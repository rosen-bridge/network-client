 ...
 */
import type { BlockTxInfoItemReferenceInputsAnyOfItem } from './blockTxInfoItemReferenceInputsAnyOfItem';
import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItem } from './blockTxInfoItemReferenceInputsAnyOfItem';

/**
 * An array of reference inputs. A reference input allows looking at an output without spending it. (CIP-31)
 */
export type BlockTxInfoItemReferenceInputs =
  | BlockTxInfoItemReferenceInputsAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemReferenceInputs: Array<string> = [
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItem,
];
