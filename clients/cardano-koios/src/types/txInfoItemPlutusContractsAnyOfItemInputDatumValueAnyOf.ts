 ...
 * Data in JSON format
 */
export type TxInfoItemPlutusContractsAnyOfItemInputDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumValueAnyOf: Array<string> =
  [];
