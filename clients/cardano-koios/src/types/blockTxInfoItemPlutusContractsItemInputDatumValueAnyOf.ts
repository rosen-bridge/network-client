...
export type BlockTxInfoItemPlutusContractsItemInputDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemPlutusContractsItemInputDatumValueAnyOf: Array<string> =
  [];
