 ...
 */
import type { PoolOwnerHistoryItemActiveStake } from './poolOwnerHistoryItemActiveStake';
import { bigIntsPoolOwnerHistoryItemActiveStake } from './poolOwnerHistoryItemActiveStake';
import type { PoolOwnerHistoryItemDeclaredPledge } from './poolOwnerHistoryItemDeclaredPledge';
import { bigIntsPoolOwnerHistoryItemDeclaredPledge } from './poolOwnerHistoryItemDeclaredPledge';

export type PoolOwnerHistoryItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  /** Individual Stake account registered as (one of the) pool owner(s) */
  stake_address?: string;
  /** Pool pledge in number */
  declared_pledge?: PoolOwnerHistoryItemDeclaredPledge;
  /** Epoch for which the pool history data is shown */
  epoch?: number;
  /** Amount of delegated stake to this pool at the time of epoch snapshot */
  active_stake?: PoolOwnerHistoryItemActiveStake;
};

export const bigIntsPoolOwnerHistoryItem: Array<string> = [
  ...bigIntsPoolOwnerHistoryItemDeclaredPledge.map((item) =>
    item === '' ? 'declared_pledge' : `declared_pledge.${item}`,
  ),
  ...bigIntsPoolOwnerHistoryItemActiveStake.map((item) =>
