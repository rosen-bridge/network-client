 ...
 */
import type { PoolRelaysItem } from './poolRelaysItem';

import { bigIntsPoolRelaysItem } from './poolRelaysItem';

/**
 * Array of pool relay information
 */
export type PoolRelays = PoolRelaysItem[];
export const bigIntsPoolRelays: Array<string> = [...bigIntsPoolRelaysItem];
