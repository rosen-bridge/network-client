...
export type TxInfoItemCollateralInputsAnyOfItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemCollateralInputsAnyOfItemReferenceScriptValueAnyOf: Array<string> =
  [];
