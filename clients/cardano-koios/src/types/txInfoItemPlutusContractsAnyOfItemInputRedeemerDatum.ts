 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash';
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue';

import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue';

export type TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum = {
  /** The Hash of the Plutus Data */
  hash?: TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash;
  /** Data in JSON format */
  value?: TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue;
};

export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum: Array<string> =
  [
    ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash.map(
      (item) => (item === '' ? 'hash' : `hash.${item}`)
    ),
    ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValue.map(
