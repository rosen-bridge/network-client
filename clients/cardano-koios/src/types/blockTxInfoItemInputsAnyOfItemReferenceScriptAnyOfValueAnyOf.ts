 ...
 * Value (json)
 */
export type BlockTxInfoItemInputsAnyOfItemReferenceScriptAnyOfValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemInputsAnyOfItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
