 ...
 */
import type { AddressAssetsItem } from './addressAssetsItem';
import { bigIntsAddressAssetsItem } from './addressAssetsItem';

/**
 * Array of address-owned assets
 */
export type AddressAssets = AddressAssetsItem[];
export const bigIntsAddressAssets: Array<string> = [
  ...bigIntsAddressAssetsItem,
];
