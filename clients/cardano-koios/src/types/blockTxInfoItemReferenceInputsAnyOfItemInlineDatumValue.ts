 ...
 * Value (json)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemInlineDatumValue = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatumValue: Array<string> =
  [];
