...
import type { ProposalListItemEnactedEpoch } from './proposalListItemEnactedEpoch';
import { bigIntsProposalListItemEnactedEpoch } from './proposalListItemEnactedEpoch';
import type { ProposalListItemDroppedEpoch } from './proposalListItemDroppedEpoch';
import { bigIntsProposalListItemDroppedEpoch } from './proposalListItemDroppedEpoch';
import type { ProposalListItemExpiredEpoch } from './proposalListItemExpiredEpoch';
import { bigIntsProposalListItemExpiredEpoch } from './proposalListItemExpiredEpoch';
import type { ProposalListItemExpiration } from './proposalListItemExpiration';
import { bigIntsProposalListItemExpiration } from './proposalListItemExpiration';
import type { ProposalListItemMetaUrl } from './proposalListItemMetaUrl';
import { bigIntsProposalListItemMetaUrl } from './proposalListItemMetaUrl';
import type { ProposalListItemMetaHash } from './proposalListItemMetaHash';
import { bigIntsProposalListItemMetaHash } from './proposalListItemMetaHash';
import type { ProposalListItemMetaJson } from './proposalListItemMetaJson';
import { bigIntsProposalListItemMetaJson } from './proposalListItemMetaJson';
import type { ProposalListItemMetaComment } from './proposalListItemMetaComment';
import { bigIntsProposalListItemMetaComment } from './proposalListItemMetaComment';
import type { ProposalListItemMetaLanguage } from './proposalListItemMetaLanguage';
import { bigIntsProposalListItemMetaLanguage } from './proposalListItemMetaLanguage';
import type { ProposalListItemMetaIsValid } from './proposalListItemMetaIsValid';
import { bigIntsProposalListItemMetaIsValid } from './proposalListItemMetaIsValid';
...
export type ProposalListItem = {
  ...
  meta_url?: ProposalListItemMetaUrl;
  /** A hash of the contents of the metadata URL */
  meta_hash?: ProposalListItemMetaHash;
  /** The payload as JSON */
  meta_json?: ProposalListItemMetaJson;
