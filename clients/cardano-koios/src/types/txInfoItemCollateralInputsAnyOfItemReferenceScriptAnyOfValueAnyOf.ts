 ...
 * Value (json)
 */
export type TxInfoItemCollateralInputsAnyOfItemReferenceScriptAnyOfValueAnyOf =
  { [key: string]: unknown };
export const bigIntsTxInfoItemCollateralInputsAnyOfItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
