 ...
 */
import type { PoolRelaysItemRelaysItem } from './poolRelaysItemRelaysItem';
import { bigIntsPoolRelaysItemRelaysItem } from './poolRelaysItemRelaysItem';
import type { PoolRelaysItemPoolStatus } from './poolRelaysItemPoolStatus';

import { bigIntsPoolRelaysItemPoolStatus } from './poolRelaysItemPoolStatus';

export type PoolRelaysItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  relays?: PoolRelaysItemRelaysItem[];
  /** Pool status */
  pool_status?: PoolRelaysItemPoolStatus;
};
...
export const bigIntsPoolRelaysItem = [
  ...
  ...bigIntsPoolRelaysItemPoolStatus.map((item) =>
