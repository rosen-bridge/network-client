 ...
 * Value (json)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemReferenceScriptAnyOfValueAnyOf =
  { [key: string]: unknown };
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
