...
export type BlockTxInfoItemPlutusContractsItemInputRedeemerDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumValueAnyOf: Array<string> =
  [];
