 ...
 */
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem';
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps';

export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit = {
  /** The budget in Cpu steps to run a script */
  steps?: BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps;
  /** The budget in Memory to run a script */
  mem?: BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem;
};

export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps.map(
      (item) => (item === '' ? 'steps' : `steps.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem.map(
