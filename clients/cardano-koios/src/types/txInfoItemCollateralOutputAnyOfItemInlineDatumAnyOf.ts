 ...
 */
import type { TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue } from './txInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue';

import { bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue } from './txInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue;
};
