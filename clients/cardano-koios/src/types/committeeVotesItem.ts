 ...
 */
import type { CommitteeVotesItemMetaHash } from './committeeVotesItemMetaHash';
import { bigIntsCommitteeVotesItemMetaHash } from './committeeVotesItemMetaHash';
import type { CommitteeVotesItemMetaUrl } from './committeeVotesItemMetaUrl';
import { bigIntsCommitteeVotesItemMetaUrl } from './committeeVotesItemMetaUrl';
import type { CommitteeVotesItemVote } from './committeeVotesItemVote';

import { bigIntsCommitteeVotesItemVote } from './committeeVotesItemVote';

export type CommitteeVotesItem = {
  /** UNIX timestamp of the block */
  block_time?: number;
  /** A hash of the contents of the metadata URL */
  meta_hash?: CommitteeVotesItemMetaHash;
  /** A URL to a JSON payload of metadata */
  meta_url?: CommitteeVotesItemMetaUrl;
  ...
  /** Actual Vote casted */
  vote?: CommitteeVotesItemVote;
  /** Hash identifier of the transaction */
  vote_tx_hash?: string;
};

export const bigIntsCommitteeVotesItem = [
