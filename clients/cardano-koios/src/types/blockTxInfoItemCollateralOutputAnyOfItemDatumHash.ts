 ...
 */
export type BlockTxInfoItemCollateralOutputAnyOfItemDatumHash = string | null;
export const bigIntsBlockTxInfoItemCollateralOutputAnyOfItemDatumHash: Array<string> =
  [];
