...
import { bigIntsProposalVotesItem } from './proposalVotesItem';

/**
 * List of all votes cast on specified governance action
 */
export type ProposalVotes = ProposalVotesItem[];
export const bigIntsProposalVotes: Array<string> = [
  ...bigIntsProposalVotesItem,
];
