...
import type { PoolUpdatesItemFixedCost } from './poolUpdatesItemFixedCost';
import { bigIntsPoolUpdatesItemFixedCost } from './poolUpdatesItemFixedCost';
import type { PoolUpdatesItemMargin } from './poolUpdatesItemMargin';
import { bigIntsPoolUpdatesItemMargin } from './poolUpdatesItemMargin';
import type { PoolUpdatesItemMetaHash } from './poolUpdatesItemMetaHash';
import { bigIntsPoolUpdatesItemMetaHash } from './poolUpdatesItemMetaHash';
import type { PoolUpdatesItemMetaJson } from './poolUpdatesItemMetaJson';
...
import { bigIntsPoolUpdatesItemRelaysItem } from './poolUpdatesItemRelaysItem';
import type { PoolUpdatesItemRetiringEpoch } from './poolUpdatesItemRetiringEpoch';
import { bigIntsPoolUpdatesItemRetiringEpoch } from './poolUpdatesItemRetiringEpoch';
import type { PoolUpdatesItemRewardAddr } from './poolUpdatesItemRewardAddr';
import { bigIntsPoolUpdatesItemRewardAddr } from './poolUpdatesItemRewardAddr';
import type { PoolUpdatesItemUpdateType } from './poolUpdatesItemUpdateType';
import { bigIntsPoolUpdatesItemUpdateType } from './poolUpdatesItemUpdateType';
import type { PoolUpdatesItemVrfKeyHash } from './poolUpdatesItemVrfKeyHash';

import { bigIntsPoolUpdatesItemVrfKeyHash } from './poolUpdatesItemVrfKeyHash';

export type PoolUpdatesItem = {
  /** Epoch number in which the update becomes active */
  active_epoch_no?: PoolUpdatesItemActiveEpochNo;
  /** UNIX timestamp of the block */
  block_time?: number;
  /** Pool fixed cost per epoch */
  fixed_cost?: PoolUpdatesItemFixedCost;
  /** Margin (decimal format) */
  margin?: PoolUpdatesItemMargin;
  /** Pool metadata hash */
  meta_hash?: PoolUpdatesItemMetaHash;
  meta_json?: PoolUpdatesItemMetaJson;
  /** Pool metadata URL */
  ...
  retiring_epoch?: PoolUpdatesItemRetiringEpoch;
  /** Pool reward address */
  reward_addr?: PoolUpdatesItemRewardAddr;
  /** Hash identifier of the transaction */
  tx_hash?: string;
  /** Type of update task */
  update_type?: PoolUpdatesItemUpdateType;
  /** Pool VRF key hash */
  vrf_key_hash?: PoolUpdatesItemVrfKeyHash;
};

export const bigIntsPoolUpdatesItem = [
