 ...
 */
import type { AccountUpdatesItem } from './accountUpdatesItem';

import { bigIntsAccountUpdatesItem } from './accountUpdatesItem';

/**
 * Array of account updates information
 */
export type AccountUpdates = AccountUpdatesItem[];
export const bigIntsAccountUpdates: Array<string> = [
  ...bigIntsAccountUpdatesItem,
];
