 ...
 */
import type { TxInfoItemAssetsMintedAnyOfItemAssetName } from './txInfoItemAssetsMintedAnyOfItemAssetName';

import { bigIntsTxInfoItemAssetsMintedAnyOfItemAssetName } from './txInfoItemAssetsMintedAnyOfItemAssetName';

export type TxInfoItemAssetsMintedAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemAssetsMintedAnyOfItemAssetName;
