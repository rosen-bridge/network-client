 ...
 */
import type { DrepHistoryItem } from './drepHistoryItem';
import { bigIntsDrepHistoryItem } from './drepHistoryItem';

/**
 * History of DReps voting power against each (or requested) epoch
 */
export type DrepHistory = DrepHistoryItem[];
export const bigIntsDrepHistory: Array<string> = [...bigIntsDrepHistoryItem];
