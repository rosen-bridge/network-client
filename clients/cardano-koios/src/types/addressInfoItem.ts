 ...
 */
import type { AddressInfoItemStakeAddress } from './addressInfoItemStakeAddress';
import { bigIntsAddressInfoItemStakeAddress } from './addressInfoItemStakeAddress';
import type { AddressInfoItemUtxoSetItem } from './addressInfoItemUtxoSetItem';

import { bigIntsAddressInfoItemUtxoSetItem } from './addressInfoItemUtxoSetItem';

export type AddressInfoItem = {
  /** A Cardano payment/base address (bech32 encoded) for transaction's input UTxO */
  address?: string;
  /** Sum of all UTxO values beloning to address */
  balance?: string;
  stake_address?: AddressInfoItemStakeAddress;
  /** Signifies whether the address is a script address */
  script_address?: boolean;
  utxo_set?: AddressInfoItemUtxoSetItem[];
};
