 ...
 */
import type { TxInfoItemWithdrawalsAnyOfItem } from './txInfoItemWithdrawalsAnyOfItem';
import { bigIntsTxInfoItemWithdrawalsAnyOfItem } from './txInfoItemWithdrawalsAnyOfItem';

/**
 * Array of withdrawals with-in a transaction
 */
export type TxInfoItemWithdrawals = TxInfoItemWithdrawalsAnyOfItem[] | null;
export const bigIntsTxInfoItemWithdrawals: Array<string> = [
  ...bigIntsTxInfoItemWithdrawalsAnyOfItem,
];
