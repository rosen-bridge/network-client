 ...
 */
import type { PoolVotesItem } from './poolVotesItem';
import { bigIntsPoolVotesItem } from './poolVotesItem';

/**
 * List of all votes casted by requested pool
 */
export type PoolVotes = PoolVotesItem[];
export const bigIntsPoolVotes: Array<string> = [...bigIntsPoolVotesItem];
