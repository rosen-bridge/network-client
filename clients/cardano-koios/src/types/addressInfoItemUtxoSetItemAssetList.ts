 ...
 */
import type { AddressInfoItemUtxoSetItemAssetListAnyOfItem } from './addressInfoItemUtxoSetItemAssetListAnyOfItem';
import { bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItem } from './addressInfoItemUtxoSetItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type AddressInfoItemUtxoSetItemAssetList =
  | AddressInfoItemUtxoSetItemAssetListAnyOfItem[]
  | null;
export const bigIntsAddressInfoItemUtxoSetItemAssetList: Array<string> = [
  ...bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItem,
];
