 ...
 */
import type { AccountUpdateHistoryItemActionType } from './accountUpdateHistoryItemActionType';
import { bigIntsAccountUpdateHistoryItemActionType } from './accountUpdateHistoryItemActionType';

export type AccountUpdateHistoryItem = {
  /** Cardano staking address (reward account) in bech32 format */
  stake_address?: string;
  /** Type of certificate submitted */
  action_type?: AccountUpdateHistoryItemActionType;
...
export const bigIntsAccountUpdateHistoryItem: Array<string> = [
  ...bigIntsAccountUpdateHistoryItemActionType.map((item) =>
