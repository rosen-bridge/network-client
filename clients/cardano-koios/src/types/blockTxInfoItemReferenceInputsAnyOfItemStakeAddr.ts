...
export type BlockTxInfoItemReferenceInputsAnyOfItemStakeAddr = string | null;
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemStakeAddr: Array<string> =
  [];
