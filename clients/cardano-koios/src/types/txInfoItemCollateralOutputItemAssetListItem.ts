 ...
 */
import type { TxInfoItemCollateralOutputItemAssetListItemAssetName } from './txInfoItemCollateralOutputItemAssetListItemAssetName';

import { bigIntsTxInfoItemCollateralOutputItemAssetListItemAssetName } from './txInfoItemCollateralOutputItemAssetListItemAssetName';

export type TxInfoItemCollateralOutputItemAssetListItem = {
  /** Asset Name (hex) */
  asset_name?: TxInfoItemCollateralOutputItemAssetListItemAssetName;
  decimals?: number;
...
export const bigIntsTxInfoItemCollateralOutputItemAssetListItem = [
  ...bigIntsTxInfoItemCollateralOutputItemAssetListItemAssetName.map((item) =>
