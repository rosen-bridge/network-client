 ...
 */
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatumHash';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatumHash';
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerDatumValue } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatumValue';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumValue } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatumValue';

export type BlockTxInfoItemPlutusContractsItemInputRedeemerDatum = {
  /** The Hash of the Plutus Data */
  hash?: BlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash;
  /** Data in JSON format */
  value?: BlockTxInfoItemPlutusContractsItemInputRedeemerDatumValue;
};

export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatum: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash.map(
      (item) => (item === '' ? 'hash' : `hash.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumValue.map(
