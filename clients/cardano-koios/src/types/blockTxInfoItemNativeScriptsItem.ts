 ...
 */
import type { BlockTxInfoItemNativeScriptsItemScriptHash } from './blockTxInfoItemNativeScriptsItemScriptHash';
import { bigIntsBlockTxInfoItemNativeScriptsItemScriptHash } from './blockTxInfoItemNativeScriptsItemScriptHash';
import type { BlockTxInfoItemNativeScriptsItemScriptJson } from './blockTxInfoItemNativeScriptsItemScriptJson';
import { bigIntsBlockTxInfoItemNativeScriptsItemScriptJson } from './blockTxInfoItemNativeScriptsItemScriptJson';

export type BlockTxInfoItemNativeScriptsItem = {
  /** Hash of a script */
  script_hash?: BlockTxInfoItemNativeScriptsItemScriptHash;
  /** JSON representation of the timelock script (null for other script types) */
  script_json?: BlockTxInfoItemNativeScriptsItemScriptJson;
};

export const bigIntsBlockTxInfoItemNativeScriptsItem: Array<string> = [
  ...bigIntsBlockTxInfoItemNativeScriptsItemScriptHash.map((item) =>
    item === '' ? 'script_hash' : `script_hash.${item}`,
  ),
  ...bigIntsBlockTxInfoItemNativeScriptsItemScriptJson.map((item) =>
