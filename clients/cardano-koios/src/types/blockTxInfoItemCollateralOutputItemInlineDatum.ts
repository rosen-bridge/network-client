 ...
 */
import type { BlockTxInfoItemCollateralOutputItemInlineDatumAnyOf } from './blockTxInfoItemCollateralOutputItemInlineDatumAnyOf';
import { bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumAnyOf } from './blockTxInfoItemCollateralOutputItemInlineDatumAnyOf';
import type { BlockTxInfoItemCollateralOutputItemInlineDatumValue } from './blockTxInfoItemCollateralOutputItemInlineDatumValue';
import { bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumValue } from './blockTxInfoItemCollateralOutputItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemCollateralOutputItemInlineDatum =
  | (BlockTxInfoItemCollateralOutputItemInlineDatumAnyOf & {
      /** Datum bytes (hex) */
      bytes?: string;
      /** Value (json) */
      value?: BlockTxInfoItemCollateralOutputItemInlineDatumValue;
    })
  | (null & {
      /** Datum bytes (hex) */
      bytes?: string;
...
export const bigIntsBlockTxInfoItemCollateralOutputItemInlineDatum: Array<string> =
  [
    ...bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumValue.map((item) =>
