 ...
 */
import type { BlockTxCborItem } from './blockTxCborItem';
import { bigIntsBlockTxCborItem } from './blockTxCborItem';

/**
 * Array of raw transaction(s) in CBOR format
 */
export type BlockTxCbor = BlockTxCborItem[];
export const bigIntsBlockTxCbor: Array<string> = [...bigIntsBlockTxCborItem];
