 ...
 */
import type { BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemInputsAnyOfItemAssetListAnyOfItem';
import { bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemInputsAnyOfItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type BlockTxInfoItemInputsAnyOfItemAssetList =
  | BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemInputsAnyOfItemAssetList: Array<string> = [
  ...bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem,
];
