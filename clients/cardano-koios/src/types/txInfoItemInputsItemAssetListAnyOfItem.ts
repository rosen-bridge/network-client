 ...
 */
import type { TxInfoItemInputsItemAssetListAnyOfItemAssetName } from './txInfoItemInputsItemAssetListAnyOfItemAssetName';
import { bigIntsTxInfoItemInputsItemAssetListAnyOfItemAssetName } from './txInfoItemInputsItemAssetListAnyOfItemAssetName';

export type TxInfoItemInputsItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemInputsItemAssetListAnyOfItemAssetName;
...
export const bigIntsTxInfoItemInputsItemAssetListAnyOfItem: Array<string> = [
  ...bigIntsTxInfoItemInputsItemAssetListAnyOfItemAssetName.map((item) =>
