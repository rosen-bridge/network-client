 ...
 * Asset Name (hex)
 */
export type TxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName =
  | string
  | null;
export const bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName: Array<string> =
  [];
