...
import { bigIntsBlockInfoItemProtoMajor } from './blockInfoItemProtoMajor';
import type { BlockInfoItemProtoMinor } from './blockInfoItemProtoMinor';
import { bigIntsBlockInfoItemProtoMinor } from './blockInfoItemProtoMinor';
import type { BlockInfoItemTotalFees } from './blockInfoItemTotalFees';
import { bigIntsBlockInfoItemTotalFees } from './blockInfoItemTotalFees';
import type { BlockInfoItemTotalOutput } from './blockInfoItemTotalOutput';

import { bigIntsBlockInfoItemTotalOutput } from './blockInfoItemTotalOutput';

export type BlockInfoItem = {
  ...
  pool?: BlockInfoItemPool;
  /** The protocol major version */
  proto_major?: BlockInfoItemProtoMajor;
  /** The protocol minor version */
  proto_minor?: BlockInfoItemProtoMinor;
  /** Total fees of the block (in number) */
  total_fees?: BlockInfoItemTotalFees;
  /** Total output of the block (in number) */
  total_output?: BlockInfoItemTotalOutput;
...
export const bigIntsBlockInfoItem = [
