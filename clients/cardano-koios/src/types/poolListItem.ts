...
import type { PoolListItemMargin } from './poolListItemMargin';
import { bigIntsPoolListItemMargin } from './poolListItemMargin';
import type { PoolListItemFixedCost } from './poolListItemFixedCost';
import { bigIntsPoolListItemFixedCost } from './poolListItemFixedCost';
import type { PoolListItemPledge } from './poolListItemPledge';
import { bigIntsPoolListItemPledge } from './poolListItemPledge';
import type { PoolListItemDeposit } from './poolListItemDeposit';
import { bigIntsPoolListItemDeposit } from './poolListItemDeposit';
import type { PoolListItemRewardAddr } from './poolListItemRewardAddr';
import { bigIntsPoolListItemRewardAddr } from './poolListItemRewardAddr';
...
import { bigIntsPoolListItemRelaysItem } from './poolListItemRelaysItem';
import type { PoolListItemTicker } from './poolListItemTicker';
import { bigIntsPoolListItemTicker } from './poolListItemTicker';
import type { PoolListItemMetaUrl } from './poolListItemMetaUrl';
import { bigIntsPoolListItemMetaUrl } from './poolListItemMetaUrl';
import type { PoolListItemMetaHash } from './poolListItemMetaHash';
...
import type { PoolListItemActiveStake } from './poolListItemActiveStake';
import { bigIntsPoolListItemActiveStake } from './poolListItemActiveStake';
import type { PoolListItemRetiringEpoch } from './poolListItemRetiringEpoch';

import { bigIntsPoolListItemRetiringEpoch } from './poolListItemRetiringEpoch';
...
export type PoolListItem = {
  ...
  active_epoch_no?: PoolListItemActiveEpochNo;
  /** Margin (decimal format) */
  margin?: PoolListItemMargin;
  /** Pool fixed cost per epoch */
  fixed_cost?: PoolListItemFixedCost;
  /** Pool pledge in number */
  pledge?: PoolListItemPledge;
  ...
  /** Pool metadata hash */
  meta_hash?: PoolListItemMetaHash;
  /** Pool status */
  pool_status?: PoolListItemPoolStatus;
  /** Amount of delegated stake to this pool at the time of epoch snapshot */
  active_stake?: PoolListItemActiveStake;
  /** Announced retiring epoch (nullable) */
  retiring_epoch?: PoolListItemRetiringEpoch;
};
