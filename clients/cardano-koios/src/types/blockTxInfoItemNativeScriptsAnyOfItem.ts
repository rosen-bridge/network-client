 ...
 */
import type { BlockTxInfoItemNativeScriptsAnyOfItemScriptHash } from './blockTxInfoItemNativeScriptsAnyOfItemScriptHash';
import { bigIntsBlockTxInfoItemNativeScriptsAnyOfItemScriptHash } from './blockTxInfoItemNativeScriptsAnyOfItemScriptHash';
import type { BlockTxInfoItemNativeScriptsAnyOfItemScriptJson } from './blockTxInfoItemNativeScriptsAnyOfItemScriptJson';

import { bigIntsBlockTxInfoItemNativeScriptsAnyOfItemScriptJson } from './blockTxInfoItemNativeScriptsAnyOfItemScriptJson';

export type BlockTxInfoItemNativeScriptsAnyOfItem = {
  /** Hash of a script */
  script_hash?: BlockTxInfoItemNativeScriptsAnyOfItemScriptHash;
  /** JSON representation of the timelock script (null for other script types) */
  script_json?: BlockTxInfoItemNativeScriptsAnyOfItemScriptJson;
};
