 ...
 */
import type { TxInfoItemProposalProceduresAnyOfItemType } from './txInfoItemProposalProceduresAnyOfItemType';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemType } from './txInfoItemProposalProceduresAnyOfItemType';
import type { TxInfoItemProposalProceduresAnyOfItemDescription } from './txInfoItemProposalProceduresAnyOfItemDescription';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemDescription } from './txInfoItemProposalProceduresAnyOfItemDescription';
import type { TxInfoItemProposalProceduresAnyOfItemDeposit } from './txInfoItemProposalProceduresAnyOfItemDeposit';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemDeposit } from './txInfoItemProposalProceduresAnyOfItemDeposit';
import type { TxInfoItemProposalProceduresAnyOfItemExpiration } from './txInfoItemProposalProceduresAnyOfItemExpiration';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemExpiration } from './txInfoItemProposalProceduresAnyOfItemExpiration';
import type { TxInfoItemProposalProceduresAnyOfItemMetaUrl } from './txInfoItemProposalProceduresAnyOfItemMetaUrl';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemMetaUrl } from './txInfoItemProposalProceduresAnyOfItemMetaUrl';
import type { TxInfoItemProposalProceduresAnyOfItemMetaHash } from './txInfoItemProposalProceduresAnyOfItemMetaHash';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemMetaHash } from './txInfoItemProposalProceduresAnyOfItemMetaHash';
import type { TxInfoItemProposalProceduresAnyOfItemWithdrawal } from './txInfoItemProposalProceduresAnyOfItemWithdrawal';
import { bigIntsTxInfoItemProposalProceduresAnyOfItemWithdrawal } from './txInfoItemProposalProceduresAnyOfItemWithdrawal';
import type { TxInfoItemProposalProceduresAnyOfItemParamProposal } from './txInfoItemProposalProceduresAnyOfItemParamProposal';

import { bigIntsTxInfoItemProposalProceduresAnyOfItemParamProposal } from './txInfoItemProposalProceduresAnyOfItemParamProposal';

export type TxInfoItemProposalProceduresAnyOfItem = {
  /** Index of governance proposal in transaction */
  index?: number;
  /** Proposal Action Type */
  type?: TxInfoItemProposalProceduresAnyOfItemType;
  /** Description for Proposal Action */
  description?: TxInfoItemProposalProceduresAnyOfItemDescription;
  /** DRep's registration deposit  in number */
  deposit?: TxInfoItemProposalProceduresAnyOfItemDeposit;
  ...
  expiration?: TxInfoItemProposalProceduresAnyOfItemExpiration;
  /** A URL to a JSON payload of metadata */
  meta_url?: TxInfoItemProposalProceduresAnyOfItemMetaUrl;
  /** A hash of the contents of the metadata URL */
  meta_hash?: TxInfoItemProposalProceduresAnyOfItemMetaHash;
  /** If not null, the amount withdrawn from treasury into stake address by this this proposal */
  withdrawal?: TxInfoItemProposalProceduresAnyOfItemWithdrawal;
  /** If not null, the proposed new parameter set */
  param_proposal?: TxInfoItemProposalProceduresAnyOfItemParamProposal;
};
