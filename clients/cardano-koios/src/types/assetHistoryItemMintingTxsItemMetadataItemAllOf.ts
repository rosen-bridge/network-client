 ...
 */
import type { AssetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf } from './assetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf';
import { bigIntsAssetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf } from './assetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type AssetHistoryItemMintingTxsItemMetadataItemAllOf =
  AssetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf | null;
export const bigIntsAssetHistoryItemMintingTxsItemMetadataItemAllOf: Array<string> =
  [...bigIntsAssetHistoryItemMintingTxsItemMetadataItemAllOfAnyOf];
