 ...
 */
export type BlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem =
  | string
  | number
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem: Array<string> =
  [];
