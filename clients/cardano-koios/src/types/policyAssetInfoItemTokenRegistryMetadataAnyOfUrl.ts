...
export type PolicyAssetInfoItemTokenRegistryMetadataAnyOfUrl = null | string;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataAnyOfUrl: Array<string> =
  [];
