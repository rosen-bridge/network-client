 ...
 */
import type { TxInfoItemOutputsItemInlineDatumAnyOfValue } from './txInfoItemOutputsItemInlineDatumAnyOfValue';
import { bigIntsTxInfoItemOutputsItemInlineDatumAnyOfValue } from './txInfoItemOutputsItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemOutputsItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemOutputsItemInlineDatumAnyOfValue;
};

export const bigIntsTxInfoItemOutputsItemInlineDatumAnyOf: Array<string> = [
  ...bigIntsTxInfoItemOutputsItemInlineDatumAnyOfValue.map((item) =>
