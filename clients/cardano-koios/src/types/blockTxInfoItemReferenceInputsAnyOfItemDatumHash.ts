 ...
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemDatumHash = string | null;
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemDatumHash: Array<string> =
  [];
