 ...
 */
import type { AssetNftAddressItemStakeAddress } from './assetNftAddressItemStakeAddress';

import { bigIntsAssetNftAddressItemStakeAddress } from './assetNftAddressItemStakeAddress';

export type AssetNftAddressItem = {
  /** A Cardano payment/base address (bech32 encoded) */
  payment_address?: string;
  stake_address?: AssetNftAddressItemStakeAddress;
};

export const bigIntsAssetNftAddressItem = [
