 ...
 */
import type { TxInfoItemPlutusContractsItemAddress } from './txInfoItemPlutusContractsItemAddress';
import { bigIntsTxInfoItemPlutusContractsItemAddress } from './txInfoItemPlutusContractsItemAddress';
import type { TxInfoItemPlutusContractsItemBytecode } from './txInfoItemPlutusContractsItemBytecode';
import { bigIntsTxInfoItemPlutusContractsItemBytecode } from './txInfoItemPlutusContractsItemBytecode';
import type { TxInfoItemPlutusContractsItemInput } from './txInfoItemPlutusContractsItemInput';
import { bigIntsTxInfoItemPlutusContractsItemInput } from './txInfoItemPlutusContractsItemInput';
import type { TxInfoItemPlutusContractsItemScriptHash } from './txInfoItemPlutusContractsItemScriptHash';
import { bigIntsTxInfoItemPlutusContractsItemScriptHash } from './txInfoItemPlutusContractsItemScriptHash';
import type { TxInfoItemPlutusContractsItemSpendsInput } from './txInfoItemPlutusContractsItemSpendsInput';
import { bigIntsTxInfoItemPlutusContractsItemSpendsInput } from './txInfoItemPlutusContractsItemSpendsInput';

export type TxInfoItemPlutusContractsItem = {
  /** Plutus script address */
  address?: TxInfoItemPlutusContractsItemAddress;
  /** Input utxo this contract spends */
  spends_input?: TxInfoItemPlutusContractsItemSpendsInput;
  /** Hash of a script */
  script_hash?: TxInfoItemPlutusContractsItemScriptHash;
  /** Script bytes (cborSeq) */
  bytecode?: TxInfoItemPlutusContractsItemBytecode;
...
export const bigIntsTxInfoItemPlutusContractsItem: Array<string> = [
  ...bigIntsTxInfoItemPlutusContractsItemAddress.map((item) =>
    item === '' ? 'address' : `address.${item}`,
  ),
  ...bigIntsTxInfoItemPlutusContractsItemSpendsInput.map((item) =>
    item === '' ? 'spends_input' : `spends_input.${item}`,
  ),
  ...bigIntsTxInfoItemPlutusContractsItemScriptHash.map((item) =>
    item === '' ? 'script_hash' : `script_hash.${item}`,
  ),
  ...bigIntsTxInfoItemPlutusContractsItemBytecode.map((item) =>
