 ...
 * Data in JSON format
 */
export type TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValueAnyOf: Array<string> =
  [];
