 ...
 */
import type { BlockTxInfoItemCollateralOutputItemAssetListItem } from './blockTxInfoItemCollateralOutputItemAssetListItem';
import { bigIntsBlockTxInfoItemCollateralOutputItemAssetListItem } from './blockTxInfoItemCollateralOutputItemAssetListItem';
import type { BlockTxInfoItemCollateralOutputItemDatumHash } from './blockTxInfoItemCollateralOutputItemDatumHash';
import { bigIntsBlockTxInfoItemCollateralOutputItemDatumHash } from './blockTxInfoItemCollateralOutputItemDatumHash';
import type { BlockTxInfoItemCollateralOutputItemInlineDatum } from './blockTxInfoItemCollateralOutputItemInlineDatum';
import { bigIntsBlockTxInfoItemCollateralOutputItemInlineDatum } from './blockTxInfoItemCollateralOutputItemInlineDatum';
import type { BlockTxInfoItemCollateralOutputItemPaymentAddr } from './blockTxInfoItemCollateralOutputItemPaymentAddr';
import { bigIntsBlockTxInfoItemCollateralOutputItemPaymentAddr } from './blockTxInfoItemCollateralOutputItemPaymentAddr';
import type { BlockTxInfoItemCollateralOutputItemReferenceScript } from './blockTxInfoItemCollateralOutputItemReferenceScript';
import { bigIntsBlockTxInfoItemCollateralOutputItemReferenceScript } from './blockTxInfoItemCollateralOutputItemReferenceScript';
import type { BlockTxInfoItemCollateralOutputItemStakeAddr } from './blockTxInfoItemCollateralOutputItemStakeAddr';

import { bigIntsBlockTxInfoItemCollateralOutputItemStakeAddr } from './blockTxInfoItemCollateralOutputItemStakeAddr';

export type BlockTxInfoItemCollateralOutputItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: BlockTxInfoItemCollateralOutputItemAssetListItem[] | null;
  /** Hash of datum (if any) connected to UTxO */
  datum_hash?: BlockTxInfoItemCollateralOutputItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemCollateralOutputItemInlineDatum;
  payment_addr?: BlockTxInfoItemCollateralOutputItemPaymentAddr;
  ...
  reference_script?: BlockTxInfoItemCollateralOutputItemReferenceScript;
  stake_addr?: BlockTxInfoItemCollateralOutputItemStakeAddr;
...
export const bigIntsBlockTxInfoItemCollateralOutputItem = [
  ...bigIntsBlockTxInfoItemCollateralOutputItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralOutputItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralOutputItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralOutputItemReferenceScript.map((item) =>
    item === '' ? 'reference_script' : `reference_script.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralOutputItemStakeAddr.map((item) =>
