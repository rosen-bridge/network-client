 ...
 */
import type { PolicyAssetInfoItem } from './policyAssetInfoItem';

import { bigIntsPolicyAssetInfoItem } from './policyAssetInfoItem';

/**
 * Array of detailed information of assets under requested policies
 */
export type PolicyAssetInfo = PolicyAssetInfoItem[];
export const bigIntsPolicyAssetInfo: Array<string> = [
  ...bigIntsPolicyAssetInfoItem,
];
