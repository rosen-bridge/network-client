 ...
 */
import type { BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem';

import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemAssetList =
  | BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem[]
  | null
  | null;
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetList: Array<string> =
  [...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem];
