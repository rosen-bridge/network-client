 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItem } from './txInfoItemPlutusContractsAnyOfItem';
import { bigIntsTxInfoItemPlutusContractsAnyOfItem } from './txInfoItemPlutusContractsAnyOfItem';

/**
 * Plutus contracts present in transaction (if any)
 */
export type TxInfoItemPlutusContracts =
  | TxInfoItemPlutusContractsAnyOfItem[]
  | null;
export const bigIntsTxInfoItemPlutusContracts: Array<string> = [
  ...bigIntsTxInfoItemPlutusContractsAnyOfItem,
];
