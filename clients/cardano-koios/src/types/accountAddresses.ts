 ...
 */
import type { AccountAddressesItem } from './accountAddressesItem';
import { bigIntsAccountAddressesItem } from './accountAddressesItem';

/**
 * Array of payment addresses
 */
export type AccountAddresses = AccountAddressesItem[];
export const bigIntsAccountAddresses: Array<string> = [
  ...bigIntsAccountAddressesItem,
];
