 ...
 */
import type { TxInfoItemCollateralInputsItemReferenceScriptValue } from './txInfoItemCollateralInputsItemReferenceScriptValue';

import { bigIntsTxInfoItemCollateralInputsItemReferenceScriptValue } from './txInfoItemCollateralInputsItemReferenceScriptValue';
 ...
 */
export type TxInfoItemCollateralInputsItemReferenceScript = {
  ...
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralInputsItemReferenceScriptValue;
} | null;

export const bigIntsTxInfoItemCollateralInputsItemReferenceScript = [
  ...bigIntsTxInfoItemCollateralInputsItemReferenceScriptValue.map((item) =>
