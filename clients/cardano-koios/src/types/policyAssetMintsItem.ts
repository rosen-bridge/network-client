 ...
 */
import type { PolicyAssetMintsItemAssetName } from './policyAssetMintsItemAssetName';
import { bigIntsPolicyAssetMintsItemAssetName } from './policyAssetMintsItemAssetName';
import type { PolicyAssetMintsItemMintingTxMetadataAllOf } from './policyAssetMintsItemMintingTxMetadataAllOf';

import { bigIntsPolicyAssetMintsItemMintingTxMetadataAllOf } from './policyAssetMintsItemMintingTxMetadataAllOf';

export type PolicyAssetMintsItem = {
  /** Asset Name (hex) */
  asset_name?: PolicyAssetMintsItemAssetName;
  /** Asset Name (ASCII) */
  ...
  minting_tx_metadata?: PolicyAssetMintsItemMintingTxMetadataAllOf;
  /** Total supply for the asset */
  total_supply?: string;
};

export const bigIntsPolicyAssetMintsItem = [
