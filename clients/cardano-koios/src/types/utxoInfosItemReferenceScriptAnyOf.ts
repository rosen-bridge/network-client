 ...
 */
import type { UtxoInfosItemReferenceScriptAnyOfValue } from './utxoInfosItemReferenceScriptAnyOfValue';

import { bigIntsUtxoInfosItemReferenceScriptAnyOfValue } from './utxoInfosItemReferenceScriptAnyOfValue';
 ...
 */
export type UtxoInfosItemReferenceScriptAnyOf = {
  /** Script bytes (hex) */
  bytes?: string;
  ...
  type?: string;
  /** Value (json) */
  value?: UtxoInfosItemReferenceScriptAnyOfValue;
};

export const bigIntsUtxoInfosItemReferenceScriptAnyOf = [
