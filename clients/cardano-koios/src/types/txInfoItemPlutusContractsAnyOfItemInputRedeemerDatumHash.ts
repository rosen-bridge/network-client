 ...
 */
export type TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash =
  | string
  | null;
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash: Array<string> =
  [];
