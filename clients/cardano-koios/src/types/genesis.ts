 ...
 */
import type { GenesisItem } from './genesisItem';
import { bigIntsGenesisItem } from './genesisItem';

/**
 * Array of genesis parameters used to start each era on chain
 */
export type Genesis = GenesisItem[];
export const bigIntsGenesis: Array<string> = [...bigIntsGenesisItem];
