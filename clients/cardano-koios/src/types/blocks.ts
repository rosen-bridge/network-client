 ...
 */
import type { BlocksItem } from './blocksItem';
import { bigIntsBlocksItem } from './blocksItem';

/**
 * Array of block information
 */
export type Blocks = BlocksItem[];
export const bigIntsBlocks: Array<string> = [...bigIntsBlocksItem];
