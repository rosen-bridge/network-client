 ...
 */
import type { DrepListItem } from './drepListItem';
import { bigIntsDrepListItem } from './drepListItem';

/**
 * List of all active delegated representatives (DReps)
 */
export type DrepList = DrepListItem[];
export const bigIntsDrepList: Array<string> = [...bigIntsDrepListItem];
