 ...
 */
import type { TxInfoItemVotingProceduresAnyOfItem } from './txInfoItemVotingProceduresAnyOfItem';
import { bigIntsTxInfoItemVotingProceduresAnyOfItem } from './txInfoItemVotingProceduresAnyOfItem';

/**
 * Governance votes in a transaction (if any)
 */
export type TxInfoItemVotingProcedures =
  | TxInfoItemVotingProceduresAnyOfItem[]
  | null;
export const bigIntsTxInfoItemVotingProcedures: Array<string> = [
  ...bigIntsTxInfoItemVotingProceduresAnyOfItem,
];
