 ...
 */
import type { EpochParamsItem } from './epochParamsItem';

import { bigIntsEpochParamsItem } from './epochParamsItem';

/**
 * Epoch parameters (all fields nullable for pre-Shelley/Gougen epochs except first block hash)
 */
export type EpochParams = EpochParamsItem[];
export const bigIntsEpochParams: Array<string> = [...bigIntsEpochParamsItem];
