 ...
 */
import type { AddressAssetsItemAssetName } from './addressAssetsItemAssetName';
import { bigIntsAddressAssetsItemAssetName } from './addressAssetsItemAssetName';

export type AddressAssetsItem = {
  /** A Cardano payment/base address (bech32 encoded) */
  address?: string;
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AddressAssetsItemAssetName;
...
export const bigIntsAddressAssetsItem: Array<string> = [
  ...bigIntsAddressAssetsItemAssetName.map((item) =>
