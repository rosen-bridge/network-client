 ...
 */
import type { ScriptUtxosItem } from './scriptUtxosItem';
import { bigIntsScriptUtxosItem } from './scriptUtxosItem';

/**
 * List of all unspent utxos with a reference script matching given script hashes
 */
export type ScriptUtxos = ScriptUtxosItem[];
export const bigIntsScriptUtxos: Array<string> = [...bigIntsScriptUtxosItem];
