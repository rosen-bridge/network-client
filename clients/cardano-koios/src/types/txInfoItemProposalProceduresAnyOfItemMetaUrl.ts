 ...
 */
export type TxInfoItemProposalProceduresAnyOfItemMetaUrl = null | string | null;
export const bigIntsTxInfoItemProposalProceduresAnyOfItemMetaUrl: Array<string> =
  [];
