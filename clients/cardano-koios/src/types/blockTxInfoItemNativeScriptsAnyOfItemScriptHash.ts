 ...
 * Hash of a script
 */
export type BlockTxInfoItemNativeScriptsAnyOfItemScriptHash = null | string;
export const bigIntsBlockTxInfoItemNativeScriptsAnyOfItemScriptHash: Array<string> =
  [];
