 ...
 */
import type { TxInfoItemCertificatesAnyOfItemInfoAnyOf } from './txInfoItemCertificatesAnyOfItemInfoAnyOf';

import { bigIntsTxInfoItemCertificatesAnyOfItemInfoAnyOf } from './txInfoItemCertificatesAnyOfItemInfoAnyOf';

/**
 * A JSON array containing information from the certificate
 */
export type TxInfoItemCertificatesAnyOfItemInfo =
  TxInfoItemCertificatesAnyOfItemInfoAnyOf | null | null;
export const bigIntsTxInfoItemCertificatesAnyOfItemInfo: Array<string> = [
  ...bigIntsTxInfoItemCertificatesAnyOfItemInfoAnyOf,
];
