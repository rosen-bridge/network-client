...
export type BlockTxInfoItemCollateralOutputItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemCollateralOutputItemReferenceScriptValueAnyOf: Array<string> =
  [];
