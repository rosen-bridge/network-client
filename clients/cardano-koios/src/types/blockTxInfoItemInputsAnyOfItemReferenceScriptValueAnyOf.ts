...
export type BlockTxInfoItemInputsAnyOfItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemInputsAnyOfItemReferenceScriptValueAnyOf: Array<string> =
  [];
