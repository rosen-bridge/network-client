 ...
 */
import type { AddressInfoItemUtxoSetItemReferenceScriptAnyOfValue } from './addressInfoItemUtxoSetItemReferenceScriptAnyOfValue';

import { bigIntsAddressInfoItemUtxoSetItemReferenceScriptAnyOfValue } from './addressInfoItemUtxoSetItemReferenceScriptAnyOfValue';
 ...
 */
export type AddressInfoItemUtxoSetItemReferenceScriptAnyOf = {
  /** Script bytes (hex) */
  bytes?: string;
  ...
  type?: string;
  /** Value (json) */
  value?: AddressInfoItemUtxoSetItemReferenceScriptAnyOfValue;
};

export const bigIntsAddressInfoItemUtxoSetItemReferenceScriptAnyOf = [
