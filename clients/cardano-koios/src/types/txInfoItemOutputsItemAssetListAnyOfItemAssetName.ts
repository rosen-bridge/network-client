 ...
 * Asset Name (hex)
 */
export type TxInfoItemOutputsItemAssetListAnyOfItemAssetName = string | null;
export const bigIntsTxInfoItemOutputsItemAssetListAnyOfItemAssetName: Array<string> =
  [];
