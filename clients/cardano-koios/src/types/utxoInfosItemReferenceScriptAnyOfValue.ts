 ...
 */
import type { UtxoInfosItemReferenceScriptAnyOfValueAnyOf } from './utxoInfosItemReferenceScriptAnyOfValueAnyOf';

import { bigIntsUtxoInfosItemReferenceScriptAnyOfValueAnyOf } from './utxoInfosItemReferenceScriptAnyOfValueAnyOf';

/**
 * Value (json)
 */
export type UtxoInfosItemReferenceScriptAnyOfValue =
  UtxoInfosItemReferenceScriptAnyOfValueAnyOf | null | null;
export const bigIntsUtxoInfosItemReferenceScriptAnyOfValue: Array<string> = [
  ...bigIntsUtxoInfosItemReferenceScriptAnyOfValueAnyOf,
];
