 ...
 */
import type { DrepMetadataItem } from './drepMetadataItem';
import { bigIntsDrepMetadataItem } from './drepMetadataItem';

/**
 * List metadata for requested delegated representatives (DReps)
 */
export type DrepMetadata = DrepMetadataItem[];
export const bigIntsDrepMetadata: Array<string> = [...bigIntsDrepMetadataItem];
