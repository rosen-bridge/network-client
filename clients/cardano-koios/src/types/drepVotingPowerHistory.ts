 ...
 */
import type { DrepVotingPowerHistoryItem } from './drepVotingPowerHistoryItem';
import { bigIntsDrepVotingPowerHistoryItem } from './drepVotingPowerHistoryItem';

/**
 * History of DReps voting power against each (or requested) epoch
 */
export type DrepVotingPowerHistory = DrepVotingPowerHistoryItem[];
export const bigIntsDrepVotingPowerHistory: Array<string> = [
  ...bigIntsDrepVotingPowerHistoryItem,
];
