 ...
 */
import type { BlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: BlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue;
};

export const bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf: Array<string> =
  [
    ...bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue.map(
