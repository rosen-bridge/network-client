 ...
 * Asset Name (hex)
 */
export type TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName =
  | string
  | null;
export const bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName: Array<string> =
  [];
