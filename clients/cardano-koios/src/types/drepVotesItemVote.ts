 ...
 * Actual Vote casted
 */
export type DrepVotesItemVote =
  (typeof DrepVotesItemVote)[keyof typeof DrepVotesItemVote];

// eslint-disable-next-line no-redeclare
export const DrepVotesItemVote = {
  Yes: 'Yes',
  No: 'No',
  Abstain: 'Abstain',
} as const;
export const bigIntsDrepVotesItemVote: Array<string> = [];
