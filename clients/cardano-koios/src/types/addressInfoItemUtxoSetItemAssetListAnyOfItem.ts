 ...
 */
import type { AddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName } from './addressInfoItemUtxoSetItemAssetListAnyOfItemAssetName';

import { bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName } from './addressInfoItemUtxoSetItemAssetListAnyOfItemAssetName';

export type AddressInfoItemUtxoSetItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName;
...
export const bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName.map(
