 ...
 */
import type { UtxoInfosItemAssetListAnyOfItem } from './utxoInfosItemAssetListAnyOfItem';
import { bigIntsUtxoInfosItemAssetListAnyOfItem } from './utxoInfosItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type UtxoInfosItemAssetList = UtxoInfosItemAssetListAnyOfItem[] | null;
export const bigIntsUtxoInfosItemAssetList: Array<string> = [
  ...bigIntsUtxoInfosItemAssetListAnyOfItem,
];
