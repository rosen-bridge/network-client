 ...
 */
import type { BlockTxInfoItemCertificatesAnyOfItemInfoAnyOf } from './blockTxInfoItemCertificatesAnyOfItemInfoAnyOf';

import { bigIntsBlockTxInfoItemCertificatesAnyOfItemInfoAnyOf } from './blockTxInfoItemCertificatesAnyOfItemInfoAnyOf';

/**
 * A JSON array containing information from the certificate
 */
export type BlockTxInfoItemCertificatesAnyOfItemInfo =
  BlockTxInfoItemCertificatesAnyOfItemInfoAnyOf | null | null;
export const bigIntsBlockTxInfoItemCertificatesAnyOfItemInfo: Array<string> = [
  ...bigIntsBlockTxInfoItemCertificatesAnyOfItemInfoAnyOf,
];
