 ...
 * Value (json)
 */
export type BlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValueAnyOf =
  { [key: string]: unknown };
export const bigIntsBlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValueAnyOf =
  [];
