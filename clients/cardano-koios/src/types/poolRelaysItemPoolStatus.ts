 ...
 * Pool status
 */
export type PoolRelaysItemPoolStatus =
  (typeof PoolRelaysItemPoolStatus)[keyof typeof PoolRelaysItemPoolStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PoolRelaysItemPoolStatus = {
  registered: 'registered',
  retiring: 'retiring',
  retired: 'retired',
} as const;
export const bigIntsPoolRelaysItemPoolStatus = [];
