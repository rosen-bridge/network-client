 ...
 * Data in JSON format
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumValueAnyOf: Array<string> =
  [];
