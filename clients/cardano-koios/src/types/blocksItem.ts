 ...
 */
import type { BlocksItemBlockHeight } from './blocksItemBlockHeight';
import { bigIntsBlocksItemBlockHeight } from './blocksItemBlockHeight';
import type { BlocksItemPool } from './blocksItemPool';
import { bigIntsBlocksItemPool } from './blocksItemPool';
import type { BlocksItemProtoMajor } from './blocksItemProtoMajor';
import { bigIntsBlocksItemProtoMajor } from './blocksItemProtoMajor';
import type { BlocksItemProtoMinor } from './blocksItemProtoMinor';

import { bigIntsBlocksItemProtoMinor } from './blocksItemProtoMinor';

export type BlocksItem = {
  /** Absolute slot number of the block */
  abs_slot?: number;
  /** Block height */
  block_height?: BlocksItemBlockHeight;
  /** Block size in bytes */
  block_size?: number;
  ...
  proto_major?: BlocksItemProtoMajor;
  /** The protocol minor version */
  proto_minor?: BlocksItemProtoMinor;
...
export const bigIntsBlocksItem = [
