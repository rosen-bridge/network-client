 ...
 * Value (json)
 */
export type TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOfValue: Array<string> =
  [];
