 ...
 */
export type TxInfoItemCollateralOutputAnyOfItemDatumHash = string | null | null;
export const bigIntsTxInfoItemCollateralOutputAnyOfItemDatumHash: Array<string> =
  [];
