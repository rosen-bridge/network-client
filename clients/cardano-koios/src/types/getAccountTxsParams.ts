 ...
 */
import type { _StakeAddressParameter } from './_stakeAddressParameter';
import { bigInts_StakeAddressParameter } from './_stakeAddressParameter';
...
export type GetAccountTxsParams = {
  /**
...
export const bigIntsGetAccountTxsParams = [
