 ...
 * Value (json)
 */
export type TxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue: Array<string> =
  [];
