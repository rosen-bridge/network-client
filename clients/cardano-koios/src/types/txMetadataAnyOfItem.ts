 ...
 */
import type { TxMetadataAnyOfItemMetadata } from './txMetadataAnyOfItemMetadata';

import { bigIntsTxMetadataAnyOfItemMetadata } from './txMetadataAnyOfItemMetadata';

export type TxMetadataAnyOfItem = {
  /** Hash identifier of the transaction */
  tx_hash?: string;
  /** A JSON array containing details about metadata within transaction */
  metadata?: TxMetadataAnyOfItemMetadata;
};
