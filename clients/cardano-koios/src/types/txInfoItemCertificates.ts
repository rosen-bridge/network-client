 ...
 */
import type { TxInfoItemCertificatesAnyOfItem } from './txInfoItemCertificatesAnyOfItem';
import { bigIntsTxInfoItemCertificatesAnyOfItem } from './txInfoItemCertificatesAnyOfItem';

/**
 * Certificates present with-in a transaction (if any)
 */
export type TxInfoItemCertificates = TxInfoItemCertificatesAnyOfItem[] | null;
export const bigIntsTxInfoItemCertificates: Array<string> = [
  ...bigIntsTxInfoItemCertificatesAnyOfItem,
];
