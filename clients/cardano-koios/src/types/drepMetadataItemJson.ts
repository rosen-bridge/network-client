 ...
 */
import type { DrepMetadataItemJsonAnyOf } from './drepMetadataItemJsonAnyOf';

import { bigIntsDrepMetadataItemJsonAnyOf } from './drepMetadataItemJsonAnyOf';

/**
 * The payload as JSON
 */
export type DrepMetadataItemJson = null | DrepMetadataItemJsonAnyOf;
export const bigIntsDrepMetadataItemJson = [];
