 ...
 */
import type { BlockTxInfoItemInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemInputsAnyOfItemAssetListItemAssetName';
import { bigIntsBlockTxInfoItemInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemInputsAnyOfItemAssetListItemAssetName';

export type BlockTxInfoItemInputsAnyOfItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemInputsAnyOfItemAssetListItemAssetName;
...
export const bigIntsBlockTxInfoItemInputsAnyOfItemAssetListItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemInputsAnyOfItemAssetListItemAssetName.map(
