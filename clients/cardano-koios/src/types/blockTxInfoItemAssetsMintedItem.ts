 ...
 */
import type { BlockTxInfoItemAssetsMintedItemAssetName } from './blockTxInfoItemAssetsMintedItemAssetName';
import { bigIntsBlockTxInfoItemAssetsMintedItemAssetName } from './blockTxInfoItemAssetsMintedItemAssetName';

export type BlockTxInfoItemAssetsMintedItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemAssetsMintedItemAssetName;
...
export const bigIntsBlockTxInfoItemAssetsMintedItem: Array<string> = [
  ...bigIntsBlockTxInfoItemAssetsMintedItemAssetName.map((item) =>
