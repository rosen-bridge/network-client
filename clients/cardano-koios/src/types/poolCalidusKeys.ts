 ...
 */
import type { PoolCalidusKeysItem } from './poolCalidusKeysItem';
import { bigIntsPoolCalidusKeysItem } from './poolCalidusKeysItem';

/**
 * Array of valid calidus keys for all pools
 */
export type PoolCalidusKeys = PoolCalidusKeysItem[];
export const bigIntsPoolCalidusKeys: Array<string> = [
  ...bigIntsPoolCalidusKeysItem,
];
