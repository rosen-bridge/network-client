 ...
 */
import type { DatumInfoItemBytes } from './datumInfoItemBytes';
import { bigIntsDatumInfoItemBytes } from './datumInfoItemBytes';
import type { DatumInfoItemDatumHash } from './datumInfoItemDatumHash';
import { bigIntsDatumInfoItemDatumHash } from './datumInfoItemDatumHash';
import type { DatumInfoItemValue } from './datumInfoItemValue';

import { bigIntsDatumInfoItemValue } from './datumInfoItemValue';

export type DatumInfoItem = {
  /** Script bytes (cborSeq) */
  bytes?: DatumInfoItemBytes;
  /** Hash of the script creation transaction */
  creation_tx_hash?: string;
  /** The Hash of the Plutus Data */
  datum_hash?: DatumInfoItemDatumHash;
  /** Data in JSON format */
  value?: DatumInfoItemValue;
};
