 ...
 */
import type { _DrepIdOptionalParameter } from './_drepIdOptionalParameter';
import { bigInts_DrepIdOptionalParameter } from './_drepIdOptionalParameter';
import type { _EpochNoParameter } from './_epochNoParameter';
import { bigInts_EpochNoParameter } from './_epochNoParameter';

export type DrepVotingPowerHistoryParams = {
  /**
   ...
   */
  _drep_id?: _DrepIdOptionalParameter;
};

export const bigIntsDrepVotingPowerHistoryParams: Array<string> = [
