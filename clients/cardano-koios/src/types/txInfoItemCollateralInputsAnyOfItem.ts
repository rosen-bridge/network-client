 ...
 */
import type { TxInfoItemCollateralInputsAnyOfItemAssetListItem } from './txInfoItemCollateralInputsAnyOfItemAssetListItem';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItem } from './txInfoItemCollateralInputsAnyOfItemAssetListItem';
import type { TxInfoItemCollateralInputsAnyOfItemDatumHash } from './txInfoItemCollateralInputsAnyOfItemDatumHash';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemDatumHash } from './txInfoItemCollateralInputsAnyOfItemDatumHash';
import type { TxInfoItemCollateralInputsAnyOfItemInlineDatum } from './txInfoItemCollateralInputsAnyOfItemInlineDatum';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemInlineDatum } from './txInfoItemCollateralInputsAnyOfItemInlineDatum';
import type { TxInfoItemCollateralInputsAnyOfItemPaymentAddr } from './txInfoItemCollateralInputsAnyOfItemPaymentAddr';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemPaymentAddr } from './txInfoItemCollateralInputsAnyOfItemPaymentAddr';
import type { TxInfoItemCollateralInputsAnyOfItemReferenceScript } from './txInfoItemCollateralInputsAnyOfItemReferenceScript';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemReferenceScript } from './txInfoItemCollateralInputsAnyOfItemReferenceScript';
import type { TxInfoItemCollateralInputsAnyOfItemStakeAddr } from './txInfoItemCollateralInputsAnyOfItemStakeAddr';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemStakeAddr } from './txInfoItemCollateralInputsAnyOfItemStakeAddr';

export type TxInfoItemCollateralInputsAnyOfItem = {
  payment_addr?: TxInfoItemCollateralInputsAnyOfItemPaymentAddr;
  stake_addr?: TxInfoItemCollateralInputsAnyOfItemStakeAddr;
  ...
  datum_hash?: TxInfoItemCollateralInputsAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: TxInfoItemCollateralInputsAnyOfItemInlineDatum;
  ...
  reference_script?: TxInfoItemCollateralInputsAnyOfItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxInfoItemCollateralInputsAnyOfItemAssetListItem[];
};
...
export const bigIntsTxInfoItemCollateralInputsAnyOfItem: Array<string> = [
  ...
  ...bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItem.map((item) =>
