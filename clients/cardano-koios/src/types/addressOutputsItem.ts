 ...
 */
import type { AddressOutputsItemPaymentCred } from './addressOutputsItemPaymentCred';
import { bigIntsAddressOutputsItemPaymentCred } from './addressOutputsItemPaymentCred';
import type { AddressOutputsItemStakeAddress } from './addressOutputsItemStakeAddress';
import { bigIntsAddressOutputsItemStakeAddress } from './addressOutputsItemStakeAddress';

export type AddressOutputsItem = {
  ...
  value?: string;
  stake_address?: AddressOutputsItemStakeAddress;
  /** Payment credential */
  payment_cred?: AddressOutputsItemPaymentCred;
...
export const bigIntsAddressOutputsItem: Array<string> = [
  ...bigIntsAddressOutputsItemStakeAddress.map((item) =>
    item === '' ? 'stake_address' : `stake_address.${item}`,
  ),
  ...bigIntsAddressOutputsItemPaymentCred.map((item) =>
