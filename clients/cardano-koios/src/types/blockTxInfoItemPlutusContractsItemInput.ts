 ...
 */
import type { BlockTxInfoItemPlutusContractsItemInputDatum } from './blockTxInfoItemPlutusContractsItemInputDatum';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputDatum } from './blockTxInfoItemPlutusContractsItemInputDatum';
import type { BlockTxInfoItemPlutusContractsItemInputRedeemer } from './blockTxInfoItemPlutusContractsItemInputRedeemer';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemer } from './blockTxInfoItemPlutusContractsItemInputRedeemer';

export type BlockTxInfoItemPlutusContractsItemInput = {
  redeemer?: BlockTxInfoItemPlutusContractsItemInputRedeemer;
  datum?: BlockTxInfoItemPlutusContractsItemInputDatum;
};

export const bigIntsBlockTxInfoItemPlutusContractsItemInput: Array<string> = [
  ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemer.map((item) =>
    item === '' ? 'redeemer' : `redeemer.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemInputDatum.map((item) =>
