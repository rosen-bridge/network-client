 ...
 */
import type { BlockTxInfoItemCertificatesItemIndex } from './blockTxInfoItemCertificatesItemIndex';
import { bigIntsBlockTxInfoItemCertificatesItemIndex } from './blockTxInfoItemCertificatesItemIndex';
import type { BlockTxInfoItemCertificatesItemInfo } from './blockTxInfoItemCertificatesItemInfo';
import { bigIntsBlockTxInfoItemCertificatesItemInfo } from './blockTxInfoItemCertificatesItemInfo';

export type BlockTxInfoItemCertificatesItem = {
  /** Certificate index */
  index?: BlockTxInfoItemCertificatesItemIndex;
  ...
  info?: BlockTxInfoItemCertificatesItemInfo;
};

export const bigIntsBlockTxInfoItemCertificatesItem: Array<string> = [
  ...bigIntsBlockTxInfoItemCertificatesItemIndex.map((item) =>
    item === '' ? 'index' : `index.${item}`,
  ),
  ...bigIntsBlockTxInfoItemCertificatesItemInfo.map((item) =>
    item === '' ? 'info' : `info.${item}`,
  ),
];
