 ...
 */
import type { TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem } from './txInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem } from './txInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type TxInfoItemCollateralInputsAnyOfItemAssetList =
  | TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem[]
  | null;
export const bigIntsTxInfoItemCollateralInputsAnyOfItemAssetList: Array<string> =
  [...bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem];
