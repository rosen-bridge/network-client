 ...
 * Pool status
 */
export type PoolInfoItemPoolStatus =
  (typeof PoolInfoItemPoolStatus)[keyof typeof PoolInfoItemPoolStatus];

// eslint-disable-next-line no-redeclare
export const PoolInfoItemPoolStatus = {
  registered: 'registered',
  retiring: 'retiring',
  retired: 'retired',
} as const;
export const bigIntsPoolInfoItemPoolStatus: Array<string> = [];
