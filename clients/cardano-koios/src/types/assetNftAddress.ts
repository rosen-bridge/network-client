 ...
 */
import type { AssetNftAddressItem } from './assetNftAddressItem';

import { bigIntsAssetNftAddressItem } from './assetNftAddressItem';

/**
 * An array of payment addresses holding the given token
 */
export type AssetNftAddress = AssetNftAddressItem[];
export const bigIntsAssetNftAddress: Array<string> = [
  ...bigIntsAssetNftAddressItem,
];
