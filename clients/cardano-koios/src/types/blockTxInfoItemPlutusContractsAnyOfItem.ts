 ...
 */
import type { BlockTxInfoItemPlutusContractsAnyOfItemAddress } from './blockTxInfoItemPlutusContractsAnyOfItemAddress';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemAddress } from './blockTxInfoItemPlutusContractsAnyOfItemAddress';
import type { BlockTxInfoItemPlutusContractsAnyOfItemSpendsInput } from './blockTxInfoItemPlutusContractsAnyOfItemSpendsInput';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemSpendsInput } from './blockTxInfoItemPlutusContractsAnyOfItemSpendsInput';
import type { BlockTxInfoItemPlutusContractsAnyOfItemScriptHash } from './blockTxInfoItemPlutusContractsAnyOfItemScriptHash';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemScriptHash } from './blockTxInfoItemPlutusContractsAnyOfItemScriptHash';
import type { BlockTxInfoItemPlutusContractsAnyOfItemBytecode } from './blockTxInfoItemPlutusContractsAnyOfItemBytecode';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemBytecode } from './blockTxInfoItemPlutusContractsAnyOfItemBytecode';
import type { BlockTxInfoItemPlutusContractsAnyOfItemInput } from './blockTxInfoItemPlutusContractsAnyOfItemInput';

import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInput } from './blockTxInfoItemPlutusContractsAnyOfItemInput';

export type BlockTxInfoItemPlutusContractsAnyOfItem = {
  /** Plutus script address */
  address?: BlockTxInfoItemPlutusContractsAnyOfItemAddress;
  /** Input utxo this contract spends */
  spends_input?: BlockTxInfoItemPlutusContractsAnyOfItemSpendsInput;
  /** Hash of a script */
  script_hash?: BlockTxInfoItemPlutusContractsAnyOfItemScriptHash;
  /** Script bytes (cborSeq) */
  bytecode?: BlockTxInfoItemPlutusContractsAnyOfItemBytecode;
  /** The size of the CBOR serialised script (in bytes) */
  size?: number;
  /** True if the contract is valid or there is no contract */
  valid_contract?: boolean;
  input?: BlockTxInfoItemPlutusContractsAnyOfItemInput;
};

export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItem: Array<string> = [
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemAddress.map((item) =>
    item === '' ? 'address' : `address.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemSpendsInput.map((item) =>
    item === '' ? 'spends_input' : `spends_input.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemScriptHash.map((item) =>
    item === '' ? 'script_hash' : `script_hash.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemBytecode.map((item) =>
    item === '' ? 'bytecode' : `bytecode.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInput.map((item) =>
