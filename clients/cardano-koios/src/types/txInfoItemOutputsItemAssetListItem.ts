 ...
 */
import type { TxInfoItemOutputsItemAssetListItemAssetName } from './txInfoItemOutputsItemAssetListItemAssetName';
import { bigIntsTxInfoItemOutputsItemAssetListItemAssetName } from './txInfoItemOutputsItemAssetListItemAssetName';

export type TxInfoItemOutputsItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemOutputsItemAssetListItemAssetName;
...
export const bigIntsTxInfoItemOutputsItemAssetListItem: Array<string> = [
  ...bigIntsTxInfoItemOutputsItemAssetListItemAssetName.map((item) =>
