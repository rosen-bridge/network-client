 ...
 */
import type { TxMetadataItemMetadataAnyOf } from './txMetadataItemMetadataAnyOf';
import { bigIntsTxMetadataItemMetadataAnyOf } from './txMetadataItemMetadataAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type TxMetadataItemMetadata = TxMetadataItemMetadataAnyOf | null;
export const bigIntsTxMetadataItemMetadata: Array<string> = [
  ...bigIntsTxMetadataItemMetadataAnyOf,
];
