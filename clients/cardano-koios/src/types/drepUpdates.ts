 ...
 */
import type { DrepUpdatesItem } from './drepUpdatesItem';
import { bigIntsDrepUpdatesItem } from './drepUpdatesItem';

/**
 * List of updates for requested (or all) delegated representatives (DReps)
 */
export type DrepUpdates = DrepUpdatesItem[];
export const bigIntsDrepUpdates: Array<string> = [...bigIntsDrepUpdatesItem];
