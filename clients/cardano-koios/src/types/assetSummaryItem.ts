 ...
 */
import type { AssetSummaryItemAssetName } from './assetSummaryItemAssetName';

import { bigIntsAssetSummaryItemAssetName } from './assetSummaryItemAssetName';

export type AssetSummaryItem = {
  /** Total number of unique addresses holding the given asset */
  addresses?: number;
  /** Asset Name (hex) */
  asset_name?: AssetSummaryItemAssetName;
...
export const bigIntsAssetSummaryItem = [
