 ...
 */
import type { BlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf';

import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemCollateralOutputAnyOfItemInlineDatum =
  BlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf | null | null;
export const bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatum: Array<string> =
  [...bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf];
