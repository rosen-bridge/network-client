 ...
 */
import type { TxInfoItemCertificatesItemInfoAnyOf } from './txInfoItemCertificatesItemInfoAnyOf';
import { bigIntsTxInfoItemCertificatesItemInfoAnyOf } from './txInfoItemCertificatesItemInfoAnyOf';

/**
 * A JSON array containing information from the certificate
 */
export type TxInfoItemCertificatesItemInfo =
  TxInfoItemCertificatesItemInfoAnyOf | null;
export const bigIntsTxInfoItemCertificatesItemInfo: Array<string> = [
  ...bigIntsTxInfoItemCertificatesItemInfoAnyOf,
];
