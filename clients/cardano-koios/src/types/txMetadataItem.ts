 ...
 */
import type { TxMetadataItemMetadata } from './txMetadataItemMetadata';
import { bigIntsTxMetadataItemMetadata } from './txMetadataItemMetadata';
...
export const bigIntsTxMetadataItem: Array<string> = [
