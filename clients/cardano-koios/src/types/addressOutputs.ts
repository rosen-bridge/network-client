 ...
 */
import type { AddressOutputsItem } from './addressOutputsItem';
import { bigIntsAddressOutputsItem } from './addressOutputsItem';

/**
 * Array of basic transaction output information
 */
export type AddressOutputs = AddressOutputsItem[];
export const bigIntsAddressOutputs: Array<string> = [
  ...bigIntsAddressOutputsItem,
];
