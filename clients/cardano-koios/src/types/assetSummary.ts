 ...
 */
import type { AssetSummaryItem } from './assetSummaryItem';

import { bigIntsAssetSummaryItem } from './assetSummaryItem';

/**
 * Array of asset summary information
 */
export type AssetSummary = AssetSummaryItem[];
export const bigIntsAssetSummary: Array<string> = [...bigIntsAssetSummaryItem];
