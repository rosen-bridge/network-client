 ...
 */
import type { BlockTxInfoItem } from './blockTxInfoItem';
import { bigIntsBlockTxInfoItem } from './blockTxInfoItem';

/**
 * Array of detailed information about transaction(s)
 */
export type BlockTxInfo = BlockTxInfoItem[];
export const bigIntsBlockTxInfo: Array<string> = [...bigIntsBlockTxInfoItem];
