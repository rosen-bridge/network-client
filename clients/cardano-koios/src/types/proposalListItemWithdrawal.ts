 ...
 */
import type { ProposalListItemWithdrawalAnyOf } from './proposalListItemWithdrawalAnyOf';

import { bigIntsProposalListItemWithdrawalAnyOf } from './proposalListItemWithdrawalAnyOf';

/**
 * If not null, the amount withdrawn from treasury into stake address by this this proposal
 */
export type ProposalListItemWithdrawal =
  ProposalListItemWithdrawalAnyOf | null | null;
export const bigIntsProposalListItemWithdrawal: Array<string> = [
  ...bigIntsProposalListItemWithdrawalAnyOf,
];
