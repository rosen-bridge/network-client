 ...
 */
import type { EraSummariesItem } from './eraSummariesItem';
import { bigIntsEraSummariesItem } from './eraSummariesItem';

/**
 * Information about each era on the network alongwith it's start epoch
 */
export type EraSummaries = EraSummariesItem[];
export const bigIntsEraSummaries: Array<string> = [...bigIntsEraSummariesItem];
