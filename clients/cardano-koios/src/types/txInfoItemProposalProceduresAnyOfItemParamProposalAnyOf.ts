 ...
 */
export type TxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf: Array<string> =
  [];
