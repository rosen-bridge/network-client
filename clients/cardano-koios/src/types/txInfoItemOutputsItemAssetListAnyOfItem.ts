 ...
 */
import type { TxInfoItemOutputsItemAssetListAnyOfItemAssetName } from './txInfoItemOutputsItemAssetListAnyOfItemAssetName';

import { bigIntsTxInfoItemOutputsItemAssetListAnyOfItemAssetName } from './txInfoItemOutputsItemAssetListAnyOfItemAssetName';

export type TxInfoItemOutputsItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemOutputsItemAssetListAnyOfItemAssetName;
...
export const bigIntsTxInfoItemOutputsItemAssetListAnyOfItem: Array<string> = [
  ...bigIntsTxInfoItemOutputsItemAssetListAnyOfItemAssetName.map((item) =>
