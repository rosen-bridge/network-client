...
export type BlockTxInfoItemCollateralOutputAnyOfItemStakeAddr = null | string;
export const bigIntsBlockTxInfoItemCollateralOutputAnyOfItemStakeAddr: Array<string> =
  [];
