...
import type { PoolInfoItemActiveStake } from './poolInfoItemActiveStake';
import { bigIntsPoolInfoItemActiveStake } from './poolInfoItemActiveStake';
import type { PoolInfoItemBlockCount } from './poolInfoItemBlockCount';
import { bigIntsPoolInfoItemBlockCount } from './poolInfoItemBlockCount';
import type { PoolInfoItemDeposit } from './poolInfoItemDeposit';
import { bigIntsPoolInfoItemDeposit } from './poolInfoItemDeposit';
import type { PoolInfoItemFixedCost } from './poolInfoItemFixedCost';
import { bigIntsPoolInfoItemFixedCost } from './poolInfoItemFixedCost';
import type { PoolInfoItemLivePledge } from './poolInfoItemLivePledge';
import { bigIntsPoolInfoItemLivePledge } from './poolInfoItemLivePledge';
import type { PoolInfoItemLiveSaturation } from './poolInfoItemLiveSaturation';
import { bigIntsPoolInfoItemLiveSaturation } from './poolInfoItemLiveSaturation';
import type { PoolInfoItemLiveStake } from './poolInfoItemLiveStake';
import { bigIntsPoolInfoItemLiveStake } from './poolInfoItemLiveStake';
import type { PoolInfoItemMargin } from './poolInfoItemMargin';
import { bigIntsPoolInfoItemMargin } from './poolInfoItemMargin';
import type { PoolInfoItemMetaHash } from './poolInfoItemMetaHash';
import { bigIntsPoolInfoItemMetaHash } from './poolInfoItemMetaHash';
import type { PoolInfoItemMetaJson } from './poolInfoItemMetaJson';
import { bigIntsPoolInfoItemMetaJson } from './poolInfoItemMetaJson';
import type { PoolInfoItemMetaUrl } from './poolInfoItemMetaUrl';
import { bigIntsPoolInfoItemMetaUrl } from './poolInfoItemMetaUrl';
import type { PoolInfoItemOpCert } from './poolInfoItemOpCert';
...
import { bigIntsPoolInfoItemPoolStatus } from './poolInfoItemPoolStatus';
import type { PoolInfoItemRelaysItem } from './poolInfoItemRelaysItem';
import { bigIntsPoolInfoItemRelaysItem } from './poolInfoItemRelaysItem';
import type { PoolInfoItemRetiringEpoch } from './poolInfoItemRetiringEpoch';
import { bigIntsPoolInfoItemRetiringEpoch } from './poolInfoItemRetiringEpoch';
import type { PoolInfoItemRewardAddr } from './poolInfoItemRewardAddr';
import { bigIntsPoolInfoItemRewardAddr } from './poolInfoItemRewardAddr';
import type { PoolInfoItemRewardAddrDelegatedDrep } from './poolInfoItemRewardAddrDelegatedDrep';
import { bigIntsPoolInfoItemRewardAddrDelegatedDrep } from './poolInfoItemRewardAddrDelegatedDrep';
import type { PoolInfoItemSigma } from './poolInfoItemSigma';
import { bigIntsPoolInfoItemSigma } from './poolInfoItemSigma';
import type { PoolInfoItemVotingPower } from './poolInfoItemVotingPower';
import { bigIntsPoolInfoItemVotingPower } from './poolInfoItemVotingPower';
import type { PoolInfoItemVrfKeyHash } from './poolInfoItemVrfKeyHash';
import { bigIntsPoolInfoItemVrfKeyHash } from './poolInfoItemVrfKeyHash';
...
export type PoolInfoItem = {
  ...
  active_epoch_no?: PoolInfoItemActiveEpochNo;
  /** Pool VRF key hash */
  vrf_key_hash?: PoolInfoItemVrfKeyHash;
  /** Margin (decimal format) */
  margin?: PoolInfoItemMargin;
  /** Pool fixed cost per epoch */
  fixed_cost?: PoolInfoItemFixedCost;
  /** Pool pledge in number */
  pledge?: PoolInfoItemPledge;
  /** Pool's registration deposit in number */
  deposit?: PoolInfoItemDeposit;
  /** Pool reward address */
