 ...
 */
import type { BlockTxInfoItemOutputsItemAssetListAnyOfItem } from './blockTxInfoItemOutputsItemAssetListAnyOfItem';
import { bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItem } from './blockTxInfoItemOutputsItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type BlockTxInfoItemOutputsItemAssetList =
  | BlockTxInfoItemOutputsItemAssetListAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemOutputsItemAssetList: Array<string> = [
  ...bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItem,
];
