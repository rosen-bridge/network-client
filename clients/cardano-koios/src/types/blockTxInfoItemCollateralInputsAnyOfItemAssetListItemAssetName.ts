 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName =
  | string
  | null;
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName: Array<string> =
  [];
