 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItemAddress } from './txInfoItemPlutusContractsAnyOfItemAddress';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemAddress } from './txInfoItemPlutusContractsAnyOfItemAddress';
import type { TxInfoItemPlutusContractsAnyOfItemBytecode } from './txInfoItemPlutusContractsAnyOfItemBytecode';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemBytecode } from './txInfoItemPlutusContractsAnyOfItemBytecode';
import type { TxInfoItemPlutusContractsAnyOfItemInput } from './txInfoItemPlutusContractsAnyOfItemInput';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInput } from './txInfoItemPlutusContractsAnyOfItemInput';
import type { TxInfoItemPlutusContractsAnyOfItemScriptHash } from './txInfoItemPlutusContractsAnyOfItemScriptHash';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemScriptHash } from './txInfoItemPlutusContractsAnyOfItemScriptHash';
import type { TxInfoItemPlutusContractsAnyOfItemSpendsInput } from './txInfoItemPlutusContractsAnyOfItemSpendsInput';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemSpendsInput } from './txInfoItemPlutusContractsAnyOfItemSpendsInput';

export type TxInfoItemPlutusContractsAnyOfItem = {
  /** Plutus script address */
  address?: TxInfoItemPlutusContractsAnyOfItemAddress;
  /** Input utxo this contract spends */
  spends_input?: TxInfoItemPlutusContractsAnyOfItemSpendsInput;
  /** Hash of a script */
  script_hash?: TxInfoItemPlutusContractsAnyOfItemScriptHash;
  /** Script bytes (cborSeq) */
  bytecode?: TxInfoItemPlutusContractsAnyOfItemBytecode;
  /** The size of the CBOR serialised script (in bytes) */
  size?: number;
  /** True if the contract is valid or there is no contract */
  valid_contract?: boolean;
  input?: TxInfoItemPlutusContractsAnyOfItemInput;
};
