 ...
 */
import type { TxInfoItemMetadataAnyOf } from './txInfoItemMetadataAnyOf';

import { bigIntsTxInfoItemMetadataAnyOf } from './txInfoItemMetadataAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type TxInfoItemMetadata = TxInfoItemMetadataAnyOf | null | null;
export const bigIntsTxInfoItemMetadata: Array<string> = [
  ...bigIntsTxInfoItemMetadataAnyOf,
];
