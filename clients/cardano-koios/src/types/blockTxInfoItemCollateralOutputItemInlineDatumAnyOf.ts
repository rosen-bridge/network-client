 ...
 */
import type { BlockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue } from './blockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue';

import { bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue } from './blockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemCollateralOutputItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: BlockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue;
};

export const bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumAnyOf = [
  ...bigIntsBlockTxInfoItemCollateralOutputItemInlineDatumAnyOfValue.map(
