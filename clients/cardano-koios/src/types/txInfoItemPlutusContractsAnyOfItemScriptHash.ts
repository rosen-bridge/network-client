 ...
 * Hash of a script
 */
export type TxInfoItemPlutusContractsAnyOfItemScriptHash = null | string | null;
export const bigIntsTxInfoItemPlutusContractsAnyOfItemScriptHash: Array<string> =
  [];
