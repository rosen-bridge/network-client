 ...
 */
import type { TxInfoItemInputsItemInlineDatumAnyOfValue } from './txInfoItemInputsItemInlineDatumAnyOfValue';

import { bigIntsTxInfoItemInputsItemInlineDatumAnyOfValue } from './txInfoItemInputsItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemInputsItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemInputsItemInlineDatumAnyOfValue;
};

export const bigIntsTxInfoItemInputsItemInlineDatumAnyOf = [
