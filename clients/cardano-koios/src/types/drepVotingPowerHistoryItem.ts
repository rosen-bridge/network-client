 ...
 */
import type { DrepVotingPowerHistoryItemAmount } from './drepVotingPowerHistoryItemAmount';
import { bigIntsDrepVotingPowerHistoryItemAmount } from './drepVotingPowerHistoryItemAmount';

export type DrepVotingPowerHistoryItem = {
  /** DRep ID in CIP-129 bech32 format */
  drep_id?: string;
  /** Epoch number of the block */
  epoch_no?: number;
  /** The voting power for the DRep */
  amount?: DrepVotingPowerHistoryItemAmount;
};

export const bigIntsDrepVotingPowerHistoryItem: Array<string> = [
  ...bigIntsDrepVotingPowerHistoryItemAmount.map((item) =>
