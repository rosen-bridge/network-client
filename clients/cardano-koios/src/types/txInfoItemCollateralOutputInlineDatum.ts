 ...
 */
import type { TxInfoItemCollateralOutputInlineDatumValue } from './txInfoItemCollateralOutputInlineDatumValue';

import { bigIntsTxInfoItemCollateralOutputInlineDatumValue } from './txInfoItemCollateralOutputInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralOutputInlineDatum = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralOutputInlineDatumValue;
} | null;
