...
/**
 * The Ogmios method to be called (see more details [here](#tag--Ogmios)) or browse examples tab
 */
...
export const OgmiosBodyMethod = {
  ...
  'queryNetwork/startTime': 'queryNetwork/startTime',
  'queryNetwork/tip': 'queryNetwork/tip',
  'queryLedgerState/epoch': 'queryLedgerState/epoch',
  'queryLedgerState/eraStart': 'queryLedgerState/eraStart',
  'queryLedgerState/eraSummaries': 'queryLedgerState/eraSummaries',
  'queryLedgerState/liveStakeDistribution':
    'queryLedgerState/liveStakeDistribution',
  'queryLedgerState/protocolParameters': 'queryLedgerState/protocolParameters',
  'queryLedgerState/proposedProtocolParameters':
    'queryLedgerState/proposedProtocolParameters',
  'queryLedgerState/stakePools': 'queryLedgerState/stakePools',
  submitTransaction: 'submitTransaction',
  evaluateTransaction: 'evaluateTransaction',
} as const;
export const bigIntsOgmiosBodyMethod: Array<string> = [];
