 ...
 */
import type { ScriptListItemScriptHash } from './scriptListItemScriptHash';
import { bigIntsScriptListItemScriptHash } from './scriptListItemScriptHash';
import type { ScriptListItemType } from './scriptListItemType';

import { bigIntsScriptListItemType } from './scriptListItemType';

export type ScriptListItem = {
  /** Hash of the script creation transaction */
  creation_tx_hash?: string;
  /** Hash of a script */
  script_hash?: ScriptListItemScriptHash;
  /** The size of the CBOR serialised script (in bytes) */
  size?: number;
  /** Type of the script */
  type?: ScriptListItemType;
};

export const bigIntsScriptListItem = [
