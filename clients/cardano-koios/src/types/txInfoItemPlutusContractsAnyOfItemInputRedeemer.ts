 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatum';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerDatum';
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose';
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerUnit';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit } from './txInfoItemPlutusContractsAnyOfItemInputRedeemerUnit';

export type TxInfoItemPlutusContractsAnyOfItemInputRedeemer = {
  /** What kind of validation this redeemer is used for */
  purpose?: TxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose;
  /** The budget in fees to run a script - the fees depend on the ExUnits and the current prices */
  fee?: string;
  unit?: TxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit;
  datum?: TxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum;
};
