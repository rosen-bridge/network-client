 ...
 */
import type { NativeScriptListItemType } from './nativeScriptListItemType';

import { bigIntsNativeScriptListItemType } from './nativeScriptListItemType';

export type NativeScriptListItem = {
  /** Hash of a script */
  script_hash?: string;
