 ...
 */
import type { _PoolEpochNoParameter } from './_poolEpochNoParameter';

import { bigInts_PoolEpochNoParameter } from './_poolEpochNoParameter';

export type PoolRegistrationsParams = {
  /**
   * Epoch Number to fetch details for
   */
  _epoch_no?: _PoolEpochNoParameter;
};

export const bigIntsPoolRegistrationsParams = [
