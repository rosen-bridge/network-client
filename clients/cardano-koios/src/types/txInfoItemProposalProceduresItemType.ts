 ...
 */
export type TxInfoItemProposalProceduresItemType =
  (typeof TxInfoItemProposalProceduresItemType)[keyof typeof TxInfoItemProposalProceduresItemType];

// eslint-disable-next-line no-redeclare
export const TxInfoItemProposalProceduresItemType = {
...
export const bigIntsTxInfoItemProposalProceduresItemType: Array<string> = [];
