 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName =
  | string
  | null;
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName: Array<string> =
  [];
