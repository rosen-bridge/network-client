 ...
 */
import type { PoolOwnerHistoryItem } from './poolOwnerHistoryItem';
import { bigIntsPoolOwnerHistoryItem } from './poolOwnerHistoryItem';

/**
 * Array of pool owner's stake history
 */
export type PoolOwnerHistory = PoolOwnerHistoryItem[];
export const bigIntsPoolOwnerHistory: Array<string> = [
  ...bigIntsPoolOwnerHistoryItem,
];
