 ...
 * Type of the script
 */
export type ScriptListItemType =
  (typeof ScriptListItemType)[keyof typeof ScriptListItemType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ScriptListItemType = {
  plutusV1: 'plutusV1',
  plutusV2: 'plutusV2',
  timelock: 'timelock',
  multisig: 'multisig',
} as const;
export const bigIntsScriptListItemType: Array<string> = [];
