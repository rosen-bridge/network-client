 ...
 */
import type { CommitteeInfoMembersItemCcHotHasScript } from './committeeInfoMembersItemCcHotHasScript';
import { bigIntsCommitteeInfoMembersItemCcHotHasScript } from './committeeInfoMembersItemCcHotHasScript';
import type { CommitteeInfoMembersItemCcHotHex } from './committeeInfoMembersItemCcHotHex';
import { bigIntsCommitteeInfoMembersItemCcHotHex } from './committeeInfoMembersItemCcHotHex';
import type { CommitteeInfoMembersItemStatus } from './committeeInfoMembersItemStatus';

import { bigIntsCommitteeInfoMembersItemStatus } from './committeeInfoMembersItemStatus';

export type CommitteeInfoMembersItem = {
  ...
  cc_cold_hex?: string;
  /** Flag which shows if this credential is a script hash */
  cc_hot_has_script?: CommitteeInfoMembersItemCcHotHasScript;
  /** Committee member key hash from last valid hot key authorization certificate in hex format */
  cc_hot_hex?: CommitteeInfoMembersItemCcHotHex;
  /** Epoch number in which the committee member vote rights expire */
  expiration_epoch?: number;
  /** Member authentication status */
  status?: CommitteeInfoMembersItemStatus;
};

export const bigIntsCommitteeInfoMembersItem = [
