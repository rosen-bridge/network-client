 ...
 */
export type DrepListItemDrepStatus =
  (typeof DrepListItemDrepStatus)[keyof typeof DrepListItemDrepStatus];

// eslint-disable-next-line no-redeclare
export const DrepListItemDrepStatus = {
  registered: 'registered',
  deregistered: 'deregistered',
  not_registered: 'not_registered',
} as const;
export const bigIntsDrepListItemDrepStatus: Array<string> = [];
