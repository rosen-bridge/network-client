 ...
 */
import type { TxInfoItemProposalProceduresAnyOfItem } from './txInfoItemProposalProceduresAnyOfItem';
import { bigIntsTxInfoItemProposalProceduresAnyOfItem } from './txInfoItemProposalProceduresAnyOfItem';

/**
 * Governance proposals in a transaction (if any)
 */
export type TxInfoItemProposalProcedures =
  | TxInfoItemProposalProceduresAnyOfItem[]
  | null;
export const bigIntsTxInfoItemProposalProcedures: Array<string> = [
  ...bigIntsTxInfoItemProposalProceduresAnyOfItem,
];
