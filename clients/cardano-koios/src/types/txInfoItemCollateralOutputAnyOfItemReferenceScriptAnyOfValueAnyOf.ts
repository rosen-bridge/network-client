 ...
 * Value (json)
 */
export type TxInfoItemCollateralOutputAnyOfItemReferenceScriptAnyOfValueAnyOf =
  { [key: string]: unknown };
export const bigIntsTxInfoItemCollateralOutputAnyOfItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
