 ...
 */
import type { PoolBlocksItem } from './poolBlocksItem';
import { bigIntsPoolBlocksItem } from './poolBlocksItem';

/**
 * Array of blocks created by pool
 */
export type PoolBlocks = PoolBlocksItem[];
export const bigIntsPoolBlocks: Array<string> = [...bigIntsPoolBlocksItem];
