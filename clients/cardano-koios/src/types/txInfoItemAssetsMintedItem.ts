 ...
 */
import type { TxInfoItemAssetsMintedItemAssetName } from './txInfoItemAssetsMintedItemAssetName';
import { bigIntsTxInfoItemAssetsMintedItemAssetName } from './txInfoItemAssetsMintedItemAssetName';

export type TxInfoItemAssetsMintedItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemAssetsMintedItemAssetName;
...
export const bigIntsTxInfoItemAssetsMintedItem: Array<string> = [
  ...bigIntsTxInfoItemAssetsMintedItemAssetName.map((item) =>
