 ...
 */
import type { VoterProposalListItemMetaJsonAnyOf } from './voterProposalListItemMetaJsonAnyOf';

import { bigIntsVoterProposalListItemMetaJsonAnyOf } from './voterProposalListItemMetaJsonAnyOf';

/**
 * The payload as JSON
 */
export type VoterProposalListItemMetaJson =
  null | VoterProposalListItemMetaJsonAnyOf | null;
export const bigIntsVoterProposalListItemMetaJson: Array<string> = [
  ...bigIntsVoterProposalListItemMetaJsonAnyOf,
];
