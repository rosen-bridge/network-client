 ...
 */
export type TxInfoItemPlutusContractsItemInputRedeemerDatumHash = string | null;
export const bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatumHash: Array<string> =
  [];
