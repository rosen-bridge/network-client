...
/**
 * Get Current Protocol Parameters from node as published by cardano-cli in JSON format
 */
export interface CliProtocolParams {
  [key: string]: unknown;
}
export const bigIntsCliProtocolParams: Array<string> = [];
