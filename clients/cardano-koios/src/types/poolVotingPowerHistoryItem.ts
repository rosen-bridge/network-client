 ...
 */
import type { PoolVotingPowerHistoryItemAmount } from './poolVotingPowerHistoryItemAmount';
import { bigIntsPoolVotingPowerHistoryItemAmount } from './poolVotingPowerHistoryItemAmount';

export type PoolVotingPowerHistoryItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  /** Epoch number of the block */
  epoch_no?: number;
  /** The voting power for the pool for the epoch */
  amount?: PoolVotingPowerHistoryItemAmount;
};

export const bigIntsPoolVotingPowerHistoryItem: Array<string> = [
  ...bigIntsPoolVotingPowerHistoryItemAmount.map((item) =>
