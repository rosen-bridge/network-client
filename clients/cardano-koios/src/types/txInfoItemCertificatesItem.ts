 ...
 */
import type { TxInfoItemCertificatesItemIndex } from './txInfoItemCertificatesItemIndex';
import { bigIntsTxInfoItemCertificatesItemIndex } from './txInfoItemCertificatesItemIndex';
import type { TxInfoItemCertificatesItemInfo } from './txInfoItemCertificatesItemInfo';
import { bigIntsTxInfoItemCertificatesItemInfo } from './txInfoItemCertificatesItemInfo';

export type TxInfoItemCertificatesItem = {
  /** Certificate index */
  index?: TxInfoItemCertificatesItemIndex;
...
export const bigIntsTxInfoItemCertificatesItem: Array<string> = [
  ...bigIntsTxInfoItemCertificatesItemIndex.map((item) =>
