 ...
 */
import type { AssetInfoItemAssetName } from './assetInfoItemAssetName';
import { bigIntsAssetInfoItemAssetName } from './assetInfoItemAssetName';
import type { AssetInfoItemMintingTxMetadataAllOf } from './assetInfoItemMintingTxMetadataAllOf';
import { bigIntsAssetInfoItemMintingTxMetadataAllOf } from './assetInfoItemMintingTxMetadataAllOf';
import type { AssetInfoItemTokenRegistryMetadata } from './assetInfoItemTokenRegistryMetadata';
import { bigIntsAssetInfoItemTokenRegistryMetadata } from './assetInfoItemTokenRegistryMetadata';
import type { AssetInfoItemCip68Metadata } from './assetInfoItemCip68Metadata';

import { bigIntsAssetInfoItemCip68Metadata } from './assetInfoItemCip68Metadata';

export type AssetInfoItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AssetInfoItemAssetName;
  /** Asset Name (ASCII) */
  asset_name_ascii?: string;
  /** The CIP14 fingerprint of the asset */
  fingerprint?: string;
  /** Hash of the latest mint transaction (with metadata if found for asset) */
  ...
  token_registry_metadata?: AssetInfoItemTokenRegistryMetadata;
  /** CIP 68 metadata if present for asset */
  cip68_metadata?: AssetInfoItemCip68Metadata;
};
