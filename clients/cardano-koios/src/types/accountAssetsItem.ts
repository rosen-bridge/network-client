 ...
 */
import type { AccountAssetsItemAssetName } from './accountAssetsItemAssetName';
import { bigIntsAccountAssetsItemAssetName } from './accountAssetsItemAssetName';

export type AccountAssetsItem = {
  /** Cardano staking address (reward account) in bech32 format */
  stake_address?: string;
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AccountAssetsItemAssetName;
