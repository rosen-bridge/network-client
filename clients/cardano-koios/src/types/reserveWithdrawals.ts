 ...
 */
import type { ReserveWithdrawalsItem } from './reserveWithdrawalsItem';

import { bigIntsReserveWithdrawalsItem } from './reserveWithdrawalsItem';

/**
 * Array of withdrawals from reserves/treasury against stake accounts
 */
export type ReserveWithdrawals = ReserveWithdrawalsItem[];
export const bigIntsReserveWithdrawals: Array<string> = [
  ...bigIntsReserveWithdrawalsItem,
];
