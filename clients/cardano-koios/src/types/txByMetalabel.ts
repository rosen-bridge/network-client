 ...
 */
import type { TxByMetalabelItem } from './txByMetalabelItem';
import { bigIntsTxByMetalabelItem } from './txByMetalabelItem';

/**
 * Array of transactions containing the queried metadata label
 */
export type TxByMetalabel = TxByMetalabelItem[];
export const bigIntsTxByMetalabel: Array<string> = [
  ...bigIntsTxByMetalabelItem,
];
