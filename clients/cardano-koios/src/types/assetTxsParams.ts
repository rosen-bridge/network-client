 ...
 */
import type { _AssetPolicyParameter } from './_assetPolicyParameter';
import { bigInts_AssetPolicyParameter } from './_assetPolicyParameter';
import type { _AssetNameParameter } from './_assetNameParameter';
import { bigInts_AssetNameParameter } from './_assetNameParameter';
import type { _AfterBlockHeightParameter } from './_afterBlockHeightParameter';
import { bigInts_AfterBlockHeightParameter } from './_afterBlockHeightParameter';
import type { _HistoryParameter } from './_historyParameter';

import { bigInts_HistoryParameter } from './_historyParameter';

export type AssetTxsParams = {
  /**
   * Asset Policy ID in hexadecimal format (hex)
   */
  _asset_policy: _AssetPolicyParameter;
  /**
   * Asset Name in hexadecimal format (hex), empty asset name returns royalties
   */
  _asset_name?: _AssetNameParameter;
  /**
   * Block height for specifying time delta
   */
  _after_block_height?: _AfterBlockHeightParameter;
  /**
   * Include all historical transactions, setting to false includes only the non-empty ones
   */
  _history?: _HistoryParameter;
};

export const bigIntsAssetTxsParams = [
