 ...
 */
import type { ScriptRedeemersItemRedeemersItemDatumValueAnyOf } from './scriptRedeemersItemRedeemersItemDatumValueAnyOf';

import { bigIntsScriptRedeemersItemRedeemersItemDatumValueAnyOf } from './scriptRedeemersItemRedeemersItemDatumValueAnyOf';

/**
 * Data in JSON format
 */
export type ScriptRedeemersItemRedeemersItemDatumValue =
  ScriptRedeemersItemRedeemersItemDatumValueAnyOf | null | null;
export const bigIntsScriptRedeemersItemRedeemersItemDatumValue: Array<string> =
  [...bigIntsScriptRedeemersItemRedeemersItemDatumValueAnyOf];
