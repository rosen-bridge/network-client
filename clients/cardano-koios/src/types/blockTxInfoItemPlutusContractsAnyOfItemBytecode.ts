 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemBytecode = string | null;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemBytecode: Array<string> =
  [];
