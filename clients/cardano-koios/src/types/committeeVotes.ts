 ...
 */
import type { CommitteeVotesItem } from './committeeVotesItem';
import { bigIntsCommitteeVotesItem } from './committeeVotesItem';

/**
 * List of all votes casted by requested delegated representative (DRep)
 */
export type CommitteeVotes = CommitteeVotesItem[];
export const bigIntsCommitteeVotes: Array<string> = [
  ...bigIntsCommitteeVotesItem,
];
