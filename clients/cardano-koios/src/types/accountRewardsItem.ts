 ...
 */
import type { AccountRewardsItemRewardsItem } from './accountRewardsItemRewardsItem';
import { bigIntsAccountRewardsItemRewardsItem } from './accountRewardsItemRewardsItem';
...
export const bigIntsAccountRewardsItem: Array<string> = [
