 ...
 * Pool status
 */
export type PoolCalidusKeysItemPoolStatus =
  (typeof PoolCalidusKeysItemPoolStatus)[keyof typeof PoolCalidusKeysItemPoolStatus];

// eslint-disable-next-line no-redeclare
export const PoolCalidusKeysItemPoolStatus = {
  registered: 'registered',
  retiring: 'retiring',
  retired: 'retired',
} as const;
export const bigIntsPoolCalidusKeysItemPoolStatus: Array<string> = [];
