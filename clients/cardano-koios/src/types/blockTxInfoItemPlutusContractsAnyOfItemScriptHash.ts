 ...
 * Hash of a script
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemScriptHash = null | string;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemScriptHash: Array<string> =
  [];
