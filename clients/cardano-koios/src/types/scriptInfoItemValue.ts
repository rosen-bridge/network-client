 ...
 */
import type { ScriptInfoItemValueAnyOf } from './scriptInfoItemValueAnyOf';

import { bigIntsScriptInfoItemValueAnyOf } from './scriptInfoItemValueAnyOf';

/**
 * Data in JSON format
 */
export type ScriptInfoItemValue = ScriptInfoItemValueAnyOf | null | null;
export const bigIntsScriptInfoItemValue: Array<string> = [
  ...bigIntsScriptInfoItemValueAnyOf,
];
