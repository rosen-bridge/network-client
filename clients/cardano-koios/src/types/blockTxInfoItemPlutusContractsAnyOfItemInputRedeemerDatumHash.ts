 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash =
  | string
  | null
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumHash: Array<string> =
  [];
