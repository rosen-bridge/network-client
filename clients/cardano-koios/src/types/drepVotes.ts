 ...
 */
import type { DrepVotesItem } from './drepVotesItem';

import { bigIntsDrepVotesItem } from './drepVotesItem';

/**
 * List of all votes casted by requested delegated representative (DRep)
 */
export type DrepVotes = DrepVotesItem[];
export const bigIntsDrepVotes: Array<string> = [...bigIntsDrepVotesItem];
