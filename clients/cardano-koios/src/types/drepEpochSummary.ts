 ...
 */
import type { DrepEpochSummaryItem } from './drepEpochSummaryItem';

import { bigIntsDrepEpochSummaryItem } from './drepEpochSummaryItem';

/**
 * Summary of voting power and DRep count for each epoch
 */
export type DrepEpochSummary = DrepEpochSummaryItem[];
export const bigIntsDrepEpochSummary: Array<string> = [
  ...bigIntsDrepEpochSummaryItem,
];
