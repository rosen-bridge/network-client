 ...
 */
import type { ScriptUtxosItemScriptHash } from './scriptUtxosItemScriptHash';
import { bigIntsScriptUtxosItemScriptHash } from './scriptUtxosItemScriptHash';

export type ScriptUtxosItem = {
  /** Hash of a script */
  script_hash?: ScriptUtxosItemScriptHash;
...
export const bigIntsScriptUtxosItem: Array<string> = [
  ...bigIntsScriptUtxosItemScriptHash.map((item) =>
