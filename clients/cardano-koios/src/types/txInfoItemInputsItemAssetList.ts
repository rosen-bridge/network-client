 ...
 */
import type { TxInfoItemInputsItemAssetListAnyOfItem } from './txInfoItemInputsItemAssetListAnyOfItem';

import { bigIntsTxInfoItemInputsItemAssetListAnyOfItem } from './txInfoItemInputsItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type TxInfoItemInputsItemAssetList =
  | TxInfoItemInputsItemAssetListAnyOfItem[]
  | null
  | null;
export const bigIntsTxInfoItemInputsItemAssetList: Array<string> = [
  ...bigIntsTxInfoItemInputsItemAssetListAnyOfItem,
];
