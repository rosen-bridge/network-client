 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName =
  | string
  | null
  | null;
export const bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName: Array<string> =
  [];
