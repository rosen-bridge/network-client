 ...
 */
import type { TxOutsEpochItem } from './txOutsEpochItem';
import { bigIntsTxOutsEpochItem } from './txOutsEpochItem';

/**
 * List of transaction outputs with basic details for requested epoch
 */
export type TxOutsEpoch = TxOutsEpochItem[];
export const bigIntsTxOutsEpoch: Array<string> = [...bigIntsTxOutsEpochItem];
