 ...
 */
import type { TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf } from './txInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf';

import { bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf } from './txInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralOutputAnyOfItemInlineDatum =
  TxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf | null | null;
export const bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatum: Array<string> =
  [...bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatumAnyOf];
