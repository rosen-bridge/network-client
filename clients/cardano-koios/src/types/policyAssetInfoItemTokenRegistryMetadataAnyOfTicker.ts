...
export type PolicyAssetInfoItemTokenRegistryMetadataAnyOfTicker = null | string;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataAnyOfTicker: Array<string> =
  [];
