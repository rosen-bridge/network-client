 ...
 */
import type { PoolListItemRelaysItemDns } from './poolListItemRelaysItemDns';
import { bigIntsPoolListItemRelaysItemDns } from './poolListItemRelaysItemDns';
import type { PoolListItemRelaysItemIpv4 } from './poolListItemRelaysItemIpv4';
import { bigIntsPoolListItemRelaysItemIpv4 } from './poolListItemRelaysItemIpv4';
import type { PoolListItemRelaysItemIpv6 } from './poolListItemRelaysItemIpv6';
import { bigIntsPoolListItemRelaysItemIpv6 } from './poolListItemRelaysItemIpv6';
import type { PoolListItemRelaysItemPort } from './poolListItemRelaysItemPort';
import { bigIntsPoolListItemRelaysItemPort } from './poolListItemRelaysItemPort';
import type { PoolListItemRelaysItemSrv } from './poolListItemRelaysItemSrv';

import { bigIntsPoolListItemRelaysItemSrv } from './poolListItemRelaysItemSrv';

export type PoolListItemRelaysItem = {
  /** DNS name of the relay (nullable) */
  dns?: PoolListItemRelaysItemDns;
  /** IPv4 address of the relay (nullable) */
  ipv4?: PoolListItemRelaysItemIpv4;
  /** IPv6 address of the relay (nullable) */
  ipv6?: PoolListItemRelaysItemIpv6;
  /** Port number of the relay (nullable) */
  port?: PoolListItemRelaysItemPort;
  /** DNS service name of the relay (nullable) */
  srv?: PoolListItemRelaysItemSrv;
};

export const bigIntsPoolListItemRelaysItem = [
