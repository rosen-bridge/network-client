 ...
 */
import type { PolicyAssetMintsItem } from './policyAssetMintsItem';
import { bigIntsPolicyAssetMintsItem } from './policyAssetMintsItem';

/**
 * Array of mint information for assets under requested policies
 */
export type PolicyAssetMints = PolicyAssetMintsItem[];
export const bigIntsPolicyAssetMints: Array<string> = [
  ...bigIntsPolicyAssetMintsItem,
];
