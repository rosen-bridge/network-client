 ...
 */
import type { TxUtxosItemOutputsItemInlineDatumValue } from './txUtxosItemOutputsItemInlineDatumValue';

import { bigIntsTxUtxosItemOutputsItemInlineDatumValue } from './txUtxosItemOutputsItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxUtxosItemOutputsItemInlineDatum = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxUtxosItemOutputsItemInlineDatumValue;
} | null;

export const bigIntsTxUtxosItemOutputsItemInlineDatum = [
  ...bigIntsTxUtxosItemOutputsItemInlineDatumValue.map((item) =>
