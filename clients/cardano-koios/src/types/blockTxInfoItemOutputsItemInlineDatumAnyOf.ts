 ...
 */
import type { BlockTxInfoItemOutputsItemInlineDatumAnyOfValue } from './blockTxInfoItemOutputsItemInlineDatumAnyOfValue';

import { bigIntsBlockTxInfoItemOutputsItemInlineDatumAnyOfValue } from './blockTxInfoItemOutputsItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemOutputsItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: BlockTxInfoItemOutputsItemInlineDatumAnyOfValue;
};

export const bigIntsBlockTxInfoItemOutputsItemInlineDatumAnyOf = [
