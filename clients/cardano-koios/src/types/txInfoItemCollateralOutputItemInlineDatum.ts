 ...
 */
import type { TxInfoItemCollateralOutputItemInlineDatumAnyOf } from './txInfoItemCollateralOutputItemInlineDatumAnyOf';
import { bigIntsTxInfoItemCollateralOutputItemInlineDatumAnyOf } from './txInfoItemCollateralOutputItemInlineDatumAnyOf';
import type { TxInfoItemCollateralOutputItemInlineDatumValue } from './txInfoItemCollateralOutputItemInlineDatumValue';
import { bigIntsTxInfoItemCollateralOutputItemInlineDatumValue } from './txInfoItemCollateralOutputItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralOutputItemInlineDatum =
  | (TxInfoItemCollateralOutputItemInlineDatumAnyOf & {
      /** Datum bytes (hex) */
      bytes?: string;
      /** Value (json) */
      value?: TxInfoItemCollateralOutputItemInlineDatumValue;
    })
  | (null & {
      /** Datum bytes (hex) */
      bytes?: string;
...
export const bigIntsTxInfoItemCollateralOutputItemInlineDatum: Array<string> = [
  ...bigIntsTxInfoItemCollateralOutputItemInlineDatumValue.map((item) =>
