 ...
 */
import type { TxInfoItemNativeScriptsItemScriptHash } from './txInfoItemNativeScriptsItemScriptHash';
import { bigIntsTxInfoItemNativeScriptsItemScriptHash } from './txInfoItemNativeScriptsItemScriptHash';
import type { TxInfoItemNativeScriptsItemScriptJson } from './txInfoItemNativeScriptsItemScriptJson';
import { bigIntsTxInfoItemNativeScriptsItemScriptJson } from './txInfoItemNativeScriptsItemScriptJson';

export type TxInfoItemNativeScriptsItem = {
  /** Hash of a script */
  script_hash?: TxInfoItemNativeScriptsItemScriptHash;
  /** JSON representation of the timelock script (null for other script types) */
  script_json?: TxInfoItemNativeScriptsItemScriptJson;
};

export const bigIntsTxInfoItemNativeScriptsItem: Array<string> = [
  ...bigIntsTxInfoItemNativeScriptsItemScriptHash.map((item) =>
