 ...
 */
import type { PoolSnapshotItem } from './poolSnapshotItem';
import { bigIntsPoolSnapshotItem } from './poolSnapshotItem';

export type PoolSnapshot = PoolSnapshotItem[];
export const bigIntsPoolSnapshot: Array<string> = [...bigIntsPoolSnapshotItem];
