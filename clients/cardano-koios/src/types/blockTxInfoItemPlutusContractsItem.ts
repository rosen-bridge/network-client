 ...
 */
import type { BlockTxInfoItemPlutusContractsItemAddress } from './blockTxInfoItemPlutusContractsItemAddress';
import { bigIntsBlockTxInfoItemPlutusContractsItemAddress } from './blockTxInfoItemPlutusContractsItemAddress';
import type { BlockTxInfoItemPlutusContractsItemBytecode } from './blockTxInfoItemPlutusContractsItemBytecode';
import { bigIntsBlockTxInfoItemPlutusContractsItemBytecode } from './blockTxInfoItemPlutusContractsItemBytecode';
import type { BlockTxInfoItemPlutusContractsItemInput } from './blockTxInfoItemPlutusContractsItemInput';
import { bigIntsBlockTxInfoItemPlutusContractsItemInput } from './blockTxInfoItemPlutusContractsItemInput';
import type { BlockTxInfoItemPlutusContractsItemScriptHash } from './blockTxInfoItemPlutusContractsItemScriptHash';
import { bigIntsBlockTxInfoItemPlutusContractsItemScriptHash } from './blockTxInfoItemPlutusContractsItemScriptHash';
import type { BlockTxInfoItemPlutusContractsItemSpendsInput } from './blockTxInfoItemPlutusContractsItemSpendsInput';
import { bigIntsBlockTxInfoItemPlutusContractsItemSpendsInput } from './blockTxInfoItemPlutusContractsItemSpendsInput';

export type BlockTxInfoItemPlutusContractsItem = {
  /** Plutus script address */
  address?: BlockTxInfoItemPlutusContractsItemAddress;
  /** Input utxo this contract spends */
  spends_input?: BlockTxInfoItemPlutusContractsItemSpendsInput;
  /** Hash of a script */
  script_hash?: BlockTxInfoItemPlutusContractsItemScriptHash;
  /** Script bytes (cborSeq) */
  bytecode?: BlockTxInfoItemPlutusContractsItemBytecode;
  /** The size of the CBOR serialised script (in bytes) */
  size?: number;
  /** True if the contract is valid or there is no contract */
  valid_contract?: boolean;
  input?: BlockTxInfoItemPlutusContractsItemInput;
};

export const bigIntsBlockTxInfoItemPlutusContractsItem: Array<string> = [
  ...bigIntsBlockTxInfoItemPlutusContractsItemAddress.map((item) =>
    item === '' ? 'address' : `address.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemSpendsInput.map((item) =>
    item === '' ? 'spends_input' : `spends_input.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemScriptHash.map((item) =>
    item === '' ? 'script_hash' : `script_hash.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemBytecode.map((item) =>
    item === '' ? 'bytecode' : `bytecode.${item}`,
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemInput.map((item) =>
