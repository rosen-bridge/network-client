 ...
 */
import type { AccountAssetsItem } from './accountAssetsItem';

import { bigIntsAccountAssetsItem } from './accountAssetsItem';

/**
 * Array of assets owned by account
 */
export type AccountAssets = AccountAssetsItem[];
export const bigIntsAccountAssets: Array<string> = [
  ...bigIntsAccountAssetsItem,
];
