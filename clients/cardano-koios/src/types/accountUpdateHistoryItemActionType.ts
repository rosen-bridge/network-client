 ...
 */
export type AccountUpdateHistoryItemActionType =
  (typeof AccountUpdateHistoryItemActionType)[keyof typeof AccountUpdateHistoryItemActionType];

// eslint-disable-next-line no-redeclare
export const AccountUpdateHistoryItemActionType = {
  registration: 'registration',
  delegation_pool: 'delegation_pool',
  delegation_drep: 'delegation_drep',
  withdrawal: 'withdrawal',
  deregistration: 'deregistration',
} as const;
export const bigIntsAccountUpdateHistoryItemActionType: Array<string> = [];
