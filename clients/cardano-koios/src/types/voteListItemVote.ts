 ...
 * Actual Vote casted
 */
export type VoteListItemVote =
  (typeof VoteListItemVote)[keyof typeof VoteListItemVote];

// eslint-disable-next-line no-redeclare
export const VoteListItemVote = {
  Yes: 'Yes',
  No: 'No',
  Abstain: 'Abstain',
} as const;
export const bigIntsVoteListItemVote: Array<string> = [];
