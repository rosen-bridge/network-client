...
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemInlineDatum } from './blockTxInfoItemCollateralInputsAnyOfItemInlineDatum';
import type { BlockTxInfoItemCollateralInputsAnyOfItemPaymentAddr } from './blockTxInfoItemCollateralInputsAnyOfItemPaymentAddr';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemPaymentAddr } from './blockTxInfoItemCollateralInputsAnyOfItemPaymentAddr';
import type { BlockTxInfoItemCollateralInputsAnyOfItemReferenceScript } from './blockTxInfoItemCollateralInputsAnyOfItemReferenceScript';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemReferenceScript } from './blockTxInfoItemCollateralInputsAnyOfItemReferenceScript';
import type { BlockTxInfoItemCollateralInputsAnyOfItemStakeAddr } from './blockTxInfoItemCollateralInputsAnyOfItemStakeAddr';

import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemStakeAddr } from './blockTxInfoItemCollateralInputsAnyOfItemStakeAddr';

export type BlockTxInfoItemCollateralInputsAnyOfItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: BlockTxInfoItemCollateralInputsAnyOfItemAssetListItem[] | null;
  /** Hash of datum (if any) connected to UTxO */
  datum_hash?: BlockTxInfoItemCollateralInputsAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemCollateralInputsAnyOfItemInlineDatum;
  payment_addr?: BlockTxInfoItemCollateralInputsAnyOfItemPaymentAddr;
  ...
  stake_addr?: BlockTxInfoItemCollateralInputsAnyOfItemStakeAddr;
...
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItem = [
  ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemPaymentAddr.map((item) =>
  ...
  ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemStakeAddr.map((item) =>
