 ...
 */
import type { TxInfoItemPlutusContractsItemInputDatumHash } from './txInfoItemPlutusContractsItemInputDatumHash';
import { bigIntsTxInfoItemPlutusContractsItemInputDatumHash } from './txInfoItemPlutusContractsItemInputDatumHash';
import type { TxInfoItemPlutusContractsItemInputDatumValue } from './txInfoItemPlutusContractsItemInputDatumValue';
import { bigIntsTxInfoItemPlutusContractsItemInputDatumValue } from './txInfoItemPlutusContractsItemInputDatumValue';

export type TxInfoItemPlutusContractsItemInputDatum = {
  /** The Hash of the Plutus Data */
  hash?: TxInfoItemPlutusContractsItemInputDatumHash;
  /** Data in JSON format */
  value?: TxInfoItemPlutusContractsItemInputDatumValue;
};

export const bigIntsTxInfoItemPlutusContractsItemInputDatum: Array<string> = [
  ...bigIntsTxInfoItemPlutusContractsItemInputDatumHash.map((item) =>
    item === '' ? 'hash' : `hash.${item}`,
  ),
  ...bigIntsTxInfoItemPlutusContractsItemInputDatumValue.map((item) =>
