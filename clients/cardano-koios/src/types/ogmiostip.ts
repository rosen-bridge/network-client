 ...
 */
import type { OgmiostipResult } from './ogmiostipResult';

import { bigIntsOgmiostipResult } from './ogmiostipResult';

/**
 * Current tip of the chain, identified by a slot and a block header hash.
 */
export interface Ogmiostip {
  /** Identifier for JSON-RPC 2.0 standard */
  jsonrpc?: string;
  /** The Ogmios method that was called in the request */
  method?: string;
  /**
   * Result of the query
   * @nullable
   */
  result?: OgmiostipResult;
}

export const bigIntsOgmiostip = [
