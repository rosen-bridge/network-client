 ...
 */
import type { VoterProposalListItemParamProposalAnyOf } from './voterProposalListItemParamProposalAnyOf';

import { bigIntsVoterProposalListItemParamProposalAnyOf } from './voterProposalListItemParamProposalAnyOf';

/**
 * If not null, the proposed new parameter set
 */
export type VoterProposalListItemParamProposal =
  VoterProposalListItemParamProposalAnyOf | null | null;
export const bigIntsVoterProposalListItemParamProposal: Array<string> = [
  ...bigIntsVoterProposalListItemParamProposalAnyOf,
];
