 ...
 * Asset Name (hex)
 */
export type TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName =
  | string
  | null
  | null;
export const bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName: Array<string> =
  [];
