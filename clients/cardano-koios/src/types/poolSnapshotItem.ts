 ...
 */
import type { PoolSnapshotItemNonce } from './poolSnapshotItemNonce';

import { bigIntsPoolSnapshotItemNonce } from './poolSnapshotItemNonce';

/**
 * Array of pool stake information for 3 snapshots
 */
export type PoolSnapshotItem = {
  /** Total Active Stake for the given epoch */
  active_stake?: string;
  /** Epoch number for the snapshot entry */
  epoch_no?: number;
  /** The nonce value for this epoch */
  nonce?: PoolSnapshotItemNonce;
...
export const bigIntsPoolSnapshotItem = [
