 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName =
  string | null | null;
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName: Array<string> =
  [];
