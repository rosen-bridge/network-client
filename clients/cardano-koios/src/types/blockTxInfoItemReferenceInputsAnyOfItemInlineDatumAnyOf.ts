 ...
 */
import type { BlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue } from './blockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue';

import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue } from './blockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: BlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue;
};

export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOf: Array<string> =
  [
    ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue.map(
