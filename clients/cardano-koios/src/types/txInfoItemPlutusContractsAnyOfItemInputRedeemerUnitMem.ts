 ...
 */
export type TxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem =
  | string
  | number
  | null;
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem: Array<string> =
  [];
