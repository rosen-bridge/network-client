 ...
 */
export type AccountRewardHistoryItemType =
  (typeof AccountRewardHistoryItemType)[keyof typeof AccountRewardHistoryItemType];

// eslint-disable-next-line no-redeclare
export const AccountRewardHistoryItemType = {
  member: 'member',
  leader: 'leader',
  treasury: 'treasury',
  reserves: 'reserves',
...
export const bigIntsAccountRewardHistoryItemType: Array<string> = [];
