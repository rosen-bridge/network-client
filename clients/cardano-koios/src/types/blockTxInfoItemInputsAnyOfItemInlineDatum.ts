 ...
 */
import type { BlockTxInfoItemInputsAnyOfItemInlineDatumAnyOf } from './blockTxInfoItemInputsAnyOfItemInlineDatumAnyOf';
import { bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatumAnyOf } from './blockTxInfoItemInputsAnyOfItemInlineDatumAnyOf';
import type { BlockTxInfoItemInputsAnyOfItemInlineDatumValue } from './blockTxInfoItemInputsAnyOfItemInlineDatumValue';
import { bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatumValue } from './blockTxInfoItemInputsAnyOfItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type BlockTxInfoItemInputsAnyOfItemInlineDatum =
  | (BlockTxInfoItemInputsAnyOfItemInlineDatumAnyOf & {
      /** Datum bytes (hex) */
      bytes?: string;
      /** Value (json) */
      value?: BlockTxInfoItemInputsAnyOfItemInlineDatumValue;
    })
  | (null & {
      /** Datum bytes (hex) */
      bytes?: string;
...
export const bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatum: Array<string> = [
  ...bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatumValue.map((item) =>
