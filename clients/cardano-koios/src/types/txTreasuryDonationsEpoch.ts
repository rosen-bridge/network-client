 ...
 */
import type { TxTreasuryDonationsEpochItem } from './txTreasuryDonationsEpochItem';
import { bigIntsTxTreasuryDonationsEpochItem } from './txTreasuryDonationsEpochItem';

/**
 * List of treasury donation transactions for requested epoch (current if NULL)
 */
export type TxTreasuryDonationsEpoch = TxTreasuryDonationsEpochItem[];
export const bigIntsTxTreasuryDonationsEpoch: Array<string> = [
  ...bigIntsTxTreasuryDonationsEpochItem,
];
