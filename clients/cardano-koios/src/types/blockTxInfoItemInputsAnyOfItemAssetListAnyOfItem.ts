 ...
 */
import type { BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName';
import { bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName';

export type BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName;
...
export const bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName.map(
