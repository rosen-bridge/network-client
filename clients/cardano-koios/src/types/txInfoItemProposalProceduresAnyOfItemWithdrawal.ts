 ...
 */
import type { TxInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf } from './txInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf';

import { bigIntsTxInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf } from './txInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf';

/**
 * If not null, the amount withdrawn from treasury into stake address by this this proposal
 */
export type TxInfoItemProposalProceduresAnyOfItemWithdrawal =
  TxInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf | null | null;
export const bigIntsTxInfoItemProposalProceduresAnyOfItemWithdrawal: Array<string> =
  [...bigIntsTxInfoItemProposalProceduresAnyOfItemWithdrawalAnyOf];
