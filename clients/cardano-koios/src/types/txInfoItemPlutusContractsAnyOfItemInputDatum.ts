 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItemInputDatumHash } from './txInfoItemPlutusContractsAnyOfItemInputDatumHash';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumHash } from './txInfoItemPlutusContractsAnyOfItemInputDatumHash';
import type { TxInfoItemPlutusContractsAnyOfItemInputDatumValue } from './txInfoItemPlutusContractsAnyOfItemInputDatumValue';

import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumValue } from './txInfoItemPlutusContractsAnyOfItemInputDatumValue';

export type TxInfoItemPlutusContractsAnyOfItemInputDatum = {
  /** The Hash of the Plutus Data */
  hash?: TxInfoItemPlutusContractsAnyOfItemInputDatumHash;
  /** Data in JSON format */
  value?: TxInfoItemPlutusContractsAnyOfItemInputDatumValue;
};

export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatum: Array<string> =
  [
    ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumHash.map((item) =>
      item === '' ? 'hash' : `hash.${item}`
    ),
    ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumValue.map((item) =>
