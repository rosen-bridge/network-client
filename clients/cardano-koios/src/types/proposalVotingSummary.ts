 ...
 */
import type { ProposalVotingSummaryItem } from './proposalVotingSummaryItem';
import { bigIntsProposalVotingSummaryItem } from './proposalVotingSummaryItem';

/**
 * Summary of votes for given proposal
 */
export type ProposalVotingSummary = ProposalVotingSummaryItem[];
export const bigIntsProposalVotingSummary: Array<string> = [
  ...bigIntsProposalVotingSummaryItem,
];
