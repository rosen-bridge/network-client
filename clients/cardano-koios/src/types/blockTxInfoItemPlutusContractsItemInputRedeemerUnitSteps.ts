 ...
 */
export type BlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps =
  | string
  | number
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps: Array<string> =
  [];
