 ...
 */
export type PolicyAssetInfoItemTokenRegistryMetadataAnyOfLogo = null | string;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataAnyOfLogo: Array<string> =
  [];
