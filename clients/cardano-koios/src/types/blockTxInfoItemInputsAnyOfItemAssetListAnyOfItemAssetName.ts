 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName =
  | string
  | null;
export const bigIntsBlockTxInfoItemInputsAnyOfItemAssetListAnyOfItemAssetName: Array<string> =
  [];
