 ...
 * Value (json)
 */
export type BlockTxInfoItemOutputsItemReferenceScriptAnyOfValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemOutputsItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
