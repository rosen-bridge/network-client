 ...
 * Asset Name (hex)
 */
export type AddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName =
  | string
  | null
  | null;
export const bigIntsAddressInfoItemUtxoSetItemAssetListAnyOfItemAssetName: Array<string> =
  [];
