 ...
 */
export type VoterProposalListItemPreviousGovActionProposalId = string | null;
export const bigIntsVoterProposalListItemPreviousGovActionProposalId: Array<string> =
  [];
