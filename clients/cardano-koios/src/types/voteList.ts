 ...
 */
import type { VoteListItem } from './voteListItem';
import { bigIntsVoteListItem } from './voteListItem';

/**
 * List of all votes cast on specified governance action
 */
export type VoteList = VoteListItem[];
export const bigIntsVoteList: Array<string> = [...bigIntsVoteListItem];
