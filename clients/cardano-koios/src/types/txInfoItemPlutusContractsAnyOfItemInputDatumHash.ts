 ...
 */
export type TxInfoItemPlutusContractsAnyOfItemInputDatumHash = string | null;
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatumHash: Array<string> =
  [];
