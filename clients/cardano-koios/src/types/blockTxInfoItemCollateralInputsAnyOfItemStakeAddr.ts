...
export type BlockTxInfoItemCollateralInputsAnyOfItemStakeAddr = string | null;
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemStakeAddr: Array<string> =
  [];
