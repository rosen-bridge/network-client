 ...
 */
import type { TxStatusItemNumConfirmations } from './txStatusItemNumConfirmations';

import { bigIntsTxStatusItemNumConfirmations } from './txStatusItemNumConfirmations';

export type TxStatusItem = {
  /** Number of block confirmations */
  num_confirmations?: TxStatusItemNumConfirmations;
  /** Hash identifier of the transaction */
  tx_hash?: string;
};

export const bigIntsTxStatusItem = [
