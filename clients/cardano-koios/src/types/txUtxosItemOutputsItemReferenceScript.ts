 ...
 */
import type { TxUtxosItemOutputsItemReferenceScriptValue } from './txUtxosItemOutputsItemReferenceScriptValue';

import { bigIntsTxUtxosItemOutputsItemReferenceScriptValue } from './txUtxosItemOutputsItemReferenceScriptValue';
 ...
 */
export type TxUtxosItemOutputsItemReferenceScript = {
  ...
  bytes?: string;
  /** Value (json) */
  value?: TxUtxosItemOutputsItemReferenceScriptValue;
} | null;

export const bigIntsTxUtxosItemOutputsItemReferenceScript = [
  ...bigIntsTxUtxosItemOutputsItemReferenceScriptValue.map((item) =>
