 ...
 */
import type { PoolRegistrationsItem } from './poolRegistrationsItem';
import { bigIntsPoolRegistrationsItem } from './poolRegistrationsItem';

/**
 * Array of pool registrations/retirements
 */
export type PoolRegistrations = PoolRegistrationsItem[];
export const bigIntsPoolRegistrations: Array<string> = [
  ...bigIntsPoolRegistrationsItem,
];
