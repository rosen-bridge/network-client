 ...
 */
export type TxInfoItemCollateralInputsAnyOfItemDatumHash = string | null | null;
export const bigIntsTxInfoItemCollateralInputsAnyOfItemDatumHash: Array<string> =
  [];
