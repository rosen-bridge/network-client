 ...
 */
import type { TxInfoItemNativeScriptsAnyOfItemScriptHash } from './txInfoItemNativeScriptsAnyOfItemScriptHash';
import { bigIntsTxInfoItemNativeScriptsAnyOfItemScriptHash } from './txInfoItemNativeScriptsAnyOfItemScriptHash';
import type { TxInfoItemNativeScriptsAnyOfItemScriptJson } from './txInfoItemNativeScriptsAnyOfItemScriptJson';

import { bigIntsTxInfoItemNativeScriptsAnyOfItemScriptJson } from './txInfoItemNativeScriptsAnyOfItemScriptJson';

export type TxInfoItemNativeScriptsAnyOfItem = {
  /** Hash of a script */
  script_hash?: TxInfoItemNativeScriptsAnyOfItemScriptHash;
  /** JSON representation of the timelock script (null for other script types) */
  script_json?: TxInfoItemNativeScriptsAnyOfItemScriptJson;
};

export const bigIntsTxInfoItemNativeScriptsAnyOfItem: Array<string> = [
  ...bigIntsTxInfoItemNativeScriptsAnyOfItemScriptHash.map((item) =>
    item === '' ? 'script_hash' : `script_hash.${item}`,
  ),
  ...bigIntsTxInfoItemNativeScriptsAnyOfItemScriptJson.map((item) =>
