 ...
 */
import type { DatumInfoItemValueAnyOf } from './datumInfoItemValueAnyOf';

import { bigIntsDatumInfoItemValueAnyOf } from './datumInfoItemValueAnyOf';

/**
 * Data in JSON format
 */
export type DatumInfoItemValue = DatumInfoItemValueAnyOf | null | null;
export const bigIntsDatumInfoItemValue: Array<string> = [
  ...bigIntsDatumInfoItemValueAnyOf,
];
