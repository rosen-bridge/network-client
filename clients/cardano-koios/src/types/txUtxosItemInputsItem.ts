 ...
 */
import type { TxUtxosItemInputsItemPaymentAddr } from './txUtxosItemInputsItemPaymentAddr';
import { bigIntsTxUtxosItemInputsItemPaymentAddr } from './txUtxosItemInputsItemPaymentAddr';
import type { TxUtxosItemInputsItemStakeAddr } from './txUtxosItemInputsItemStakeAddr';
import { bigIntsTxUtxosItemInputsItemStakeAddr } from './txUtxosItemInputsItemStakeAddr';
import type { TxUtxosItemInputsItemInlineDatum } from './txUtxosItemInputsItemInlineDatum';
import { bigIntsTxUtxosItemInputsItemInlineDatum } from './txUtxosItemInputsItemInlineDatum';
import type { TxUtxosItemInputsItemReferenceScript } from './txUtxosItemInputsItemReferenceScript';
import { bigIntsTxUtxosItemInputsItemReferenceScript } from './txUtxosItemInputsItemReferenceScript';
import type { TxUtxosItemInputsItemAssetListItem } from './txUtxosItemInputsItemAssetListItem';

import { bigIntsTxUtxosItemInputsItemAssetListItem } from './txUtxosItemInputsItemAssetListItem';

export type TxUtxosItemInputsItem = {
  payment_addr?: TxUtxosItemInputsItemPaymentAddr;
  stake_addr?: TxUtxosItemInputsItemStakeAddr;
  ...
  inline_datum?: TxUtxosItemInputsItemInlineDatum;
  ...
  reference_script?: TxUtxosItemInputsItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxUtxosItemInputsItemAssetListItem[] | null;
};

export const bigIntsTxUtxosItemInputsItem = [
  ...bigIntsTxUtxosItemInputsItemPaymentAddr.map(
    (item) => `payment_addr.${item}`
  ),
  ...bigIntsTxUtxosItemInputsItemStakeAddr.map((item) => `stake_addr.${item}`),
  ...bigIntsTxUtxosItemInputsItemInlineDatum.map(
    (item) => `inline_datum.${item}`
  ),
  ...bigIntsTxUtxosItemInputsItemReferenceScript.map(
