 ...
 */
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose';
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit';
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum';

import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum } from './blockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum';

export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemer = {
  /** What kind of validation this redeemer is used for */
  purpose?: BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose;
  /** The budget in fees to run a script - the fees depend on the ExUnits and the current prices */
  fee?: string;
  unit?: BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit;
  datum?: BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum;
};

export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemer: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerPurpose.map(
      (item) => (item === '' ? 'purpose' : `purpose.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnit.map(
      (item) => (item === '' ? 'unit' : `unit.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatum.map(
