...
export type TxInfoItemPlutusContractsItemInputRedeemerDatumValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatumValueAnyOf: Array<string> =
  [];
