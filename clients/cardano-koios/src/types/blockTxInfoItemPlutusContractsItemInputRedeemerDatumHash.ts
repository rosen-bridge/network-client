 ...
 */
export type BlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash =
  | string
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatumHash: Array<string> =
  [];
