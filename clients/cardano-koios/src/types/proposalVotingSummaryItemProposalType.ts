 ...
 */
export type ProposalVotingSummaryItemProposalType =
  (typeof ProposalVotingSummaryItemProposalType)[keyof typeof ProposalVotingSummaryItemProposalType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ProposalVotingSummaryItemProposalType = {
...
export const bigIntsProposalVotingSummaryItemProposalType: Array<string> = [];
