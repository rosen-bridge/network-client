 ...
 */
import type { DrepDelegatorsItem } from './drepDelegatorsItem';
import { bigIntsDrepDelegatorsItem } from './drepDelegatorsItem';

/**
 * List of all delegators by requested delegated representative (DRep)
 */
export type DrepDelegators = DrepDelegatorsItem[];
export const bigIntsDrepDelegators: Array<string> = [
  ...bigIntsDrepDelegatorsItem,
];
