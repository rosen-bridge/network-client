...
/**
 * The selected server has restricted the endpoint to be only usable via authentication. The authentication supplied was not authorized to access the endpoint
 */
export type UnauthorizedResponse = void;
export const bigIntsUnauthorizedResponse = [];
