 ...
 */
import type { TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName } from './txInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName';

import { bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName } from './txInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName';

export type TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName;
...
export const bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName.map(
