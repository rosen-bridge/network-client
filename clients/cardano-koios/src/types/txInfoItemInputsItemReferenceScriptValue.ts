 ...
 */
import type { TxInfoItemInputsItemReferenceScriptValueAnyOf } from './txInfoItemInputsItemReferenceScriptValueAnyOf';
import { bigIntsTxInfoItemInputsItemReferenceScriptValueAnyOf } from './txInfoItemInputsItemReferenceScriptValueAnyOf';

/**
 * Value (json)
 */
export type TxInfoItemInputsItemReferenceScriptValue =
  TxInfoItemInputsItemReferenceScriptValueAnyOf | null;
export const bigIntsTxInfoItemInputsItemReferenceScriptValue: Array<string> = [
  ...bigIntsTxInfoItemInputsItemReferenceScriptValueAnyOf,
];
