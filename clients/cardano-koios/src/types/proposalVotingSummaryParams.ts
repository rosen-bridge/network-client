 ...
 */
import type { _ProposalIdParameter } from './_proposalIdParameter';

import { bigInts_ProposalIdParameter } from './_proposalIdParameter';

export type ProposalVotingSummaryParams = {
  /**
   * Government proposal ID in CIP-129 Bech32 format
   */
  _proposal_id: _ProposalIdParameter;
};

export const bigIntsProposalVotingSummaryParams: Array<string> = [
  ...bigInts_ProposalIdParameter.map((item) =>
    item === '' ? '_proposal_id' : `_proposal_id.${item}`,
  ),
];
