 ...
 */
import type { TxUtxosItemInputsItemInlineDatumValue } from './txUtxosItemInputsItemInlineDatumValue';

import { bigIntsTxUtxosItemInputsItemInlineDatumValue } from './txUtxosItemInputsItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxUtxosItemInputsItemInlineDatum = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxUtxosItemInputsItemInlineDatumValue;
} | null;

export const bigIntsTxUtxosItemInputsItemInlineDatum = [
  ...bigIntsTxUtxosItemInputsItemInlineDatumValue.map((item) =>
