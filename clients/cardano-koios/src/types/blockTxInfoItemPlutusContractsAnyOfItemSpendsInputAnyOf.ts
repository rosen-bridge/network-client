 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemSpendsInputAnyOf = {
  /** Hash identifier of the transaction */
  tx_hash?: string;
  /** Index of UTxO in the transaction */
  tx_index?: number;
};
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemSpendsInputAnyOf: Array<string> =
  [];
