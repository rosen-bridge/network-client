 ...
 */
import type { BlockTxInfoItemAssetsMintedAnyOfItem } from './blockTxInfoItemAssetsMintedAnyOfItem';
import { bigIntsBlockTxInfoItemAssetsMintedAnyOfItem } from './blockTxInfoItemAssetsMintedAnyOfItem';

/**
 * Array of minted assets with-in a transaction
 */
export type BlockTxInfoItemAssetsMinted =
  | BlockTxInfoItemAssetsMintedAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemAssetsMinted: Array<string> = [
  ...bigIntsBlockTxInfoItemAssetsMintedAnyOfItem,
];
