 ...
 */
import type { _EpochNoReqdParameter } from './_epochNoReqdParameter';
import { bigInts_EpochNoReqdParameter } from './_epochNoReqdParameter';

export type TxOutsEpochParams = {
  /**
   * Epoch Number to fetch details for
   */
  _epoch_no: _EpochNoReqdParameter;
};

export const bigIntsTxOutsEpochParams: Array<string> = [
  ...bigInts_EpochNoReqdParameter.map((item) =>
