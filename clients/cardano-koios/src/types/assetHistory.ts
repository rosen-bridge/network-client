 ...
 */
import type { AssetHistoryItem } from './assetHistoryItem';

import { bigIntsAssetHistoryItem } from './assetHistoryItem';

/**
 * Array of asset mint/burn history
 */
export type AssetHistory = AssetHistoryItem[];
export const bigIntsAssetHistory: Array<string> = [...bigIntsAssetHistoryItem];
