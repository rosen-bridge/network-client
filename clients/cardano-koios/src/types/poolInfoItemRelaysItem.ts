 ...
 */
import type { PoolInfoItemRelaysItemDns } from './poolInfoItemRelaysItemDns';
import { bigIntsPoolInfoItemRelaysItemDns } from './poolInfoItemRelaysItemDns';
import type { PoolInfoItemRelaysItemIpv4 } from './poolInfoItemRelaysItemIpv4';
import { bigIntsPoolInfoItemRelaysItemIpv4 } from './poolInfoItemRelaysItemIpv4';
import type { PoolInfoItemRelaysItemIpv6 } from './poolInfoItemRelaysItemIpv6';
import { bigIntsPoolInfoItemRelaysItemIpv6 } from './poolInfoItemRelaysItemIpv6';
import type { PoolInfoItemRelaysItemPort } from './poolInfoItemRelaysItemPort';
import { bigIntsPoolInfoItemRelaysItemPort } from './poolInfoItemRelaysItemPort';
import type { PoolInfoItemRelaysItemSrv } from './poolInfoItemRelaysItemSrv';
import { bigIntsPoolInfoItemRelaysItemSrv } from './poolInfoItemRelaysItemSrv';

export type PoolInfoItemRelaysItem = {
  /** DNS name of the relay (nullable) */
  dns?: PoolInfoItemRelaysItemDns;
  /** DNS service name of the relay (nullable) */
  srv?: PoolInfoItemRelaysItemSrv;
  /** IPv4 address of the relay (nullable) */
  ipv4?: PoolInfoItemRelaysItemIpv4;
  /** IPv6 address of the relay (nullable) */
  ipv6?: PoolInfoItemRelaysItemIpv6;
  /** Port number of the relay (nullable) */
  port?: PoolInfoItemRelaysItemPort;
};

export const bigIntsPoolInfoItemRelaysItem: Array<string> = [
  ...bigIntsPoolInfoItemRelaysItemDns.map((item) =>
    item === '' ? 'dns' : `dns.${item}`,
  ),
  ...bigIntsPoolInfoItemRelaysItemSrv.map((item) =>
    item === '' ? 'srv' : `srv.${item}`,
  ),
  ...bigIntsPoolInfoItemRelaysItemIpv4.map((item) =>
    item === '' ? 'ipv4' : `ipv4.${item}`,
  ),
  ...bigIntsPoolInfoItemRelaysItemIpv6.map((item) =>
    item === '' ? 'ipv6' : `ipv6.${item}`,
  ),
  ...bigIntsPoolInfoItemRelaysItemPort.map((item) =>
    item === '' ? 'port' : `port.${item}`,
  ),
];
