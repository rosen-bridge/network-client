 ...
 * Value (json)
 */
export type TxInfoItemReferenceInputsAnyOfItemReferenceScriptAnyOfValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemReferenceInputsAnyOfItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
