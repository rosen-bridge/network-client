 ...
 */
import type { TxInfoItemProposalProceduresItemWithdrawalAnyOf } from './txInfoItemProposalProceduresItemWithdrawalAnyOf';

import { bigIntsTxInfoItemProposalProceduresItemWithdrawalAnyOf } from './txInfoItemProposalProceduresItemWithdrawalAnyOf';

/**
 * If not null, the amount withdrawn from treasury into stake address by this this proposal
 */
export type TxInfoItemProposalProceduresItemWithdrawal =
  TxInfoItemProposalProceduresItemWithdrawalAnyOf | null;
export const bigIntsTxInfoItemProposalProceduresItemWithdrawal = [];
