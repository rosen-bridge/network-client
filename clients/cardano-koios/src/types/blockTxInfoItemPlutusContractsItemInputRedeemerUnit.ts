 ...
 */
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnitMem';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnitMem';
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps';

export type BlockTxInfoItemPlutusContractsItemInputRedeemerUnit = {
  /** The budget in Cpu steps to run a script */
  steps?: BlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps;
  /** The budget in Memory to run a script */
  mem?: BlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem;
};

export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnit: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitSteps.map(
      (item) => (item === '' ? 'steps' : `steps.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnitMem.map(
