...
export type TxInfoItemReferenceInputsAnyOfItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemReferenceInputsAnyOfItemReferenceScriptValueAnyOf: Array<string> =
  [];
