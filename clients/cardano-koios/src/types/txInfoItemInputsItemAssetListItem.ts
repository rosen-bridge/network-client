 ...
 */
import type { TxInfoItemInputsItemAssetListItemAssetName } from './txInfoItemInputsItemAssetListItemAssetName';
import { bigIntsTxInfoItemInputsItemAssetListItemAssetName } from './txInfoItemInputsItemAssetListItemAssetName';

export type TxInfoItemInputsItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemInputsItemAssetListItemAssetName;
...
export const bigIntsTxInfoItemInputsItemAssetListItem: Array<string> = [
  ...bigIntsTxInfoItemInputsItemAssetListItemAssetName.map((item) =>
