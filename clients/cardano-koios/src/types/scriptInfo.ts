 ...
 */
import type { ScriptInfoItem } from './scriptInfoItem';
import { bigIntsScriptInfoItem } from './scriptInfoItem';

export type ScriptInfo = ScriptInfoItem[];
export const bigIntsScriptInfo: Array<string> = [...bigIntsScriptInfoItem];
