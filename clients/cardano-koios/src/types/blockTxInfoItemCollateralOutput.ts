 ...
 */
import type { BlockTxInfoItemCollateralOutputAnyOfItem } from './blockTxInfoItemCollateralOutputAnyOfItem';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItem } from './blockTxInfoItemCollateralOutputAnyOfItem';

/**
 * A collateral output for change if the smart contract fails to execute and collateral inputs are spent. (CIP-40)
 */
export type BlockTxInfoItemCollateralOutput =
  | BlockTxInfoItemCollateralOutputAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemCollateralOutput: Array<string> = [
  ...bigIntsBlockTxInfoItemCollateralOutputAnyOfItem,
];
