 ...
 */
import type { PoolInfoItem } from './poolInfoItem';

import { bigIntsPoolInfoItem } from './poolInfoItem';

/**
 * Array of pool information
 */
export type PoolInfo = PoolInfoItem[];
export const bigIntsPoolInfo: Array<string> = [...bigIntsPoolInfoItem];
