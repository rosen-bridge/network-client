 ...
 */
import type { BlockTxInfoItemInputsAnyOfItem } from './blockTxInfoItemInputsAnyOfItem';
import { bigIntsBlockTxInfoItemInputsAnyOfItem } from './blockTxInfoItemInputsAnyOfItem';

/**
 * An array of UTxO inputs spent in the transaction
 */
export type BlockTxInfoItemInputs = BlockTxInfoItemInputsAnyOfItem[] | null;
export const bigIntsBlockTxInfoItemInputs: Array<string> = [
  ...bigIntsBlockTxInfoItemInputsAnyOfItem,
];
