 ...
 */
import type { TxInfoItemCollateralOutputItemInlineDatumAnyOfValue } from './txInfoItemCollateralOutputItemInlineDatumAnyOfValue';

import { bigIntsTxInfoItemCollateralOutputItemInlineDatumAnyOfValue } from './txInfoItemCollateralOutputItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralOutputItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralOutputItemInlineDatumAnyOfValue;
};

export const bigIntsTxInfoItemCollateralOutputItemInlineDatumAnyOf = [
  ...bigIntsTxInfoItemCollateralOutputItemInlineDatumAnyOfValue.map((item) =>
