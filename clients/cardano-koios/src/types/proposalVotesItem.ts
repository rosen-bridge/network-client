 ...
 */
import type { ProposalVotesItemMetaHash } from './proposalVotesItemMetaHash';
import { bigIntsProposalVotesItemMetaHash } from './proposalVotesItemMetaHash';
import type { ProposalVotesItemMetaUrl } from './proposalVotesItemMetaUrl';
import { bigIntsProposalVotesItemMetaUrl } from './proposalVotesItemMetaUrl';
import type { ProposalVotesItemVote } from './proposalVotesItemVote';
import { bigIntsProposalVotesItemVote } from './proposalVotesItemVote';
import type { ProposalVotesItemVoterRole } from './proposalVotesItemVoterRole';

import { bigIntsProposalVotesItemVoterRole } from './proposalVotesItemVoterRole';

export type ProposalVotesItem = {
  /** UNIX timestamp of the block */
  block_time?: number;
  /** A hash of the contents of the metadata URL */
  meta_hash?: ProposalVotesItemMetaHash;
  /** A URL to a JSON payload of metadata */
  meta_url?: ProposalVotesItemMetaUrl;
  /** Actual Vote casted */
  vote?: ProposalVotesItemVote;
  ...
  voter_role?: ProposalVotesItemVoterRole;
};

export const bigIntsProposalVotesItem = [
