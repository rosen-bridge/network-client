 ...
 */
import type { TxInfoItemInputsItemAssetListItem } from './txInfoItemInputsItemAssetListItem';
import { bigIntsTxInfoItemInputsItemAssetListItem } from './txInfoItemInputsItemAssetListItem';
import type { TxInfoItemInputsItemDatumHash } from './txInfoItemInputsItemDatumHash';
import { bigIntsTxInfoItemInputsItemDatumHash } from './txInfoItemInputsItemDatumHash';
import type { TxInfoItemInputsItemInlineDatum } from './txInfoItemInputsItemInlineDatum';
import { bigIntsTxInfoItemInputsItemInlineDatum } from './txInfoItemInputsItemInlineDatum';
import type { TxInfoItemInputsItemPaymentAddr } from './txInfoItemInputsItemPaymentAddr';
import { bigIntsTxInfoItemInputsItemPaymentAddr } from './txInfoItemInputsItemPaymentAddr';
import type { TxInfoItemInputsItemReferenceScript } from './txInfoItemInputsItemReferenceScript';
import { bigIntsTxInfoItemInputsItemReferenceScript } from './txInfoItemInputsItemReferenceScript';
import type { TxInfoItemInputsItemStakeAddr } from './txInfoItemInputsItemStakeAddr';
import { bigIntsTxInfoItemInputsItemStakeAddr } from './txInfoItemInputsItemStakeAddr';

export type TxInfoItemInputsItem = {
  payment_addr?: TxInfoItemInputsItemPaymentAddr;
  stake_addr?: TxInfoItemInputsItemStakeAddr;
  ...
  datum_hash?: TxInfoItemInputsItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: TxInfoItemInputsItemInlineDatum;
  ...
  reference_script?: TxInfoItemInputsItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxInfoItemInputsItemAssetListItem[];
};
...
export const bigIntsTxInfoItemInputsItem: Array<string> = [
  ...
  ...bigIntsTxInfoItemInputsItemAssetListItem.map((item) =>
