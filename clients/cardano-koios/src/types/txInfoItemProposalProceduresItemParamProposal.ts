 ...
 */
import type { TxInfoItemProposalProceduresItemParamProposalAnyOf } from './txInfoItemProposalProceduresItemParamProposalAnyOf';
import { bigIntsTxInfoItemProposalProceduresItemParamProposalAnyOf } from './txInfoItemProposalProceduresItemParamProposalAnyOf';

/**
 * If not null, the proposed new parameter set
 */
export type TxInfoItemProposalProceduresItemParamProposal =
  TxInfoItemProposalProceduresItemParamProposalAnyOf | null;
export const bigIntsTxInfoItemProposalProceduresItemParamProposal: Array<string> =
  [...bigIntsTxInfoItemProposalProceduresItemParamProposalAnyOf];
