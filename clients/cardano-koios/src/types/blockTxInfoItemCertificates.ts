 ...
 */
import type { BlockTxInfoItemCertificatesAnyOfItem } from './blockTxInfoItemCertificatesAnyOfItem';
import { bigIntsBlockTxInfoItemCertificatesAnyOfItem } from './blockTxInfoItemCertificatesAnyOfItem';

/**
 * Certificates present with-in a transaction (if any)
 */
export type BlockTxInfoItemCertificates =
  | BlockTxInfoItemCertificatesAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemCertificates: Array<string> = [
  ...bigIntsBlockTxInfoItemCertificatesAnyOfItem,
];
