 ...
 */
import type { TxInfoItemReferenceInputsItemInlineDatumValue } from './txInfoItemReferenceInputsItemInlineDatumValue';

import { bigIntsTxInfoItemReferenceInputsItemInlineDatumValue } from './txInfoItemReferenceInputsItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemReferenceInputsItemInlineDatum = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemReferenceInputsItemInlineDatumValue;
} | null;
