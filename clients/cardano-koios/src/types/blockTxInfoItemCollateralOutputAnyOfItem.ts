 ...
 */
import type { BlockTxInfoItemCollateralOutputAnyOfItemDatumHash } from './blockTxInfoItemCollateralOutputAnyOfItemDatumHash';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemDatumHash } from './blockTxInfoItemCollateralOutputAnyOfItemDatumHash';
import type { BlockTxInfoItemCollateralOutputAnyOfItemInlineDatum } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatum';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemInlineDatum } from './blockTxInfoItemCollateralOutputAnyOfItemInlineDatum';
import type { BlockTxInfoItemCollateralOutputAnyOfItemPaymentAddr } from './blockTxInfoItemCollateralOutputAnyOfItemPaymentAddr';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemPaymentAddr } from './blockTxInfoItemCollateralOutputAnyOfItemPaymentAddr';
import type { BlockTxInfoItemCollateralOutputAnyOfItemReferenceScript } from './blockTxInfoItemCollateralOutputAnyOfItemReferenceScript';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemReferenceScript } from './blockTxInfoItemCollateralOutputAnyOfItemReferenceScript';
import type { BlockTxInfoItemCollateralOutputAnyOfItemStakeAddr } from './blockTxInfoItemCollateralOutputAnyOfItemStakeAddr';
import { bigIntsBlockTxInfoItemCollateralOutputAnyOfItemStakeAddr } from './blockTxInfoItemCollateralOutputAnyOfItemStakeAddr';

export type BlockTxInfoItemCollateralOutputAnyOfItem = {
  payment_addr?: BlockTxInfoItemCollateralOutputAnyOfItemPaymentAddr;
  stake_addr?: BlockTxInfoItemCollateralOutputAnyOfItemStakeAddr;
  ...
  datum_hash?: BlockTxInfoItemCollateralOutputAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemCollateralOutputAnyOfItemInlineDatum;
  ...
  reference_script?: BlockTxInfoItemCollateralOutputAnyOfItemReferenceScript;
