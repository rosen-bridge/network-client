 ...
 */
import type { BlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName';
import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName';

export type BlockTxInfoItemReferenceInputsAnyOfItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName;
...
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName.map(
