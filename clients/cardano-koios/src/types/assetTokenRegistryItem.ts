 ...
 */
import type { AssetTokenRegistryItemAssetName } from './assetTokenRegistryItemAssetName';
import { bigIntsAssetTokenRegistryItemAssetName } from './assetTokenRegistryItemAssetName';
import type { AssetTokenRegistryItemDescription } from './assetTokenRegistryItemDescription';
import { bigIntsAssetTokenRegistryItemDescription } from './assetTokenRegistryItemDescription';
import type { AssetTokenRegistryItemLogo } from './assetTokenRegistryItemLogo';
import { bigIntsAssetTokenRegistryItemLogo } from './assetTokenRegistryItemLogo';
import type { AssetTokenRegistryItemTicker } from './assetTokenRegistryItemTicker';
import { bigIntsAssetTokenRegistryItemTicker } from './assetTokenRegistryItemTicker';
import type { AssetTokenRegistryItemUrl } from './assetTokenRegistryItemUrl';

import { bigIntsAssetTokenRegistryItemUrl } from './assetTokenRegistryItemUrl';

export type AssetTokenRegistryItem = {
  /** Asset Name (hex) */
  asset_name?: AssetTokenRegistryItemAssetName;
  /** Asset Name (ASCII) */
  asset_name_ascii?: string;
  decimals?: number;
  description?: AssetTokenRegistryItemDescription;
  /** A PNG image file as a byte string */
  logo?: AssetTokenRegistryItemLogo;
  /** Asset Policy ID (hex) */
  policy_id?: string;
  ticker?: AssetTokenRegistryItemTicker;
  url?: AssetTokenRegistryItemUrl;
};

export const bigIntsAssetTokenRegistryItem = [
