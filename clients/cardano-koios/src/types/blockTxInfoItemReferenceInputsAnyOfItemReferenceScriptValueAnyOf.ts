...
export type BlockTxInfoItemReferenceInputsAnyOfItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemReferenceScriptValueAnyOf: Array<string> =
  [];
