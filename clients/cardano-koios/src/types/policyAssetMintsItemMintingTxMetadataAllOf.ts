 ...
 */
import type { PolicyAssetMintsItemMintingTxMetadataAllOfAnyOf } from './policyAssetMintsItemMintingTxMetadataAllOfAnyOf';

import { bigIntsPolicyAssetMintsItemMintingTxMetadataAllOfAnyOf } from './policyAssetMintsItemMintingTxMetadataAllOfAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type PolicyAssetMintsItemMintingTxMetadataAllOf =
  PolicyAssetMintsItemMintingTxMetadataAllOfAnyOf | null | null;
export const bigIntsPolicyAssetMintsItemMintingTxMetadataAllOf: Array<string> =
  [...bigIntsPolicyAssetMintsItemMintingTxMetadataAllOfAnyOf];
