 ...
 */
export type BlockTxInfoItemCollateralInputsAnyOfItemDatumHash = string | null;
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemDatumHash: Array<string> =
  [];
