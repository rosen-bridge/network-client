 ...
 */
import type { TxInfoItemCollateralOutputItemReferenceScriptAnyOfValue } from './txInfoItemCollateralOutputItemReferenceScriptAnyOfValue';

import { bigIntsTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue } from './txInfoItemCollateralOutputItemReferenceScriptAnyOfValue';
 ...
 */
export type TxInfoItemCollateralOutputItemReferenceScriptAnyOf = {
  /** Script bytes (hex) */
  bytes?: string;
  ...
  type?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralOutputItemReferenceScriptAnyOfValue;
};

export const bigIntsTxInfoItemCollateralOutputItemReferenceScriptAnyOf = [
  ...bigIntsTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue.map(
