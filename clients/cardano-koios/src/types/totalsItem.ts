...
export type TotalsItem = {
  /** Epoch number */
  epoch_no?: number;
  /** Circulating UTxOs for given epoch (in numbers) */
  circulation?: string;
  /** Funds in treasury for given epoch (in numbers) */
  treasury?: string;
  /** Rewards accumulated as of given epoch (in numbers) */
  reward?: string;
  /** Total Active Supply (sum of treasury funds, rewards, UTxOs, deposits and fees) for given epoch (in numbers) */
  supply?: string;
...
export const bigIntsTotalsItem: Array<string> = [];
