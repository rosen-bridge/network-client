 ...
 */
import type { EpochBlockProtocolsItem } from './epochBlockProtocolsItem';
import { bigIntsEpochBlockProtocolsItem } from './epochBlockProtocolsItem';

/**
 * Array of distinct block protocol versions counts in epoch
 */
export type EpochBlockProtocols = EpochBlockProtocolsItem[];
export const bigIntsEpochBlockProtocols: Array<string> = [
  ...bigIntsEpochBlockProtocolsItem,
];
