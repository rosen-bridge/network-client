 ...
 */
import type { TxUtxosItemInputsItem } from './txUtxosItemInputsItem';
import { bigIntsTxUtxosItemInputsItem } from './txUtxosItemInputsItem';
import type { TxUtxosItemOutputsAllOfItem } from './txUtxosItemOutputsAllOfItem';

import { bigIntsTxUtxosItemOutputsAllOfItem } from './txUtxosItemOutputsAllOfItem';

export type TxUtxosItem = {
  /** Hash identifier of the transaction */
  tx_hash?: string;
  /** An array of UTxO inputs used by the transaction */
  inputs?: TxUtxosItemInputsItem[];
  /** An array of UTxO outputs created by the transaction */
  outputs?: TxUtxosItemOutputsAllOfItem[];
};
