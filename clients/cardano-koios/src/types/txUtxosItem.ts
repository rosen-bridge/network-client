...
import type { TxUtxosItemOutputsItem } from './txUtxosItemOutputsItem';

import { bigIntsTxUtxosItemOutputsItem } from './txUtxosItemOutputsItem';
...
export type TxUtxosItem = {
  ...
  /** An array of UTxO outputs created by the transaction */
  outputs?: TxUtxosItemOutputsItem[];
};
