 ...
 */
import type { TxInfoItemCollateralInputsItemInlineDatumValue } from './txInfoItemCollateralInputsItemInlineDatumValue';

import { bigIntsTxInfoItemCollateralInputsItemInlineDatumValue } from './txInfoItemCollateralInputsItemInlineDatumValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralInputsItemInlineDatum = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralInputsItemInlineDatumValue;
} | null;

export const bigIntsTxInfoItemCollateralInputsItemInlineDatum = [
  ...bigIntsTxInfoItemCollateralInputsItemInlineDatumValue.map((item) =>
