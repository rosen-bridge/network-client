 ...
 */
export type BlockTxInfoItemPlutusContractsItemInputDatumHash = string | null;
export const bigIntsBlockTxInfoItemPlutusContractsItemInputDatumHash: Array<string> =
  [];
