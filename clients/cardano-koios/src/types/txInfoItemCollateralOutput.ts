 ...
 */
import type { TxInfoItemCollateralOutputPaymentAddr } from './txInfoItemCollateralOutputPaymentAddr';
import { bigIntsTxInfoItemCollateralOutputPaymentAddr } from './txInfoItemCollateralOutputPaymentAddr';
import type { TxInfoItemCollateralOutputStakeAddr } from './txInfoItemCollateralOutputStakeAddr';
import { bigIntsTxInfoItemCollateralOutputStakeAddr } from './txInfoItemCollateralOutputStakeAddr';
import type { TxInfoItemCollateralOutputInlineDatum } from './txInfoItemCollateralOutputInlineDatum';
import { bigIntsTxInfoItemCollateralOutputInlineDatum } from './txInfoItemCollateralOutputInlineDatum';
import type { TxInfoItemCollateralOutputReferenceScript } from './txInfoItemCollateralOutputReferenceScript';
import { bigIntsTxInfoItemCollateralOutputReferenceScript } from './txInfoItemCollateralOutputReferenceScript';
import type { TxInfoItemCollateralOutputAssetListItem } from './txInfoItemCollateralOutputAssetListItem';

import { bigIntsTxInfoItemCollateralOutputAssetListItem } from './txInfoItemCollateralOutputAssetListItem';

export type TxInfoItemCollateralOutput = {
  payment_addr?: TxInfoItemCollateralOutputPaymentAddr;
  stake_addr?: TxInfoItemCollateralOutputStakeAddr;
  ...
  inline_datum?: TxInfoItemCollateralOutputInlineDatum;
  ...
  reference_script?: TxInfoItemCollateralOutputReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxInfoItemCollateralOutputAssetListItem[] | null;
};

export const bigIntsTxInfoItemCollateralOutput = [
  ...bigIntsTxInfoItemCollateralOutputPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputStakeAddr.map((item) =>
    item === '' ? 'stake_addr' : `stake_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputReferenceScript.map((item) =>
