 ...
 */
export type DrepInfoItemDrepStatus =
  (typeof DrepInfoItemDrepStatus)[keyof typeof DrepInfoItemDrepStatus];

// eslint-disable-next-line no-redeclare
export const DrepInfoItemDrepStatus = {
  registered: 'registered',
  deregistered: 'deregistered',
  not_registered: 'not_registered',
} as const;
export const bigIntsDrepInfoItemDrepStatus: Array<string> = [];
