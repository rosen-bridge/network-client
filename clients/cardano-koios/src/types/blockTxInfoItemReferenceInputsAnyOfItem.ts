...
import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatum } from './blockTxInfoItemReferenceInputsAnyOfItemInlineDatum';
import type { BlockTxInfoItemReferenceInputsAnyOfItemPaymentAddr } from './blockTxInfoItemReferenceInputsAnyOfItemPaymentAddr';
import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemPaymentAddr } from './blockTxInfoItemReferenceInputsAnyOfItemPaymentAddr';
import type { BlockTxInfoItemReferenceInputsAnyOfItemReferenceScript } from './blockTxInfoItemReferenceInputsAnyOfItemReferenceScript';
import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemReferenceScript } from './blockTxInfoItemReferenceInputsAnyOfItemReferenceScript';
import type { BlockTxInfoItemReferenceInputsAnyOfItemStakeAddr } from './blockTxInfoItemReferenceInputsAnyOfItemStakeAddr';

import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemStakeAddr } from './blockTxInfoItemReferenceInputsAnyOfItemStakeAddr';

export type BlockTxInfoItemReferenceInputsAnyOfItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: BlockTxInfoItemReferenceInputsAnyOfItemAssetListItem[] | null;
  /** Hash of datum (if any) connected to UTxO */
  datum_hash?: BlockTxInfoItemReferenceInputsAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemReferenceInputsAnyOfItemInlineDatum;
  payment_addr?: BlockTxInfoItemReferenceInputsAnyOfItemPaymentAddr;
  ...
  stake_addr?: BlockTxInfoItemReferenceInputsAnyOfItemStakeAddr;
...
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItem = [
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemReferenceScript.map((item) =>
    item === '' ? 'reference_script' : `reference_script.${item}`
  ),
  ...bigIntsBlockTxInfoItemReferenceInputsAnyOfItemStakeAddr.map((item) =>
