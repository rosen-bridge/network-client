 ...
 */
export type VoteListItemVoterRole =
  (typeof VoteListItemVoterRole)[keyof typeof VoteListItemVoterRole];

// eslint-disable-next-line no-redeclare
export const VoteListItemVoterRole = {
  ConstitutionalCommittee: 'ConstitutionalCommittee',
  DRep: 'DRep',
  SPO: 'SPO',
} as const;
export const bigIntsVoteListItemVoterRole: Array<string> = [];
