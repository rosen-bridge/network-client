 ...
 */
import type { TxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf } from './txInfoItemProposalProceduresAnyOfItemParamProposalAnyOf';

import { bigIntsTxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf } from './txInfoItemProposalProceduresAnyOfItemParamProposalAnyOf';

/**
 * If not null, the proposed new parameter set
 */
export type TxInfoItemProposalProceduresAnyOfItemParamProposal =
  TxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf | null | null;
export const bigIntsTxInfoItemProposalProceduresAnyOfItemParamProposal: Array<string> =
  [...bigIntsTxInfoItemProposalProceduresAnyOfItemParamProposalAnyOf];
