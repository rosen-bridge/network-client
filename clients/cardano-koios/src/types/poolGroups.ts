 ...
 */
import type { PoolGroupsItem } from './poolGroupsItem';
import { bigIntsPoolGroupsItem } from './poolGroupsItem';

/**
 * Array of pools with their corresponding group information
 */
export type PoolGroups = PoolGroupsItem[];
export const bigIntsPoolGroups: Array<string> = [...bigIntsPoolGroupsItem];
