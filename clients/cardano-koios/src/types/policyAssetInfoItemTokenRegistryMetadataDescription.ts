...
export type PolicyAssetInfoItemTokenRegistryMetadataDescription = string | null;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataDescription: Array<string> =
  [];
