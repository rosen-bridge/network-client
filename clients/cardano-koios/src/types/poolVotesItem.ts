 ...
 */
import type { PoolVotesItemMetaHash } from './poolVotesItemMetaHash';
import { bigIntsPoolVotesItemMetaHash } from './poolVotesItemMetaHash';
import type { PoolVotesItemMetaUrl } from './poolVotesItemMetaUrl';
import { bigIntsPoolVotesItemMetaUrl } from './poolVotesItemMetaUrl';
import type { PoolVotesItemVote } from './poolVotesItemVote';

import { bigIntsPoolVotesItemVote } from './poolVotesItemVote';

export type PoolVotesItem = {
  /** UNIX timestamp of the block */
  block_time?: number;
  /** A hash of the contents of the metadata URL */
  meta_hash?: PoolVotesItemMetaHash;
  /** A URL to a JSON payload of metadata */
  meta_url?: PoolVotesItemMetaUrl;
  ...
  /** Actual Vote casted */
  vote?: PoolVotesItemVote;
  /** Hash identifier of the transaction */
  vote_tx_hash?: string;
};

export const bigIntsPoolVotesItem = [
