 ...
 */
import type { DrepVotesItemMetaHash } from './drepVotesItemMetaHash';
import { bigIntsDrepVotesItemMetaHash } from './drepVotesItemMetaHash';
import type { DrepVotesItemMetaUrl } from './drepVotesItemMetaUrl';
import { bigIntsDrepVotesItemMetaUrl } from './drepVotesItemMetaUrl';
import type { DrepVotesItemVote } from './drepVotesItemVote';
import { bigIntsDrepVotesItemVote } from './drepVotesItemVote';

export type DrepVotesItem = {
  ...
  block_time?: number;
  /** Actual Vote casted */
  vote?: DrepVotesItemVote;
  /** A URL to a JSON payload of metadata */
  meta_url?: DrepVotesItemMetaUrl;
  /** A hash of the contents of the metadata URL */
  meta_hash?: DrepVotesItemMetaHash;
};

export const bigIntsDrepVotesItem: Array<string> = [
  ...bigIntsDrepVotesItemVote.map((item) =>
    item === '' ? 'vote' : `vote.${item}`,
  ),
  ...bigIntsDrepVotesItemMetaUrl.map((item) =>
    item === '' ? 'meta_url' : `meta_url.${item}`,
  ),
  ...bigIntsDrepVotesItemMetaHash.map((item) =>
