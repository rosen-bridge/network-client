 ...
 */
import type { BlockTxInfoItemOutputsItemAssetListItem } from './blockTxInfoItemOutputsItemAssetListItem';
import { bigIntsBlockTxInfoItemOutputsItemAssetListItem } from './blockTxInfoItemOutputsItemAssetListItem';
import type { BlockTxInfoItemOutputsItemDatumHash } from './blockTxInfoItemOutputsItemDatumHash';
import { bigIntsBlockTxInfoItemOutputsItemDatumHash } from './blockTxInfoItemOutputsItemDatumHash';
import type { BlockTxInfoItemOutputsItemInlineDatum } from './blockTxInfoItemOutputsItemInlineDatum';
import { bigIntsBlockTxInfoItemOutputsItemInlineDatum } from './blockTxInfoItemOutputsItemInlineDatum';
import type { BlockTxInfoItemOutputsItemPaymentAddr } from './blockTxInfoItemOutputsItemPaymentAddr';
import { bigIntsBlockTxInfoItemOutputsItemPaymentAddr } from './blockTxInfoItemOutputsItemPaymentAddr';
import type { BlockTxInfoItemOutputsItemReferenceScript } from './blockTxInfoItemOutputsItemReferenceScript';
import { bigIntsBlockTxInfoItemOutputsItemReferenceScript } from './blockTxInfoItemOutputsItemReferenceScript';
import type { BlockTxInfoItemOutputsItemStakeAddr } from './blockTxInfoItemOutputsItemStakeAddr';
import { bigIntsBlockTxInfoItemOutputsItemStakeAddr } from './blockTxInfoItemOutputsItemStakeAddr';

export type BlockTxInfoItemOutputsItem = {
  payment_addr?: BlockTxInfoItemOutputsItemPaymentAddr;
  stake_addr?: BlockTxInfoItemOutputsItemStakeAddr;
  ...
  datum_hash?: BlockTxInfoItemOutputsItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemOutputsItemInlineDatum;
  ...
  reference_script?: BlockTxInfoItemOutputsItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: BlockTxInfoItemOutputsItemAssetListItem[];
};

export const bigIntsBlockTxInfoItemOutputsItem: Array<string> = [
  ...bigIntsBlockTxInfoItemOutputsItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`,
  ),
  ...bigIntsBlockTxInfoItemOutputsItemStakeAddr.map((item) =>
    item === '' ? 'stake_addr' : `stake_addr.${item}`,
  ),
  ...bigIntsBlockTxInfoItemOutputsItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`,
  ),
  ...bigIntsBlockTxInfoItemOutputsItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`,
  ),
  ...bigIntsBlockTxInfoItemOutputsItemReferenceScript.map((item) =>
    item === '' ? 'reference_script' : `reference_script.${item}`,
  ),
  ...bigIntsBlockTxInfoItemOutputsItemAssetListItem.map((item) =>
