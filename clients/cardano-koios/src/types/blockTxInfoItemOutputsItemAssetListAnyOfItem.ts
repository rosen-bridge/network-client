 ...
 */
import type { BlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName } from './blockTxInfoItemOutputsItemAssetListAnyOfItemAssetName';

import { bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName } from './blockTxInfoItemOutputsItemAssetListAnyOfItemAssetName';

export type BlockTxInfoItemOutputsItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName;
...
export const bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemOutputsItemAssetListAnyOfItemAssetName.map(
