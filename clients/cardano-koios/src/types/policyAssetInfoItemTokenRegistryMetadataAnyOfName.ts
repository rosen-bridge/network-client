...
export type PolicyAssetInfoItemTokenRegistryMetadataAnyOfName = null | string;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataAnyOfName: Array<string> =
  [];
