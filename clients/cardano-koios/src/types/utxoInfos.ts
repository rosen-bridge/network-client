 ...
 */
import type { UtxoInfosItem } from './utxoInfosItem';

import { bigIntsUtxoInfosItem } from './utxoInfosItem';

/**
 * Array of complete UTxO information
 */
export type UtxoInfos = UtxoInfosItem[];
export const bigIntsUtxoInfos: Array<string> = [...bigIntsUtxoInfosItem];
