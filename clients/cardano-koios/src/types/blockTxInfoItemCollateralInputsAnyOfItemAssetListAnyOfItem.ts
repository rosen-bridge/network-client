 ...
 */
import type { BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName';

export type BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName;
...
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItemAssetName.map(
