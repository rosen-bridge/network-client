 ...
 */
import type { TxInfoItemCollateralOutputItemAssetListItem } from './txInfoItemCollateralOutputItemAssetListItem';
import { bigIntsTxInfoItemCollateralOutputItemAssetListItem } from './txInfoItemCollateralOutputItemAssetListItem';
import type { TxInfoItemCollateralOutputItemDatumHash } from './txInfoItemCollateralOutputItemDatumHash';
import { bigIntsTxInfoItemCollateralOutputItemDatumHash } from './txInfoItemCollateralOutputItemDatumHash';
import type { TxInfoItemCollateralOutputItemInlineDatum } from './txInfoItemCollateralOutputItemInlineDatum';
import { bigIntsTxInfoItemCollateralOutputItemInlineDatum } from './txInfoItemCollateralOutputItemInlineDatum';
import type { TxInfoItemCollateralOutputItemPaymentAddr } from './txInfoItemCollateralOutputItemPaymentAddr';
import { bigIntsTxInfoItemCollateralOutputItemPaymentAddr } from './txInfoItemCollateralOutputItemPaymentAddr';
import type { TxInfoItemCollateralOutputItemReferenceScript } from './txInfoItemCollateralOutputItemReferenceScript';
import { bigIntsTxInfoItemCollateralOutputItemReferenceScript } from './txInfoItemCollateralOutputItemReferenceScript';
import type { TxInfoItemCollateralOutputItemStakeAddr } from './txInfoItemCollateralOutputItemStakeAddr';

import { bigIntsTxInfoItemCollateralOutputItemStakeAddr } from './txInfoItemCollateralOutputItemStakeAddr';

export type TxInfoItemCollateralOutputItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: TxInfoItemCollateralOutputItemAssetListItem[] | null;
  /** Hash of datum (if any) connected to UTxO */
  datum_hash?: TxInfoItemCollateralOutputItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: TxInfoItemCollateralOutputItemInlineDatum;
  payment_addr?: TxInfoItemCollateralOutputItemPaymentAddr;
  ...
  reference_script?: TxInfoItemCollateralOutputItemReferenceScript;
  stake_addr?: TxInfoItemCollateralOutputItemStakeAddr;
...
export const bigIntsTxInfoItemCollateralOutputItem = [
  ...bigIntsTxInfoItemCollateralOutputItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputItemReferenceScript.map((item) =>
    item === '' ? 'reference_script' : `reference_script.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputItemStakeAddr.map((item) =>
