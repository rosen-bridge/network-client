 ...
 */
import type { TxMetadataAnyOfItemMetadataAnyOf } from './txMetadataAnyOfItemMetadataAnyOf';

import { bigIntsTxMetadataAnyOfItemMetadataAnyOf } from './txMetadataAnyOfItemMetadataAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type TxMetadataAnyOfItemMetadata =
  TxMetadataAnyOfItemMetadataAnyOf | null | null;
export const bigIntsTxMetadataAnyOfItemMetadata: Array<string> = [
  ...bigIntsTxMetadataAnyOfItemMetadataAnyOf,
];
