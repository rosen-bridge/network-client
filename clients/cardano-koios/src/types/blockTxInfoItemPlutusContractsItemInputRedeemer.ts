...
export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemer = [
  ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatum.map((item) =>
    item === '' ? 'datum' : `datum.${item}`
  ),
  ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerPurpose.map((item) =>
