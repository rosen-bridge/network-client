 ...
 */
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerDatum } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatum';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatum } from './blockTxInfoItemPlutusContractsItemInputRedeemerDatum';
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerPurpose } from './blockTxInfoItemPlutusContractsItemInputRedeemerPurpose';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerPurpose } from './blockTxInfoItemPlutusContractsItemInputRedeemerPurpose';
import type { BlockTxInfoItemPlutusContractsItemInputRedeemerUnit } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnit';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnit } from './blockTxInfoItemPlutusContractsItemInputRedeemerUnit';

export type BlockTxInfoItemPlutusContractsItemInputRedeemer = {
  /** What kind of validation this redeemer is used for */
  purpose?: BlockTxInfoItemPlutusContractsItemInputRedeemerPurpose;
  /** The budget in fees to run a script - the fees depend on the ExUnits and the current prices */
  fee?: string;
  unit?: BlockTxInfoItemPlutusContractsItemInputRedeemerUnit;
  datum?: BlockTxInfoItemPlutusContractsItemInputRedeemerDatum;
};

export const bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemer: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerPurpose.map(
      (item) => (item === '' ? 'purpose' : `purpose.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerUnit.map((item) =>
      item === '' ? 'unit' : `unit.${item}`,
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputRedeemerDatum.map(
