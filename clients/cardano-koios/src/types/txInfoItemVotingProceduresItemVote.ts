 ...
 * Actual Vote casted
 */
export type TxInfoItemVotingProceduresItemVote =
  (typeof TxInfoItemVotingProceduresItemVote)[keyof typeof TxInfoItemVotingProceduresItemVote];

// eslint-disable-next-line no-redeclare
export const TxInfoItemVotingProceduresItemVote = {
  Yes: 'Yes',
  No: 'No',
  Abstain: 'Abstain',
} as const;
export const bigIntsTxInfoItemVotingProceduresItemVote: Array<string> = [];
