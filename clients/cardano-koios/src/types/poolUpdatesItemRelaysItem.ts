 ...
 */
import type { PoolUpdatesItemRelaysItemDns } from './poolUpdatesItemRelaysItemDns';
import { bigIntsPoolUpdatesItemRelaysItemDns } from './poolUpdatesItemRelaysItemDns';
import type { PoolUpdatesItemRelaysItemIpv4 } from './poolUpdatesItemRelaysItemIpv4';
import { bigIntsPoolUpdatesItemRelaysItemIpv4 } from './poolUpdatesItemRelaysItemIpv4';
import type { PoolUpdatesItemRelaysItemIpv6 } from './poolUpdatesItemRelaysItemIpv6';
import { bigIntsPoolUpdatesItemRelaysItemIpv6 } from './poolUpdatesItemRelaysItemIpv6';
import type { PoolUpdatesItemRelaysItemPort } from './poolUpdatesItemRelaysItemPort';
import { bigIntsPoolUpdatesItemRelaysItemPort } from './poolUpdatesItemRelaysItemPort';
import type { PoolUpdatesItemRelaysItemSrv } from './poolUpdatesItemRelaysItemSrv';
import { bigIntsPoolUpdatesItemRelaysItemSrv } from './poolUpdatesItemRelaysItemSrv';

export type PoolUpdatesItemRelaysItem = {
  /** DNS name of the relay (nullable) */
  dns?: PoolUpdatesItemRelaysItemDns;
  /** DNS service name of the relay (nullable) */
  srv?: PoolUpdatesItemRelaysItemSrv;
  /** IPv4 address of the relay (nullable) */
  ipv4?: PoolUpdatesItemRelaysItemIpv4;
  /** IPv6 address of the relay (nullable) */
  ipv6?: PoolUpdatesItemRelaysItemIpv6;
  /** Port number of the relay (nullable) */
  port?: PoolUpdatesItemRelaysItemPort;
};

export const bigIntsPoolUpdatesItemRelaysItem: Array<string> = [
  ...bigIntsPoolUpdatesItemRelaysItemDns.map((item) =>
    item === '' ? 'dns' : `dns.${item}`,
  ),
  ...bigIntsPoolUpdatesItemRelaysItemSrv.map((item) =>
    item === '' ? 'srv' : `srv.${item}`,
  ),
  ...bigIntsPoolUpdatesItemRelaysItemIpv4.map((item) =>
    item === '' ? 'ipv4' : `ipv4.${item}`,
  ),
  ...bigIntsPoolUpdatesItemRelaysItemIpv6.map((item) =>
    item === '' ? 'ipv6' : `ipv6.${item}`,
  ),
  ...bigIntsPoolUpdatesItemRelaysItemPort.map((item) =>
    item === '' ? 'port' : `port.${item}`,
  ),
];
