 ...
 */
import type { AssetHistoryItemMintingTxsAnyOfItem } from './assetHistoryItemMintingTxsAnyOfItem';

import { bigIntsAssetHistoryItemMintingTxsAnyOfItem } from './assetHistoryItemMintingTxsAnyOfItem';

/**
 * Array of all mint/burn transactions for an asset
 */
export type AssetHistoryItemMintingTxs =
  | AssetHistoryItemMintingTxsAnyOfItem[]
  | null
  | null;
export const bigIntsAssetHistoryItemMintingTxs: Array<string> = [
  ...bigIntsAssetHistoryItemMintingTxsAnyOfItem,
];
