 ...
 */
import type { PoolUpdatesItemMetaJsonAnyOf } from './poolUpdatesItemMetaJsonAnyOf';

import { bigIntsPoolUpdatesItemMetaJsonAnyOf } from './poolUpdatesItemMetaJsonAnyOf';

export type PoolUpdatesItemMetaJson =
  PoolUpdatesItemMetaJsonAnyOf | null | null;
export const bigIntsPoolUpdatesItemMetaJson: Array<string> = [
  ...bigIntsPoolUpdatesItemMetaJsonAnyOf,
];
