 ...
 * Value (json)
 */
export type AddressInfoItemUtxoSetItemReferenceScriptAnyOfValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsAddressInfoItemUtxoSetItemReferenceScriptAnyOfValueAnyOf: Array<string> =
  [];
