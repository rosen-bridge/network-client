 ...
 */
export type TxInfoItemVotingProceduresItemVoterRole =
  (typeof TxInfoItemVotingProceduresItemVoterRole)[keyof typeof TxInfoItemVotingProceduresItemVoterRole];

// eslint-disable-next-line no-redeclare
export const TxInfoItemVotingProceduresItemVoterRole = {
  ConstitutionalCommittee: 'ConstitutionalCommittee',
  DRep: 'DRep',
  SPO: 'SPO',
} as const;
export const bigIntsTxInfoItemVotingProceduresItemVoterRole: Array<string> = [];
