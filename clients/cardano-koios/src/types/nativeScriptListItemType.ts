 ...
 * Type of the script
 */
export type NativeScriptListItemType =
  (typeof NativeScriptListItemType)[keyof typeof NativeScriptListItemType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NativeScriptListItemType = {
  timelock: 'timelock',
  multisig: 'multisig',
} as const;
export const bigIntsNativeScriptListItemType = [];
