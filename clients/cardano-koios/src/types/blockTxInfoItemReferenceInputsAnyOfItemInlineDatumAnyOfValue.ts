 ...
 * Value (json)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue: Array<string> =
  [];
