 ...
 */
import type { UtxoInfosItemReferenceScriptValueAnyOf } from './utxoInfosItemReferenceScriptValueAnyOf';
import { bigIntsUtxoInfosItemReferenceScriptValueAnyOf } from './utxoInfosItemReferenceScriptValueAnyOf';

/**
 * Value (json)
 */
export type UtxoInfosItemReferenceScriptValue =
  UtxoInfosItemReferenceScriptValueAnyOf | null;
export const bigIntsUtxoInfosItemReferenceScriptValue: Array<string> = [
  ...bigIntsUtxoInfosItemReferenceScriptValueAnyOf,
];
