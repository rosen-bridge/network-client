 ...
 * Data in JSON format
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValueAnyOf =
  { [key: string]: unknown };
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerDatumValueAnyOf: Array<string> =
  [];
