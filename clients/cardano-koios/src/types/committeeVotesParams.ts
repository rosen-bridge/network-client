 ...
 */
import type { _CcHotIdParameter } from './_ccHotIdParameter';

import { bigInts_CcHotIdParameter } from './_ccHotIdParameter';

export type CommitteeVotesParams = {
  /**
   * Committee member hot key ID in Bech32 format (CIP-5 | CIP-129)
   */
  _cc_hot_id?: _CcHotIdParameter;
};

export const bigIntsCommitteeVotesParams = [
