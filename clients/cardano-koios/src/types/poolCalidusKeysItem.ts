 ...
 */
import type { PoolCalidusKeysItemPoolStatus } from './poolCalidusKeysItemPoolStatus';
import { bigIntsPoolCalidusKeysItemPoolStatus } from './poolCalidusKeysItemPoolStatus';

export type PoolCalidusKeysItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  /** Pool status */
  pool_status?: PoolCalidusKeysItemPoolStatus;
  /** Unique nonce for pool's calidus key registration as per CIP-88 */
...
export const bigIntsPoolCalidusKeysItem: Array<string> = [
  ...bigIntsPoolCalidusKeysItemPoolStatus.map((item) =>
