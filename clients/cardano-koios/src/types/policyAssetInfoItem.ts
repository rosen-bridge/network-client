 ...
 */
import type { PolicyAssetInfoItemAssetName } from './policyAssetInfoItemAssetName';
import { bigIntsPolicyAssetInfoItemAssetName } from './policyAssetInfoItemAssetName';
import type { PolicyAssetInfoItemMintingTxMetadataAllOf } from './policyAssetInfoItemMintingTxMetadataAllOf';
import { bigIntsPolicyAssetInfoItemMintingTxMetadataAllOf } from './policyAssetInfoItemMintingTxMetadataAllOf';
import type { PolicyAssetInfoItemTokenRegistryMetadata } from './policyAssetInfoItemTokenRegistryMetadata';

import { bigIntsPolicyAssetInfoItemTokenRegistryMetadata } from './policyAssetInfoItemTokenRegistryMetadata';

export type PolicyAssetInfoItem = {
  /** Asset Name (hex) */
  asset_name?: PolicyAssetInfoItemAssetName;
  /** Asset Name (ASCII) */
  ...
  minting_tx_metadata?: PolicyAssetInfoItemMintingTxMetadataAllOf;
  /** Asset metadata registered on the Cardano Token Registry */
  token_registry_metadata?: PolicyAssetInfoItemTokenRegistryMetadata;
