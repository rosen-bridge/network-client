 ...
 * Value (json)
 */
export type TxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue: Array<string> =
  [];
