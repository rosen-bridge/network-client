...
import { bigIntsPoolListItem } from './poolListItem';

/**
 * Array of pool IDs and tickers
 */
export type PoolList = PoolListItem[];
export const bigIntsPoolList: Array<string> = [...bigIntsPoolListItem];
