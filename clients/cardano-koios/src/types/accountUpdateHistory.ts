 ...
 */
import type { AccountUpdateHistoryItem } from './accountUpdateHistoryItem';
import { bigIntsAccountUpdateHistoryItem } from './accountUpdateHistoryItem';

/**
 * Array of account update history information
 */
export type AccountUpdateHistory = AccountUpdateHistoryItem[];
export const bigIntsAccountUpdateHistory: Array<string> = [
  ...bigIntsAccountUpdateHistoryItem,
];
