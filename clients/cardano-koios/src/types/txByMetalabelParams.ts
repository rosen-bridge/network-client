...
import type { _LabelParameter } from './_labelParameter';
import { bigInts_LabelParameter } from './_labelParameter';

export type TxByMetalabelParams = {
  /**
   * Metadata label (key) to filter transactions by
   */
  _label: _LabelParameter;
  /**
...
export const bigIntsTxByMetalabelParams: Array<string> = [
  ...bigInts_LabelParameter.map((item) =>
