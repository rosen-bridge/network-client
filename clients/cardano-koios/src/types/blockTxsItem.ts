 ...
 */
import type { BlockTxsItemBlockHeight } from './blockTxsItemBlockHeight';

import { bigIntsBlockTxsItemBlockHeight } from './blockTxsItemBlockHeight';

export type BlockTxsItem = {
  /** Hash of the block */
  block_hash?: string;
  ...
  epoch_no?: number;
  /** Block height */
  block_height?: BlockTxsItemBlockHeight;
  /** UNIX timestamp of the block */
  block_time?: number;
};

export const bigIntsBlockTxsItem: Array<string> = [
  ...bigIntsBlockTxsItemBlockHeight.map((item) =>
