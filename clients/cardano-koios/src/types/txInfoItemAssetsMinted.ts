 ...
 */
import type { TxInfoItemAssetsMintedAnyOfItem } from './txInfoItemAssetsMintedAnyOfItem';
import { bigIntsTxInfoItemAssetsMintedAnyOfItem } from './txInfoItemAssetsMintedAnyOfItem';

/**
 * Array of minted assets with-in a transaction
 */
export type TxInfoItemAssetsMinted = TxInfoItemAssetsMintedAnyOfItem[] | null;
export const bigIntsTxInfoItemAssetsMinted: Array<string> = [
  ...bigIntsTxInfoItemAssetsMintedAnyOfItem,
];
