...
export type TxInfoBody = {
  /** Array of Cardano Transaction hashes */
  _tx_hashes: string[];
  /** Controls whether to include transaction inputs in the result */
  _inputs?: boolean;
  /** Controls whether to include transaction metadata in the result */
  _metadata?: boolean;
  /** Controls whether to include assets involved within transaction the result */
  _assets?: boolean;
  /** Controls whether to include any stake account reward withdrawals in the result */
  _withdrawals?: boolean;
  /** Controls whether to include transaction certificates in the result */
  _certs?: boolean;
  /** Controls whether to include any details regarding collateral/reference/datum/script objects in the result */
  _scripts?: boolean;
  /** Controls whether to include bytecode for associated reference/plutus scripts */
  _bytecode?: boolean;
  /** Controls whether to include governance certificates, votes and proposals in the result */
  _governance?: boolean;
};
export const bigIntsTxInfoBody: Array<string> = [];
