 ...
 */
import type { TxOutsEpochItemDatumHash } from './txOutsEpochItemDatumHash';
import { bigIntsTxOutsEpochItemDatumHash } from './txOutsEpochItemDatumHash';
import type { TxOutsEpochItemPaymentCred } from './txOutsEpochItemPaymentCred';
import { bigIntsTxOutsEpochItemPaymentCred } from './txOutsEpochItemPaymentCred';
import type { TxOutsEpochItemStakeAddress } from './txOutsEpochItemStakeAddress';
import { bigIntsTxOutsEpochItemStakeAddress } from './txOutsEpochItemStakeAddress';

export type TxOutsEpochItem = {
  ...
  address?: string;
  stake_address?: TxOutsEpochItemStakeAddress;
  /** Payment credential */
  payment_cred?: TxOutsEpochItemPaymentCred;
  ...
  datum_hash?: TxOutsEpochItemDatumHash;
  /** True if the UTxO has been spent */
  is_spent?: boolean;
};

export const bigIntsTxOutsEpochItem: Array<string> = [
  ...bigIntsTxOutsEpochItemStakeAddress.map((item) =>
    item === '' ? 'stake_address' : `stake_address.${item}`,
  ),
  ...bigIntsTxOutsEpochItemPaymentCred.map((item) =>
    item === '' ? 'payment_cred' : `payment_cred.${item}`,
  ),
  ...bigIntsTxOutsEpochItemDatumHash.map((item) =>
