 ...
 */
import type { DrepUpdatesItemAction } from './drepUpdatesItemAction';
import { bigIntsDrepUpdatesItemAction } from './drepUpdatesItemAction';
import type { DrepUpdatesItemDeposit } from './drepUpdatesItemDeposit';
import { bigIntsDrepUpdatesItemDeposit } from './drepUpdatesItemDeposit';
import type { DrepUpdatesItemMetaHash } from './drepUpdatesItemMetaHash';
import { bigIntsDrepUpdatesItemMetaHash } from './drepUpdatesItemMetaHash';
import type { DrepUpdatesItemMetaJson } from './drepUpdatesItemMetaJson';
import { bigIntsDrepUpdatesItemMetaJson } from './drepUpdatesItemMetaJson';
import type { DrepUpdatesItemMetaUrl } from './drepUpdatesItemMetaUrl';

import { bigIntsDrepUpdatesItemMetaUrl } from './drepUpdatesItemMetaUrl';

export type DrepUpdatesItem = {
  /** Effective action for this DRep Update certificate */
  action?: DrepUpdatesItemAction;
  /** UNIX timestamp of the block */
  block_time?: number;
  /** The index of this certificate within the the transaction. */
  cert_index?: number;
  /** DRep's registration deposit  in number */
  deposit?: DrepUpdatesItemDeposit;
  ...
  meta_hash?: DrepUpdatesItemMetaHash;
  /** The payload as JSON */
  meta_json?: DrepUpdatesItemMetaJson;
  /** A URL to a JSON payload of metadata */
  meta_url?: DrepUpdatesItemMetaUrl;
  /** Hash identifier of the transaction */
  update_tx_hash?: string;
};

export const bigIntsDrepUpdatesItem = [
