 ...
 */
import type { TxInfoItemCollateralInputsItemPaymentAddr } from './txInfoItemCollateralInputsItemPaymentAddr';
import { bigIntsTxInfoItemCollateralInputsItemPaymentAddr } from './txInfoItemCollateralInputsItemPaymentAddr';
import type { TxInfoItemCollateralInputsItemStakeAddr } from './txInfoItemCollateralInputsItemStakeAddr';
import { bigIntsTxInfoItemCollateralInputsItemStakeAddr } from './txInfoItemCollateralInputsItemStakeAddr';
import type { TxInfoItemCollateralInputsItemInlineDatum } from './txInfoItemCollateralInputsItemInlineDatum';
import { bigIntsTxInfoItemCollateralInputsItemInlineDatum } from './txInfoItemCollateralInputsItemInlineDatum';
import type { TxInfoItemCollateralInputsItemReferenceScript } from './txInfoItemCollateralInputsItemReferenceScript';
import { bigIntsTxInfoItemCollateralInputsItemReferenceScript } from './txInfoItemCollateralInputsItemReferenceScript';
import type { TxInfoItemCollateralInputsItemAssetListItem } from './txInfoItemCollateralInputsItemAssetListItem';

import { bigIntsTxInfoItemCollateralInputsItemAssetListItem } from './txInfoItemCollateralInputsItemAssetListItem';

export type TxInfoItemCollateralInputsItem = {
  payment_addr?: TxInfoItemCollateralInputsItemPaymentAddr;
  stake_addr?: TxInfoItemCollateralInputsItemStakeAddr;
  ...
  inline_datum?: TxInfoItemCollateralInputsItemInlineDatum;
  ...
  reference_script?: TxInfoItemCollateralInputsItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxInfoItemCollateralInputsItemAssetListItem[] | null;
};

export const bigIntsTxInfoItemCollateralInputsItem = [
  ...bigIntsTxInfoItemCollateralInputsItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralInputsItemStakeAddr.map((item) =>
    item === '' ? 'stake_addr' : `stake_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralInputsItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsTxInfoItemCollateralInputsItemReferenceScript.map((item) =>
