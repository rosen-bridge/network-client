 ...
 */
export type VoteListItemProposalType =
  (typeof VoteListItemProposalType)[keyof typeof VoteListItemProposalType];

// eslint-disable-next-line no-redeclare
export const VoteListItemProposalType = {
...
export const bigIntsVoteListItemProposalType: Array<string> = [];
