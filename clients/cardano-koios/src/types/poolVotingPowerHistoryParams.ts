...
import type { _PoolBech32OptionalParameter } from './_poolBech32OptionalParameter';
import { bigInts_PoolBech32OptionalParameter } from './_poolBech32OptionalParameter';

export type PoolVotingPowerHistoryParams = {
  /**
   * Epoch Number to fetch details for
   */
  _epoch_no?: _EpochNoParameter;
  /**
   * Pool ID in bech32 format (optional)
   */
  _pool_bech32?: _PoolBech32OptionalParameter;
};

export const bigIntsPoolVotingPowerHistoryParams: Array<string> = [
