...
import type { _PoolBech32Parameter } from './_poolBech32Parameter';
import { bigInts_PoolBech32Parameter } from './_poolBech32Parameter';

export type PoolInvalidDelegatorsParams = {
  /**
   * Pool ID in bech32 format
   */
  _pool_bech32: _PoolBech32Parameter;
  /**
...
export const bigIntsPoolInvalidDelegatorsParams: Array<string> = [
