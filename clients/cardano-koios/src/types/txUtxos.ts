 ...
 */
import type { TxUtxosItem } from './txUtxosItem';
import { bigIntsTxUtxosItem } from './txUtxosItem';

/**
 * Array of inputs and outputs for given transaction(s)
 */
export type TxUtxos = TxUtxosItem[];
export const bigIntsTxUtxos: Array<string> = [...bigIntsTxUtxosItem];
