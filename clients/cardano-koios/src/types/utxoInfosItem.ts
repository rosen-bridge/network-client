...
import { bigIntsUtxoInfosItemInlineDatum } from './utxoInfosItemInlineDatum';
import type { UtxoInfosItemPaymentCred } from './utxoInfosItemPaymentCred';
import { bigIntsUtxoInfosItemPaymentCred } from './utxoInfosItemPaymentCred';
import type { UtxoInfosItemReferenceScript } from './utxoInfosItemReferenceScript';
import { bigIntsUtxoInfosItemReferenceScript } from './utxoInfosItemReferenceScript';
import type { UtxoInfosItemStakeAddress } from './utxoInfosItemStakeAddress';

import { bigIntsUtxoInfosItemStakeAddress } from './utxoInfosItemStakeAddress';

export type UtxoInfosItem = {
   ...
   * @nullable
   */
  asset_list?: UtxoInfosItemAssetListItem[] | null;
  /** Block height */
  block_height?: UtxoInfosItemBlockHeight;
  /** UNIX timestamp of the block */
  block_time?: number;
  /** The Hash of the Plutus Data */
  datum_hash?: UtxoInfosItemDatumHash;
  /** Epoch number of the block */
  epoch_no?: number;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: UtxoInfosItemInlineDatum;
  /** True if the UTXO has been spent */
  is_spent?: boolean;
  /** Payment credential */
  payment_cred?: UtxoInfosItemPaymentCred;
  ...
  stake_address?: UtxoInfosItemStakeAddress;
...
export const bigIntsUtxoInfosItem = [
