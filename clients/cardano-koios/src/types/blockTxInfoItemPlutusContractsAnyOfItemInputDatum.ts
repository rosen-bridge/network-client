 ...
 */
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash } from './blockTxInfoItemPlutusContractsAnyOfItemInputDatumHash';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash } from './blockTxInfoItemPlutusContractsAnyOfItemInputDatumHash';
import type { BlockTxInfoItemPlutusContractsAnyOfItemInputDatumValue } from './blockTxInfoItemPlutusContractsAnyOfItemInputDatumValue';

import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumValue } from './blockTxInfoItemPlutusContractsAnyOfItemInputDatumValue';

export type BlockTxInfoItemPlutusContractsAnyOfItemInputDatum = {
  /** The Hash of the Plutus Data */
  hash?: BlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash;
  /** Data in JSON format */
  value?: BlockTxInfoItemPlutusContractsAnyOfItemInputDatumValue;
};

export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatum: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash.map(
      (item) => (item === '' ? 'hash' : `hash.${item}`),
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumValue.map(
