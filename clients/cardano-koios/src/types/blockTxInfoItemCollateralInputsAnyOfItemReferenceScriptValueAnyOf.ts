...
export type BlockTxInfoItemCollateralInputsAnyOfItemReferenceScriptValueAnyOf =
  { [key: string]: unknown };
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemReferenceScriptValueAnyOf: Array<string> =
  [];
