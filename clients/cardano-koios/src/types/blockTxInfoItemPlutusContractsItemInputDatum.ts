 ...
 */
import type { BlockTxInfoItemPlutusContractsItemInputDatumHash } from './blockTxInfoItemPlutusContractsItemInputDatumHash';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputDatumHash } from './blockTxInfoItemPlutusContractsItemInputDatumHash';
import type { BlockTxInfoItemPlutusContractsItemInputDatumValue } from './blockTxInfoItemPlutusContractsItemInputDatumValue';
import { bigIntsBlockTxInfoItemPlutusContractsItemInputDatumValue } from './blockTxInfoItemPlutusContractsItemInputDatumValue';

export type BlockTxInfoItemPlutusContractsItemInputDatum = {
  /** The Hash of the Plutus Data */
  hash?: BlockTxInfoItemPlutusContractsItemInputDatumHash;
  /** Data in JSON format */
  value?: BlockTxInfoItemPlutusContractsItemInputDatumValue;
};

export const bigIntsBlockTxInfoItemPlutusContractsItemInputDatum: Array<string> =
  [
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputDatumHash.map((item) =>
      item === '' ? 'hash' : `hash.${item}`,
    ),
    ...bigIntsBlockTxInfoItemPlutusContractsItemInputDatumValue.map((item) =>
