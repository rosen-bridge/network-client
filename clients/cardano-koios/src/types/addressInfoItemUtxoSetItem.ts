...
import { bigIntsAddressInfoItemUtxoSetItemInlineDatum } from './addressInfoItemUtxoSetItemInlineDatum';
import type { AddressInfoItemUtxoSetItemReferenceScript } from './addressInfoItemUtxoSetItemReferenceScript';

import { bigIntsAddressInfoItemUtxoSetItemReferenceScript } from './addressInfoItemUtxoSetItemReferenceScript';

export type AddressInfoItemUtxoSetItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: AddressInfoItemUtxoSetItemAssetListItem[] | null;
  /** Block height */
  block_height?: AddressInfoItemUtxoSetItemBlockHeight;
  /** UNIX timestamp of the block */
  block_time?: number;
  /** The Hash of the Plutus Data */
  datum_hash?: AddressInfoItemUtxoSetItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: AddressInfoItemUtxoSetItemInlineDatum;
