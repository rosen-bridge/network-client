 ...
 */
import type { BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type BlockTxInfoItemCollateralInputsAnyOfItemAssetList =
  | BlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetList: Array<string> =
  [...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListAnyOfItem];
