 ...
 */
import type { BlockTxInfoItemNativeScriptsAnyOfItem } from './blockTxInfoItemNativeScriptsAnyOfItem';
import { bigIntsBlockTxInfoItemNativeScriptsAnyOfItem } from './blockTxInfoItemNativeScriptsAnyOfItem';

/**
 * Native scripts present in a transaction (if any)
 */
export type BlockTxInfoItemNativeScripts =
  | BlockTxInfoItemNativeScriptsAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemNativeScripts: Array<string> = [
  ...bigIntsBlockTxInfoItemNativeScriptsAnyOfItem,
];
