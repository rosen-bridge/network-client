 ...
 */
import type { PoolHistoryInfoItemActiveStake } from './poolHistoryInfoItemActiveStake';
import { bigIntsPoolHistoryInfoItemActiveStake } from './poolHistoryInfoItemActiveStake';
import type { PoolHistoryInfoItemActiveStakePct } from './poolHistoryInfoItemActiveStakePct';
import { bigIntsPoolHistoryInfoItemActiveStakePct } from './poolHistoryInfoItemActiveStakePct';
import type { PoolHistoryInfoItemBlockCnt } from './poolHistoryInfoItemBlockCnt';
import { bigIntsPoolHistoryInfoItemBlockCnt } from './poolHistoryInfoItemBlockCnt';
import type { PoolHistoryInfoItemMemberRewards } from './poolHistoryInfoItemMemberRewards';

import { bigIntsPoolHistoryInfoItemMemberRewards } from './poolHistoryInfoItemMemberRewards';
...
export type PoolHistoryInfoItem = {
  ...
  active_stake?: PoolHistoryInfoItemActiveStake;
  /** Active stake for the pool, expressed as a percentage of total active stake on network */
  active_stake_pct?: PoolHistoryInfoItemActiveStakePct;
  /** Saturation percentage of a pool at the time of snapshot (2 decimals) */
  saturation_pct?: number;
  /** Number of blocks pool created in that epoch */
  block_cnt?: PoolHistoryInfoItemBlockCnt;
  /** Number of delegators to the pool for that epoch snapshot */
  delegator_cnt?: number;
  /** Margin (decimal format) */
  margin?: number;
  /** Pool fixed cost per epoch (in numbers) */
  fixed_cost?: string;
  /** Total amount of fees earned by pool owners in that epoch (in numbers) */
  pool_fees?: string;
  /** Total amount of rewards earned by delegators in that epoch (in numbers) */
  deleg_rewards?: string;
  /** Total amount of rewards earned by members (delegator - owner) in that epoch (in numbers) */
  member_rewards?: PoolHistoryInfoItemMemberRewards;
