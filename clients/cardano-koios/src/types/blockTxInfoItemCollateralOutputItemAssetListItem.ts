 ...
 */
import type { BlockTxInfoItemCollateralOutputItemAssetListItemAssetName } from './blockTxInfoItemCollateralOutputItemAssetListItemAssetName';

import { bigIntsBlockTxInfoItemCollateralOutputItemAssetListItemAssetName } from './blockTxInfoItemCollateralOutputItemAssetListItemAssetName';

export type BlockTxInfoItemCollateralOutputItemAssetListItem = {
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemCollateralOutputItemAssetListItemAssetName;
  decimals?: number;
...
export const bigIntsBlockTxInfoItemCollateralOutputItemAssetListItem = [
  ...bigIntsBlockTxInfoItemCollateralOutputItemAssetListItemAssetName.map(
