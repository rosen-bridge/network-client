 ...
 */
import type { BlockTxInfoItemMetadataAnyOf } from './blockTxInfoItemMetadataAnyOf';

import { bigIntsBlockTxInfoItemMetadataAnyOf } from './blockTxInfoItemMetadataAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type BlockTxInfoItemMetadata =
  BlockTxInfoItemMetadataAnyOf | null | null;
export const bigIntsBlockTxInfoItemMetadata: Array<string> = [
  ...bigIntsBlockTxInfoItemMetadataAnyOf,
];
