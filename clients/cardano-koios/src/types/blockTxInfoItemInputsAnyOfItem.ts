...
import { bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatum } from './blockTxInfoItemInputsAnyOfItemInlineDatum';
import type { BlockTxInfoItemInputsAnyOfItemPaymentAddr } from './blockTxInfoItemInputsAnyOfItemPaymentAddr';
import { bigIntsBlockTxInfoItemInputsAnyOfItemPaymentAddr } from './blockTxInfoItemInputsAnyOfItemPaymentAddr';
import type { BlockTxInfoItemInputsAnyOfItemReferenceScript } from './blockTxInfoItemInputsAnyOfItemReferenceScript';
import { bigIntsBlockTxInfoItemInputsAnyOfItemReferenceScript } from './blockTxInfoItemInputsAnyOfItemReferenceScript';
import type { BlockTxInfoItemInputsAnyOfItemStakeAddr } from './blockTxInfoItemInputsAnyOfItemStakeAddr';

import { bigIntsBlockTxInfoItemInputsAnyOfItemStakeAddr } from './blockTxInfoItemInputsAnyOfItemStakeAddr';

export type BlockTxInfoItemInputsAnyOfItem = {
  /**
   * An array of assets on the UTxO
   * @nullable
   */
  asset_list?: BlockTxInfoItemInputsAnyOfItemAssetListItem[] | null;
  /** Hash of datum (if any) connected to UTxO */
  datum_hash?: BlockTxInfoItemInputsAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: BlockTxInfoItemInputsAnyOfItemInlineDatum;
  payment_addr?: BlockTxInfoItemInputsAnyOfItemPaymentAddr;
  ...
  stake_addr?: BlockTxInfoItemInputsAnyOfItemStakeAddr;
...
export const bigIntsBlockTxInfoItemInputsAnyOfItem = [
  ...bigIntsBlockTxInfoItemInputsAnyOfItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsBlockTxInfoItemInputsAnyOfItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsBlockTxInfoItemInputsAnyOfItemPaymentAddr.map((item) =>
  ...
  ...bigIntsBlockTxInfoItemInputsAnyOfItemStakeAddr.map((item) =>
