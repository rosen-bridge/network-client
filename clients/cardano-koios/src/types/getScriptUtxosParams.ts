 ...
 */
import type { _ScriptHashParameter } from './_scriptHashParameter';
import { bigInts_ScriptHashParameter } from './_scriptHashParameter';
import type { _ExtendedParameter } from './_extendedParameter';

import { bigInts_ExtendedParameter } from './_extendedParameter';

export type GetScriptUtxosParams = {
  /**
   * Script hash in hexadecimal format (hex)
   */
  _script_hash: _ScriptHashParameter;
  /**
   * Controls whether or not certain optional fields supported by a given endpoint are populated as a part of the call
   */
  _extended?: _ExtendedParameter;
};

export const bigIntsGetScriptUtxosParams = [
