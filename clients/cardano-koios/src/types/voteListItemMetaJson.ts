 ...
 */
import type { VoteListItemMetaJsonAnyOf } from './voteListItemMetaJsonAnyOf';
import { bigIntsVoteListItemMetaJsonAnyOf } from './voteListItemMetaJsonAnyOf';

/**
 * The payload as JSON
 */
export type VoteListItemMetaJson = VoteListItemMetaJsonAnyOf | null;
export const bigIntsVoteListItemMetaJson: Array<string> = [
  ...bigIntsVoteListItemMetaJsonAnyOf,
];
