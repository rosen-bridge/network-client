 ...
 * Pool status
 */
export type PoolMetadataItemPoolStatus =
  (typeof PoolMetadataItemPoolStatus)[keyof typeof PoolMetadataItemPoolStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PoolMetadataItemPoolStatus = {
  registered: 'registered',
  retiring: 'retiring',
  retired: 'retired',
} as const;
export const bigIntsPoolMetadataItemPoolStatus = [];
