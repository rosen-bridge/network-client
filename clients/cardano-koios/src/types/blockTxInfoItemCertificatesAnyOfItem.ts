 ...
 */
import type { BlockTxInfoItemCertificatesAnyOfItemIndex } from './blockTxInfoItemCertificatesAnyOfItemIndex';
import { bigIntsBlockTxInfoItemCertificatesAnyOfItemIndex } from './blockTxInfoItemCertificatesAnyOfItemIndex';
import type { BlockTxInfoItemCertificatesAnyOfItemInfo } from './blockTxInfoItemCertificatesAnyOfItemInfo';
import { bigIntsBlockTxInfoItemCertificatesAnyOfItemInfo } from './blockTxInfoItemCertificatesAnyOfItemInfo';

export type BlockTxInfoItemCertificatesAnyOfItem = {
  /** Certificate index */
  index?: BlockTxInfoItemCertificatesAnyOfItemIndex;
  ...
  info?: BlockTxInfoItemCertificatesAnyOfItemInfo;
};

export const bigIntsBlockTxInfoItemCertificatesAnyOfItem: Array<string> = [
  ...bigIntsBlockTxInfoItemCertificatesAnyOfItemIndex.map((item) =>
    item === '' ? 'index' : `index.${item}`,
  ),
  ...bigIntsBlockTxInfoItemCertificatesAnyOfItemInfo.map((item) =>
    item === '' ? 'info' : `info.${item}`,
  ),
];
