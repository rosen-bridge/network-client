 ...
 */
import type { TxInfoItemOutputsItemReferenceScriptValueAnyOf } from './txInfoItemOutputsItemReferenceScriptValueAnyOf';
import { bigIntsTxInfoItemOutputsItemReferenceScriptValueAnyOf } from './txInfoItemOutputsItemReferenceScriptValueAnyOf';

/**
 * Value (json)
 */
export type TxInfoItemOutputsItemReferenceScriptValue =
  TxInfoItemOutputsItemReferenceScriptValueAnyOf | null;
export const bigIntsTxInfoItemOutputsItemReferenceScriptValue: Array<string> = [
  ...bigIntsTxInfoItemOutputsItemReferenceScriptValueAnyOf,
];
