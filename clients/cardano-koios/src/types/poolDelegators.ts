 ...
 */
import type { PoolDelegatorsItem } from './poolDelegatorsItem';

import { bigIntsPoolDelegatorsItem } from './poolDelegatorsItem';

/**
 * Array of live pool delegators
 */
export type PoolDelegators = PoolDelegatorsItem[];
export const bigIntsPoolDelegators: Array<string> = [
  ...bigIntsPoolDelegatorsItem,
];
