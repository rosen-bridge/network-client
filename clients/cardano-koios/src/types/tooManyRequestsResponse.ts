...
/**
 * Too many requests were sent in a short period, the tier-based cap can be referred to at https://koios.rest/tiers.html
 */
export type TooManyRequestsResponse = void;
export const bigIntsTooManyRequestsResponse: Array<string> = [];
