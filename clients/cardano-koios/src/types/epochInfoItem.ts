...
import type { EpochInfoItemAvgBlkReward } from './epochInfoItemAvgBlkReward';
import { bigIntsEpochInfoItemAvgBlkReward } from './epochInfoItemAvgBlkReward';
import type { EpochInfoItemTotalRewards } from './epochInfoItemTotalRewards';

import { bigIntsEpochInfoItemTotalRewards } from './epochInfoItemTotalRewards';

export type EpochInfoItem = {
  /** Total active stake in epoch stake snapshot (null for pre-Shelley epochs) */
  active_stake?: EpochInfoItemActiveStake;
  /** Average block reward for epoch (null for pre-Shelley epochs) */
  avg_blk_reward?: EpochInfoItemAvgBlkReward;
  ...
  total_rewards?: EpochInfoItemTotalRewards;
  /** Number of transactions submitted in epoch */
  tx_count?: number;
};

export const bigIntsEpochInfoItem = [
