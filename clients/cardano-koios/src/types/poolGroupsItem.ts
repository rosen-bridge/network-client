 ...
 */
import type { PoolGroupsItemAdastatGroup } from './poolGroupsItemAdastatGroup';
import { bigIntsPoolGroupsItemAdastatGroup } from './poolGroupsItemAdastatGroup';
import type { PoolGroupsItemBalanceanalyticsGroup } from './poolGroupsItemBalanceanalyticsGroup';
import { bigIntsPoolGroupsItemBalanceanalyticsGroup } from './poolGroupsItemBalanceanalyticsGroup';
import type { PoolGroupsItemPoolGroup } from './poolGroupsItemPoolGroup';
import { bigIntsPoolGroupsItemPoolGroup } from './poolGroupsItemPoolGroup';

export type PoolGroupsItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  /** A group that the pool was identified to be associated with */
  pool_group?: PoolGroupsItemPoolGroup;
  /** Pool ticker */
  ticker?: string;
  /** The pool's group identification as per adastat.net */
  adastat_group?: PoolGroupsItemAdastatGroup;
  /** The pool's group identification as per balanceanalytics.io */
  balanceanalytics_group?: PoolGroupsItemBalanceanalyticsGroup;
};

export const bigIntsPoolGroupsItem: Array<string> = [
  ...bigIntsPoolGroupsItemPoolGroup.map((item) =>
    item === '' ? 'pool_group' : `pool_group.${item}`,
  ),
  ...bigIntsPoolGroupsItemAdastatGroup.map((item) =>
    item === '' ? 'adastat_group' : `adastat_group.${item}`,
  ),
  ...bigIntsPoolGroupsItemBalanceanalyticsGroup.map((item) =>
    item === '' ? 'balanceanalytics_group' : `balanceanalytics_group.${item}`,
  ),
];
