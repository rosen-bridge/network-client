 ...
 * Asset Name (hex)
 */
export type TxInfoItemInputsItemAssetListAnyOfItemAssetName = string | null;
export const bigIntsTxInfoItemInputsItemAssetListAnyOfItemAssetName: Array<string> =
  [];
