 ...
 */
export type TxInfoItemProposalProceduresAnyOfItemDeposit = string | null | null;
export const bigIntsTxInfoItemProposalProceduresAnyOfItemDeposit: Array<string> =
  [];
