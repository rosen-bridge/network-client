 ...
 */
import type { _EpochNoParameter } from './_epochNoParameter';
import { bigInts_EpochNoParameter } from './_epochNoParameter';
import type { _IncludeNextEpochParameter } from './_includeNextEpochParameter';

import { bigInts_IncludeNextEpochParameter } from './_includeNextEpochParameter';
...
export type EpochInfoParams = {
  ...
  /**
   * Include information about nearing but not yet started epoch, to get access to active stake snapshot information if available
   */
  _include_next_epoch?: _IncludeNextEpochParameter;
};

export const bigIntsEpochInfoParams = [
