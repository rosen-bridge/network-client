 ...
 */
import type { TxCborItem } from './txCborItem';
import { bigIntsTxCborItem } from './txCborItem';

/**
 * Raw Transaction(s) in CBOR format
 */
export type TxCbor = TxCborItem[];
export const bigIntsTxCbor: Array<string> = [...bigIntsTxCborItem];
