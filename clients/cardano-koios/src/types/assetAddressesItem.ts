 ...
 */
import type { AssetAddressesItemStakeAddress } from './assetAddressesItemStakeAddress';

import { bigIntsAssetAddressesItemStakeAddress } from './assetAddressesItemStakeAddress';

export type AssetAddressesItem = {
  /** A Cardano payment/base address (bech32 encoded) */
  payment_address?: string;
  stake_address?: AssetAddressesItemStakeAddress;
  /** Asset balance on the payment address */
  quantity?: string;
};

export const bigIntsAssetAddressesItem: Array<string> = [
  ...bigIntsAssetAddressesItemStakeAddress.map((item) =>
