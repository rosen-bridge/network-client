 ...
 */
import type { DrepInfoItem } from './drepInfoItem';
import { bigIntsDrepInfoItem } from './drepInfoItem';

/**
 * Get detailed information about requested delegated representatives (DReps)
 */
export type DrepInfo = DrepInfoItem[];
export const bigIntsDrepInfo: Array<string> = [...bigIntsDrepInfoItem];
