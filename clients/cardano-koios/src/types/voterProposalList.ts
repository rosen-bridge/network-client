 ...
 */
import type { VoterProposalListItem } from './voterProposalListItem';
import { bigIntsVoterProposalListItem } from './voterProposalListItem';

/**
 * List of all governance action proposals where specified credential(DRep, SPO or Committee member) has cast a vote
 */
export type VoterProposalList = VoterProposalListItem[];
export const bigIntsVoterProposalList: Array<string> = [
  ...bigIntsVoterProposalListItem,
];
