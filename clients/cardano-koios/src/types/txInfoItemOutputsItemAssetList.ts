 ...
 */
import type { TxInfoItemOutputsItemAssetListAnyOfItem } from './txInfoItemOutputsItemAssetListAnyOfItem';

import { bigIntsTxInfoItemOutputsItemAssetListAnyOfItem } from './txInfoItemOutputsItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type TxInfoItemOutputsItemAssetList =
  | TxInfoItemOutputsItemAssetListAnyOfItem[]
  | null
  | null;
export const bigIntsTxInfoItemOutputsItemAssetList: Array<string> = [
  ...bigIntsTxInfoItemOutputsItemAssetListAnyOfItem,
];
