 ...
 */
import type { ScriptListItem } from './scriptListItem';
import { bigIntsScriptListItem } from './scriptListItem';

/**
 * List of script and creation tx hash pairs
 */
export type ScriptList = ScriptListItem[];
export const bigIntsScriptList: Array<string> = [...bigIntsScriptListItem];
