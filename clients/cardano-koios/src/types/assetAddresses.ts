 ...
 */
import type { AssetAddressesItem } from './assetAddressesItem';

import { bigIntsAssetAddressesItem } from './assetAddressesItem';

/**
 * An array of payment addresses holding the given token (including balances)
 */
export type AssetAddresses = AssetAddressesItem[];
export const bigIntsAssetAddresses: Array<string> = [
  ...bigIntsAssetAddressesItem,
];
