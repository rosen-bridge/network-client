 ...
 */
import type { BlockTxInfoItemAssetsMintedAnyOfItemAssetName } from './blockTxInfoItemAssetsMintedAnyOfItemAssetName';
import { bigIntsBlockTxInfoItemAssetsMintedAnyOfItemAssetName } from './blockTxInfoItemAssetsMintedAnyOfItemAssetName';

export type BlockTxInfoItemAssetsMintedAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemAssetsMintedAnyOfItemAssetName;
...
export const bigIntsBlockTxInfoItemAssetsMintedAnyOfItem: Array<string> = [
  ...bigIntsBlockTxInfoItemAssetsMintedAnyOfItemAssetName.map((item) =>
