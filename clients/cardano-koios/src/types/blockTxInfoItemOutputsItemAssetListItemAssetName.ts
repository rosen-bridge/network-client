 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemOutputsItemAssetListItemAssetName = string | null;
export const bigIntsBlockTxInfoItemOutputsItemAssetListItemAssetName: Array<string> =
  [];
