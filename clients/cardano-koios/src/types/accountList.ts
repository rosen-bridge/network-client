...
import { bigIntsAccountListItem } from './accountListItem';

/**
 * Array of account (stake address) IDs
 */
export type AccountList = AccountListItem[];
export const bigIntsAccountList: Array<string> = [...bigIntsAccountListItem];
