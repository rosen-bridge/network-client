 ...
 */
import type { ProposalListItemParamProposalAnyOf } from './proposalListItemParamProposalAnyOf';

import { bigIntsProposalListItemParamProposalAnyOf } from './proposalListItemParamProposalAnyOf';

/**
 * If not null, the proposed new parameter set
 */
export type ProposalListItemParamProposal =
  ProposalListItemParamProposalAnyOf | null | null;
export const bigIntsProposalListItemParamProposal: Array<string> = [
  ...bigIntsProposalListItemParamProposalAnyOf,
];
