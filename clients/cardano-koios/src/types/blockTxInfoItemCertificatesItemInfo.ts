 ...
 */
import type { BlockTxInfoItemCertificatesItemInfoAnyOf } from './blockTxInfoItemCertificatesItemInfoAnyOf';
import { bigIntsBlockTxInfoItemCertificatesItemInfoAnyOf } from './blockTxInfoItemCertificatesItemInfoAnyOf';

/**
 * A JSON array containing information from the certificate
 */
export type BlockTxInfoItemCertificatesItemInfo =
  BlockTxInfoItemCertificatesItemInfoAnyOf | null;
export const bigIntsBlockTxInfoItemCertificatesItemInfo: Array<string> = [
  ...bigIntsBlockTxInfoItemCertificatesItemInfoAnyOf,
];
