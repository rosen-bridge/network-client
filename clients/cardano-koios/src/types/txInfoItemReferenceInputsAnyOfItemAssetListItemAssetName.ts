 ...
 * Asset Name (hex)
 */
export type TxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName =
  | string
  | null;
export const bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName: Array<string> =
  [];
