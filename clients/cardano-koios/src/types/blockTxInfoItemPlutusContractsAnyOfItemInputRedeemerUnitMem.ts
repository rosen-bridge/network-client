 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem =
  | string
  | number
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitMem: Array<string> =
  [];
