 ...
 */
export type TxInfoItemPlutusContractsItemInputRedeemerPurpose =
  (typeof TxInfoItemPlutusContractsItemInputRedeemerPurpose)[keyof typeof TxInfoItemPlutusContractsItemInputRedeemerPurpose];

// eslint-disable-next-line no-redeclare
export const TxInfoItemPlutusContractsItemInputRedeemerPurpose = {
  spend: 'spend',
  mint: 'mint',
  cert: 'cert',
  reward: 'reward',
} as const;
export const bigIntsTxInfoItemPlutusContractsItemInputRedeemerPurpose: Array<string> =
  [];
