 ...
 */
import type { AddressInfoItemUtxoSetItemInlineDatumAnyOfValue } from './addressInfoItemUtxoSetItemInlineDatumAnyOfValue';

import { bigIntsAddressInfoItemUtxoSetItemInlineDatumAnyOfValue } from './addressInfoItemUtxoSetItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type AddressInfoItemUtxoSetItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: AddressInfoItemUtxoSetItemInlineDatumAnyOfValue;
};

export const bigIntsAddressInfoItemUtxoSetItemInlineDatumAnyOf = [
