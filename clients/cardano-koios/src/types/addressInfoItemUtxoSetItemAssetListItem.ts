 ...
 */
import type { AddressInfoItemUtxoSetItemAssetListItemAssetName } from './addressInfoItemUtxoSetItemAssetListItemAssetName';
import { bigIntsAddressInfoItemUtxoSetItemAssetListItemAssetName } from './addressInfoItemUtxoSetItemAssetListItemAssetName';

export type AddressInfoItemUtxoSetItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AddressInfoItemUtxoSetItemAssetListItemAssetName;
...
export const bigIntsAddressInfoItemUtxoSetItemAssetListItem: Array<string> = [
  ...bigIntsAddressInfoItemUtxoSetItemAssetListItemAssetName.map((item) =>
