 ...
 */
import type { TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem } from './txInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem } from './txInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem';

/**
 * An array of assets on the UTxO
 */
export type TxInfoItemReferenceInputsAnyOfItemAssetList =
  | TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem[]
  | null;
export const bigIntsTxInfoItemReferenceInputsAnyOfItemAssetList: Array<string> =
  [...bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem];
