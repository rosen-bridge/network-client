 ...
 */
import type { EraSummariesItemProtocolMajor } from './eraSummariesItemProtocolMajor';
import { bigIntsEraSummariesItemProtocolMajor } from './eraSummariesItemProtocolMajor';
import type { EraSummariesItemProtocolMinor } from './eraSummariesItemProtocolMinor';
import { bigIntsEraSummariesItemProtocolMinor } from './eraSummariesItemProtocolMinor';

export type EraSummariesItem = {
  /** Cardano Era */
  era?: string;
  /** The protocol major version */
  protocol_major?: EraSummariesItemProtocolMajor;
  /** The protocol minor version */
  protocol_minor?: EraSummariesItemProtocolMinor;
...
export const bigIntsEraSummariesItem: Array<string> = [
  ...bigIntsEraSummariesItemProtocolMajor.map((item) =>
    item === '' ? 'protocol_major' : `protocol_major.${item}`,
  ),
  ...bigIntsEraSummariesItemProtocolMinor.map((item) =>
