 ...
 */
import type { TxInfoItemProposalProceduresItemDeposit } from './txInfoItemProposalProceduresItemDeposit';
import { bigIntsTxInfoItemProposalProceduresItemDeposit } from './txInfoItemProposalProceduresItemDeposit';
import type { TxInfoItemProposalProceduresItemDescription } from './txInfoItemProposalProceduresItemDescription';
import { bigIntsTxInfoItemProposalProceduresItemDescription } from './txInfoItemProposalProceduresItemDescription';
import type { TxInfoItemProposalProceduresItemExpiration } from './txInfoItemProposalProceduresItemExpiration';
import { bigIntsTxInfoItemProposalProceduresItemExpiration } from './txInfoItemProposalProceduresItemExpiration';
import type { TxInfoItemProposalProceduresItemMetaHash } from './txInfoItemProposalProceduresItemMetaHash';
import { bigIntsTxInfoItemProposalProceduresItemMetaHash } from './txInfoItemProposalProceduresItemMetaHash';
import type { TxInfoItemProposalProceduresItemMetaUrl } from './txInfoItemProposalProceduresItemMetaUrl';
import { bigIntsTxInfoItemProposalProceduresItemMetaUrl } from './txInfoItemProposalProceduresItemMetaUrl';
import type { TxInfoItemProposalProceduresItemParamProposal } from './txInfoItemProposalProceduresItemParamProposal';
import { bigIntsTxInfoItemProposalProceduresItemParamProposal } from './txInfoItemProposalProceduresItemParamProposal';
import type { TxInfoItemProposalProceduresItemType } from './txInfoItemProposalProceduresItemType';
import { bigIntsTxInfoItemProposalProceduresItemType } from './txInfoItemProposalProceduresItemType';
import type { TxInfoItemProposalProceduresItemWithdrawalItem } from './txInfoItemProposalProceduresItemWithdrawalItem';
import { bigIntsTxInfoItemProposalProceduresItemWithdrawalItem } from './txInfoItemProposalProceduresItemWithdrawalItem';

export type TxInfoItemProposalProceduresItem = {
  /** Index of governance proposal in transaction */
  index?: number;
  /** Proposal Action Type */
  type?: TxInfoItemProposalProceduresItemType;
  /** Description for Proposal Action */
  description?: TxInfoItemProposalProceduresItemDescription;
  /** DRep's registration deposit  in number */
  deposit?: TxInfoItemProposalProceduresItemDeposit;
  ...
  expiration?: TxInfoItemProposalProceduresItemExpiration;
  /** A URL to a JSON payload of metadata */
  meta_url?: TxInfoItemProposalProceduresItemMetaUrl;
  /** A hash of the contents of the metadata URL */
  meta_hash?: TxInfoItemProposalProceduresItemMetaHash;
  /** The array of amounts withdrawn from treasury into specified stake addresses by this proposal */
  withdrawal?: TxInfoItemProposalProceduresItemWithdrawalItem[];
  /** If not null, the proposed new parameter set */
  param_proposal?: TxInfoItemProposalProceduresItemParamProposal;
};

export const bigIntsTxInfoItemProposalProceduresItem: Array<string> = [
  ...bigIntsTxInfoItemProposalProceduresItemType.map((item) =>
    item === '' ? 'type' : `type.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemDescription.map((item) =>
    item === '' ? 'description' : `description.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemDeposit.map((item) =>
    item === '' ? 'deposit' : `deposit.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemExpiration.map((item) =>
    item === '' ? 'expiration' : `expiration.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemMetaUrl.map((item) =>
    item === '' ? 'meta_url' : `meta_url.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemMetaHash.map((item) =>
    item === '' ? 'meta_hash' : `meta_hash.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemWithdrawalItem.map((item) =>
    item === '' ? 'withdrawal' : `withdrawal.${item}`,
  ),
  ...bigIntsTxInfoItemProposalProceduresItemParamProposal.map((item) =>
