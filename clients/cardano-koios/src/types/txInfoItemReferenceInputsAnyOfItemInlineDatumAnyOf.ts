 ...
 */
import type { TxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue } from './txInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue';

import { bigIntsTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue } from './txInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOfValue;
};

export const bigIntsTxInfoItemReferenceInputsAnyOfItemInlineDatumAnyOf = [
