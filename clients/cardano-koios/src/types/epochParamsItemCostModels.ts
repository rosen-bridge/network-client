 ...
 */
import type { EpochParamsItemCostModelsAnyOf } from './epochParamsItemCostModelsAnyOf';

import { bigIntsEpochParamsItemCostModelsAnyOf } from './epochParamsItemCostModelsAnyOf';

/**
 * The per language cost model in JSON
 */
export type EpochParamsItemCostModels =
  EpochParamsItemCostModelsAnyOf | null | null;
export const bigIntsEpochParamsItemCostModels: Array<string> = [
  ...bigIntsEpochParamsItemCostModelsAnyOf,
];
