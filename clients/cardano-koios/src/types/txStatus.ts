 ...
 */
import type { TxStatusItem } from './txStatusItem';
import { bigIntsTxStatusItem } from './txStatusItem';

/**
 * Array of transaction confirmation counts
 */
export type TxStatus = TxStatusItem[];
export const bigIntsTxStatus: Array<string> = [...bigIntsTxStatusItem];
