 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash =
  | string
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputDatumHash: Array<string> =
  [];
