 ...
 * Asset Name (hex)
 */
export type AddressInfoItemUtxoSetItemAssetListItemAssetName = string | null;
export const bigIntsAddressInfoItemUtxoSetItemAssetListItemAssetName: Array<string> =
  [];
