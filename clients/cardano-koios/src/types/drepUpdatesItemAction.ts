 ...
 */
export type DrepUpdatesItemAction =
  (typeof DrepUpdatesItemAction)[keyof typeof DrepUpdatesItemAction];

// eslint-disable-next-line no-redeclare
export const DrepUpdatesItemAction = {
  updated: 'updated',
  registered: 'registered',
  deregistered: 'deregistered',
} as const;
export const bigIntsDrepUpdatesItemAction: Array<string> = [];
