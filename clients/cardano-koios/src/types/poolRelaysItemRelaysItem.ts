 ...
 */
import type { PoolRelaysItemRelaysItemDns } from './poolRelaysItemRelaysItemDns';
import { bigIntsPoolRelaysItemRelaysItemDns } from './poolRelaysItemRelaysItemDns';
import type { PoolRelaysItemRelaysItemSrv } from './poolRelaysItemRelaysItemSrv';
import { bigIntsPoolRelaysItemRelaysItemSrv } from './poolRelaysItemRelaysItemSrv';
import type { PoolRelaysItemRelaysItemIpv4 } from './poolRelaysItemRelaysItemIpv4';
import { bigIntsPoolRelaysItemRelaysItemIpv4 } from './poolRelaysItemRelaysItemIpv4';
import type { PoolRelaysItemRelaysItemIpv6 } from './poolRelaysItemRelaysItemIpv6';
import { bigIntsPoolRelaysItemRelaysItemIpv6 } from './poolRelaysItemRelaysItemIpv6';
import type { PoolRelaysItemRelaysItemPort } from './poolRelaysItemRelaysItemPort';

import { bigIntsPoolRelaysItemRelaysItemPort } from './poolRelaysItemRelaysItemPort';

export type PoolRelaysItemRelaysItem = {
  /** DNS name of the relay (nullable) */
  dns?: PoolRelaysItemRelaysItemDns;
  /** DNS service name of the relay (nullable) */
  srv?: PoolRelaysItemRelaysItemSrv;
  /** IPv4 address of the relay (nullable) */
  ipv4?: PoolRelaysItemRelaysItemIpv4;
  /** IPv6 address of the relay (nullable) */
  ipv6?: PoolRelaysItemRelaysItemIpv6;
  /** Port number of the relay (nullable) */
  port?: PoolRelaysItemRelaysItemPort;
};

export const bigIntsPoolRelaysItemRelaysItem: Array<string> = [
  ...bigIntsPoolRelaysItemRelaysItemDns.map((item) =>
    item === '' ? 'dns' : `dns.${item}`,
  ),
  ...bigIntsPoolRelaysItemRelaysItemSrv.map((item) =>
    item === '' ? 'srv' : `srv.${item}`,
  ),
  ...bigIntsPoolRelaysItemRelaysItemIpv4.map((item) =>
    item === '' ? 'ipv4' : `ipv4.${item}`,
  ),
  ...bigIntsPoolRelaysItemRelaysItemIpv6.map((item) =>
    item === '' ? 'ipv6' : `ipv6.${item}`,
  ),
  ...bigIntsPoolRelaysItemRelaysItemPort.map((item) =>
    item === '' ? 'port' : `port.${item}`,
  ),
];
