 ...
 */
import type { DatumInfoItem } from './datumInfoItem';
import { bigIntsDatumInfoItem } from './datumInfoItem';

/**
 * Array of datum information for given datum hashes
 */
export type DatumInfo = DatumInfoItem[];
export const bigIntsDatumInfo: Array<string> = [...bigIntsDatumInfoItem];
