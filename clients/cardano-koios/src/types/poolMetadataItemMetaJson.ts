 ...
 */
import type { PoolMetadataItemMetaJsonAnyOf } from './poolMetadataItemMetaJsonAnyOf';

import { bigIntsPoolMetadataItemMetaJsonAnyOf } from './poolMetadataItemMetaJsonAnyOf';

export type PoolMetadataItemMetaJson =
  PoolMetadataItemMetaJsonAnyOf | null | null;
export const bigIntsPoolMetadataItemMetaJson: Array<string> = [
  ...bigIntsPoolMetadataItemMetaJsonAnyOf,
];
