 ...
 */
import type { PolicyAssetInfoItemMintingTxMetadataAllOfAnyOf } from './policyAssetInfoItemMintingTxMetadataAllOfAnyOf';

import { bigIntsPolicyAssetInfoItemMintingTxMetadataAllOfAnyOf } from './policyAssetInfoItemMintingTxMetadataAllOfAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type PolicyAssetInfoItemMintingTxMetadataAllOf =
  PolicyAssetInfoItemMintingTxMetadataAllOfAnyOf | null | null;
export const bigIntsPolicyAssetInfoItemMintingTxMetadataAllOf: Array<string> = [
  ...bigIntsPolicyAssetInfoItemMintingTxMetadataAllOfAnyOf,
];
