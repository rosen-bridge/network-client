...
export type PolicyAssetInfoItemTokenRegistryMetadataAnyOfDescription =
  | null
  | string
  | null;
export const bigIntsPolicyAssetInfoItemTokenRegistryMetadataAnyOfDescription: Array<string> =
  [];
