 ...
 */
import type { PolicyAssetAddressesItemAssetName } from './policyAssetAddressesItemAssetName';
import { bigIntsPolicyAssetAddressesItemAssetName } from './policyAssetAddressesItemAssetName';
import type { PolicyAssetAddressesItemStakeAddress } from './policyAssetAddressesItemStakeAddress';

import { bigIntsPolicyAssetAddressesItemStakeAddress } from './policyAssetAddressesItemStakeAddress';

export type PolicyAssetAddressesItem = {
  /** Asset Name (hex) */
  asset_name?: PolicyAssetAddressesItemAssetName;
  /** A Cardano payment/base address (bech32 encoded) */
  payment_address?: string;
  /** Asset balance on the payment address */
  quantity?: string;
  stake_address?: PolicyAssetAddressesItemStakeAddress;
};

export const bigIntsPolicyAssetAddressesItem = [
