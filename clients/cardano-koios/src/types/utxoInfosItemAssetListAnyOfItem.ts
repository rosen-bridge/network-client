 ...
 */
import type { UtxoInfosItemAssetListAnyOfItemAssetName } from './utxoInfosItemAssetListAnyOfItemAssetName';

import { bigIntsUtxoInfosItemAssetListAnyOfItemAssetName } from './utxoInfosItemAssetListAnyOfItemAssetName';

export type UtxoInfosItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: UtxoInfosItemAssetListAnyOfItemAssetName;
...
export const bigIntsUtxoInfosItemAssetListAnyOfItem: Array<string> = [
  ...bigIntsUtxoInfosItemAssetListAnyOfItemAssetName.map((item) =>
