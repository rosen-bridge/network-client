 ...
 */
import type { PolicyAssetListItemAssetName } from './policyAssetListItemAssetName';

import { bigIntsPolicyAssetListItemAssetName } from './policyAssetListItemAssetName';

export type PolicyAssetListItem = {
  /** Asset Name (hex) */
  asset_name?: PolicyAssetListItemAssetName;
  decimals?: number;
...
export const bigIntsPolicyAssetListItem = [
