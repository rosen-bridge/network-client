 ...
 */
import type { PoolVotingPowerHistoryItem } from './poolVotingPowerHistoryItem';
import { bigIntsPoolVotingPowerHistoryItem } from './poolVotingPowerHistoryItem';

/**
 * History of Pool's voting power against each (or requested) epoch
 */
export type PoolVotingPowerHistory = PoolVotingPowerHistoryItem[];
export const bigIntsPoolVotingPowerHistory: Array<string> = [
  ...bigIntsPoolVotingPowerHistoryItem,
];
