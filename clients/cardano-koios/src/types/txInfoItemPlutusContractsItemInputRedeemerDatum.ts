 ...
 */
import type { TxInfoItemPlutusContractsItemInputRedeemerDatumHash } from './txInfoItemPlutusContractsItemInputRedeemerDatumHash';
import { bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatumHash } from './txInfoItemPlutusContractsItemInputRedeemerDatumHash';
import type { TxInfoItemPlutusContractsItemInputRedeemerDatumValue } from './txInfoItemPlutusContractsItemInputRedeemerDatumValue';
import { bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatumValue } from './txInfoItemPlutusContractsItemInputRedeemerDatumValue';

export type TxInfoItemPlutusContractsItemInputRedeemerDatum = {
  /** The Hash of the Plutus Data */
  hash?: TxInfoItemPlutusContractsItemInputRedeemerDatumHash;
  /** Data in JSON format */
  value?: TxInfoItemPlutusContractsItemInputRedeemerDatumValue;
};

export const bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatum: Array<string> =
  [
    ...bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatumHash.map((item) =>
      item === '' ? 'hash' : `hash.${item}`,
    ),
