 ...
 */
export type TxInfoItemProposalProceduresAnyOfItemExpiration = number | null;
export const bigIntsTxInfoItemProposalProceduresAnyOfItemExpiration: Array<string> =
  [];
