 ...
 */
import type { ParamUpdatesItem } from './paramUpdatesItem';
import { bigIntsParamUpdatesItem } from './paramUpdatesItem';

/**
 * Array of unique param update proposals submitted on chain
 */
export type ParamUpdates = ParamUpdatesItem[];
export const bigIntsParamUpdates: Array<string> = [...bigIntsParamUpdatesItem];
