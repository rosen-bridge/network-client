 ...
 */
import type { BlockTxInfoItemOutputsItemReferenceScriptAnyOfValue } from './blockTxInfoItemOutputsItemReferenceScriptAnyOfValue';
import { bigIntsBlockTxInfoItemOutputsItemReferenceScriptAnyOfValue } from './blockTxInfoItemOutputsItemReferenceScriptAnyOfValue';
 ...
 */
export type BlockTxInfoItemOutputsItemReferenceScriptAnyOf = {
  ...
  bytes?: string;
  /** Value (json) */
  value?: BlockTxInfoItemOutputsItemReferenceScriptAnyOfValue;
};

export const bigIntsBlockTxInfoItemOutputsItemReferenceScriptAnyOf: Array<string> =
  [
    ...bigIntsBlockTxInfoItemOutputsItemReferenceScriptAnyOfValue.map((item) =>
