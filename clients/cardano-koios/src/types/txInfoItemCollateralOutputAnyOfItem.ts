 ...
 */
import type { TxInfoItemCollateralOutputAnyOfItemPaymentAddr } from './txInfoItemCollateralOutputAnyOfItemPaymentAddr';
import { bigIntsTxInfoItemCollateralOutputAnyOfItemPaymentAddr } from './txInfoItemCollateralOutputAnyOfItemPaymentAddr';
import type { TxInfoItemCollateralOutputAnyOfItemStakeAddr } from './txInfoItemCollateralOutputAnyOfItemStakeAddr';
import { bigIntsTxInfoItemCollateralOutputAnyOfItemStakeAddr } from './txInfoItemCollateralOutputAnyOfItemStakeAddr';
import type { TxInfoItemCollateralOutputAnyOfItemDatumHash } from './txInfoItemCollateralOutputAnyOfItemDatumHash';
import { bigIntsTxInfoItemCollateralOutputAnyOfItemDatumHash } from './txInfoItemCollateralOutputAnyOfItemDatumHash';
import type { TxInfoItemCollateralOutputAnyOfItemInlineDatum } from './txInfoItemCollateralOutputAnyOfItemInlineDatum';
import { bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatum } from './txInfoItemCollateralOutputAnyOfItemInlineDatum';
import type { TxInfoItemCollateralOutputAnyOfItemReferenceScript } from './txInfoItemCollateralOutputAnyOfItemReferenceScript';

import { bigIntsTxInfoItemCollateralOutputAnyOfItemReferenceScript } from './txInfoItemCollateralOutputAnyOfItemReferenceScript';

export type TxInfoItemCollateralOutputAnyOfItem = {
  payment_addr?: TxInfoItemCollateralOutputAnyOfItemPaymentAddr;
  stake_addr?: TxInfoItemCollateralOutputAnyOfItemStakeAddr;
  ...
  datum_hash?: TxInfoItemCollateralOutputAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: TxInfoItemCollateralOutputAnyOfItemInlineDatum;
  ...
  reference_script?: TxInfoItemCollateralOutputAnyOfItemReferenceScript;
  /** Brief asset description from ledger */
  asset_list?: unknown[];
};

export const bigIntsTxInfoItemCollateralOutputAnyOfItem: Array<string> = [
  ...bigIntsTxInfoItemCollateralOutputAnyOfItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputAnyOfItemStakeAddr.map((item) =>
    item === '' ? 'stake_addr' : `stake_addr.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputAnyOfItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputAnyOfItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`
  ),
  ...bigIntsTxInfoItemCollateralOutputAnyOfItemReferenceScript.map((item) =>
