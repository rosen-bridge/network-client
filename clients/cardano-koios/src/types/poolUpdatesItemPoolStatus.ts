 ...
 * Pool status
 */
export type PoolUpdatesItemPoolStatus =
  (typeof PoolUpdatesItemPoolStatus)[keyof typeof PoolUpdatesItemPoolStatus];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PoolUpdatesItemPoolStatus = {
  registered: 'registered',
  retiring: 'retiring',
  retired: 'retired',
} as const;
export const bigIntsPoolUpdatesItemPoolStatus = [];
