...
import type { AccountInfoItemDelegatedPool } from './accountInfoItemDelegatedPool';
import { bigIntsAccountInfoItemDelegatedPool } from './accountInfoItemDelegatedPool';
import type { AccountInfoItemStatus } from './accountInfoItemStatus';
import { bigIntsAccountInfoItemStatus } from './accountInfoItemStatus';

export type AccountInfoItem = {
  /** Cardano staking address (reward account) in bech32 format */
  stake_address?: string;
  /** Stake address status */
  status?: AccountInfoItemStatus;
  /** Account's current delegation status to DRep ID in CIP-129 Bech32 format */
  delegated_drep?: AccountInfoItemDelegatedDrep;
  delegated_pool?: AccountInfoItemDelegatedPool;
