 ...
 */
import type { TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName } from './txInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName } from './txInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName';

export type TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName;
...
export const bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem: Array<string> =
  [
    ...bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName.map(
