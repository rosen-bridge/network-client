 ...
 */
import type { EpochInfoItem } from './epochInfoItem';
import { bigIntsEpochInfoItem } from './epochInfoItem';

/**
 * Array of detailed summary for each epoch
 */
export type EpochInfo = EpochInfoItem[];
export const bigIntsEpochInfo: Array<string> = [...bigIntsEpochInfoItem];
