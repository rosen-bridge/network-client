 ...
 */
import type { AccountHistoryItem } from './accountHistoryItem';

import { bigIntsAccountHistoryItem } from './accountHistoryItem';

/**
 * Array of active stake values per epoch
 */
export type AccountHistory = AccountHistoryItem[];
export const bigIntsAccountHistory: Array<string> = [
  ...bigIntsAccountHistoryItem,
];
