...
import { bigIntsBlockTxInfoItemInvalidAfter } from './blockTxInfoItemInvalidAfter';
import type { BlockTxInfoItemInvalidBefore } from './blockTxInfoItemInvalidBefore';
...
export type BlockTxInfoItem = {
   ...
   * @nullable
   */
  assets_minted?: BlockTxInfoItemAssetsMintedItem[] | null;
  /** Hash of the block */
  block_hash?: string;
  /** Block height */
   ...
   * @nullable
   */
  certificates?: BlockTxInfoItemCertificatesItem[] | null;
   ...
   * @nullable
   */
  collateral_output?: BlockTxInfoItemCollateralOutputItem[] | null;
   ...
   * @nullable
   */
  native_scripts?: BlockTxInfoItemNativeScriptsItem[] | null;
   ...
   * @nullable
   */
  plutus_contracts?: BlockTxInfoItemPlutusContractsItem[] | null;
   ...
   * @nullable
   */
  withdrawals?: BlockTxInfoItemWithdrawalsItem[] | null;
};

export const bigIntsBlockTxInfoItem = [
