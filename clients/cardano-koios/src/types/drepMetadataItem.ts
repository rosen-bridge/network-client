...
import type { DrepMetadataItemHash } from './drepMetadataItemHash';
import { bigIntsDrepMetadataItemHash } from './drepMetadataItemHash';
import type { DrepMetadataItemJson } from './drepMetadataItemJson';
import { bigIntsDrepMetadataItemJson } from './drepMetadataItemJson';
...
import type { DrepMetadataItemUrl } from './drepMetadataItemUrl';
import { bigIntsDrepMetadataItemUrl } from './drepMetadataItemUrl';
...
export const bigIntsDrepMetadataItem = [
  ...
  ...bigIntsDrepMetadataItemHash.map((item) =>
    item === '' ? 'hash' : `hash.${item}`
  ),
  ...bigIntsDrepMetadataItemJson.map((item) =>
    item === '' ? 'json' : `json.${item}`
  ),
  ...bigIntsDrepMetadataItemLanguage.map((item) =>
    item === '' ? 'language' : `language.${item}`
  ),
  ...bigIntsDrepMetadataItemUrl.map((item) =>
    item === '' ? 'url' : `url.${item}`
  ),
