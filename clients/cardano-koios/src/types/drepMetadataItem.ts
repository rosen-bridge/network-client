 ...
 */
import type { DrepMetadataItemBytes } from './drepMetadataItemBytes';
import { bigIntsDrepMetadataItemBytes } from './drepMetadataItemBytes';
import type { DrepMetadataItemComment } from './drepMetadataItemComment';
import { bigIntsDrepMetadataItemComment } from './drepMetadataItemComment';
import type { DrepMetadataItemIsValid } from './drepMetadataItemIsValid';
import { bigIntsDrepMetadataItemIsValid } from './drepMetadataItemIsValid';
import type { DrepMetadataItemLanguage } from './drepMetadataItemLanguage';
import { bigIntsDrepMetadataItemLanguage } from './drepMetadataItemLanguage';
import type { DrepMetadataItemMetaHash } from './drepMetadataItemMetaHash';
import { bigIntsDrepMetadataItemMetaHash } from './drepMetadataItemMetaHash';
import type { DrepMetadataItemMetaJson } from './drepMetadataItemMetaJson';
import { bigIntsDrepMetadataItemMetaJson } from './drepMetadataItemMetaJson';
import type { DrepMetadataItemMetaUrl } from './drepMetadataItemMetaUrl';
import { bigIntsDrepMetadataItemMetaUrl } from './drepMetadataItemMetaUrl';
import type { DrepMetadataItemWarning } from './drepMetadataItemWarning';
import { bigIntsDrepMetadataItemWarning } from './drepMetadataItemWarning';

export type DrepMetadataItem = {
  ...
  meta_url?: DrepMetadataItemMetaUrl;
  /** A hash of the contents of the metadata URL */
  meta_hash?: DrepMetadataItemMetaHash;
  /** The payload as JSON */
  meta_json?: DrepMetadataItemMetaJson;
  /** The raw bytes of the payload */
  bytes?: DrepMetadataItemBytes;
  /** A warning that occured while validating the metadata */
  warning?: DrepMetadataItemWarning;
  /** The language described in the context of the metadata as per CIP-100 */
  language?: DrepMetadataItemLanguage;
  /** Comment attached to the metadata */
  comment?: DrepMetadataItemComment;
  /** Indicate whether data is invalid (currently returns null for all as per dbsync) */
  is_valid?: DrepMetadataItemIsValid;
};
