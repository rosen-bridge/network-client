 ...
 */
import type { ScriptInfoItemBytes } from './scriptInfoItemBytes';
import { bigIntsScriptInfoItemBytes } from './scriptInfoItemBytes';
import type { ScriptInfoItemScriptHash } from './scriptInfoItemScriptHash';
import { bigIntsScriptInfoItemScriptHash } from './scriptInfoItemScriptHash';
import type { ScriptInfoItemType } from './scriptInfoItemType';
import { bigIntsScriptInfoItemType } from './scriptInfoItemType';
import type { ScriptInfoItemValue } from './scriptInfoItemValue';

import { bigIntsScriptInfoItemValue } from './scriptInfoItemValue';

/**
 * Array of information for scripts
 */
export type ScriptInfoItem = {
  /** Script bytes (cborSeq) */
  bytes?: ScriptInfoItemBytes;
  /** Hash of the script creation transaction */
  creation_tx_hash?: string;
  /** Hash of a script */
  script_hash?: ScriptInfoItemScriptHash;
  /** The size of the CBOR serialised script (in bytes) */
  size?: number;
  /** Type of the script */
  type?: ScriptInfoItemType;
  /** Data in JSON format */
  value?: ScriptInfoItemValue;
};

export const bigIntsScriptInfoItem = [
