 ...
 */
import type { TxCborItemBlockHeight } from './txCborItemBlockHeight';

import { bigIntsTxCborItemBlockHeight } from './txCborItemBlockHeight';

export type TxCborItem = {
  /** Hash identifier of the transaction */
  tx_hash?: string;
  /** Hash of the block */
  block_hash?: string;
  /** Block height */
  block_height?: TxCborItemBlockHeight;
...
export const bigIntsTxCborItem: Array<string> = [
  ...bigIntsTxCborItemBlockHeight.map((item) =>
