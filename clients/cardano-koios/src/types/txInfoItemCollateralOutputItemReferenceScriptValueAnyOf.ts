...
export type TxInfoItemCollateralOutputItemReferenceScriptValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemCollateralOutputItemReferenceScriptValueAnyOf: Array<string> =
  [];
