 ...
 */
import type { BlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName } from './blockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName';

export type BlockTxInfoItemCollateralInputsAnyOfItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName;
...
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListItem: Array<string> =
  [
    ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName.map(
