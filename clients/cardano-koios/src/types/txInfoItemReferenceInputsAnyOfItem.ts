 ...
 */
import type { TxInfoItemReferenceInputsAnyOfItemAssetListItem } from './txInfoItemReferenceInputsAnyOfItemAssetListItem';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItem } from './txInfoItemReferenceInputsAnyOfItemAssetListItem';
import type { TxInfoItemReferenceInputsAnyOfItemDatumHash } from './txInfoItemReferenceInputsAnyOfItemDatumHash';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemDatumHash } from './txInfoItemReferenceInputsAnyOfItemDatumHash';
import type { TxInfoItemReferenceInputsAnyOfItemInlineDatum } from './txInfoItemReferenceInputsAnyOfItemInlineDatum';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemInlineDatum } from './txInfoItemReferenceInputsAnyOfItemInlineDatum';
import type { TxInfoItemReferenceInputsAnyOfItemPaymentAddr } from './txInfoItemReferenceInputsAnyOfItemPaymentAddr';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemPaymentAddr } from './txInfoItemReferenceInputsAnyOfItemPaymentAddr';
import type { TxInfoItemReferenceInputsAnyOfItemReferenceScript } from './txInfoItemReferenceInputsAnyOfItemReferenceScript';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemReferenceScript } from './txInfoItemReferenceInputsAnyOfItemReferenceScript';
import type { TxInfoItemReferenceInputsAnyOfItemStakeAddr } from './txInfoItemReferenceInputsAnyOfItemStakeAddr';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemStakeAddr } from './txInfoItemReferenceInputsAnyOfItemStakeAddr';

export type TxInfoItemReferenceInputsAnyOfItem = {
  payment_addr?: TxInfoItemReferenceInputsAnyOfItemPaymentAddr;
  stake_addr?: TxInfoItemReferenceInputsAnyOfItemStakeAddr;
  ...
  datum_hash?: TxInfoItemReferenceInputsAnyOfItemDatumHash;
  /** Allows datums to be attached to UTxO (CIP-32) */
  inline_datum?: TxInfoItemReferenceInputsAnyOfItemInlineDatum;
  ...
  reference_script?: TxInfoItemReferenceInputsAnyOfItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxInfoItemReferenceInputsAnyOfItemAssetListItem[];
};

export const bigIntsTxInfoItemReferenceInputsAnyOfItem: Array<string> = [
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemPaymentAddr.map((item) =>
    item === '' ? 'payment_addr' : `payment_addr.${item}`,
  ),
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemStakeAddr.map((item) =>
    item === '' ? 'stake_addr' : `stake_addr.${item}`,
  ),
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemDatumHash.map((item) =>
    item === '' ? 'datum_hash' : `datum_hash.${item}`,
  ),
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemInlineDatum.map((item) =>
    item === '' ? 'inline_datum' : `inline_datum.${item}`,
  ),
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemReferenceScript.map((item) =>
    item === '' ? 'reference_script' : `reference_script.${item}`,
  ),
  ...bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItem.map((item) =>
