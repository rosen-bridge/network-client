 ...
 */
import type { TxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName } from './txInfoItemCollateralInputsAnyOfItemAssetListItemAssetName';
import { bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName } from './txInfoItemCollateralInputsAnyOfItemAssetListItemAssetName';

export type TxInfoItemCollateralInputsAnyOfItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName;
...
export const bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItem: Array<string> =
  [
    ...bigIntsTxInfoItemCollateralInputsAnyOfItemAssetListItemAssetName.map(
