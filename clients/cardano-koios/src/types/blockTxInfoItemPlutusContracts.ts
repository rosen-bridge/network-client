 ...
 */
import type { BlockTxInfoItemPlutusContractsAnyOfItem } from './blockTxInfoItemPlutusContractsAnyOfItem';
import { bigIntsBlockTxInfoItemPlutusContractsAnyOfItem } from './blockTxInfoItemPlutusContractsAnyOfItem';

/**
 * Plutus contracts present in transaction (if any)
 */
export type BlockTxInfoItemPlutusContracts =
  | BlockTxInfoItemPlutusContractsAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemPlutusContracts: Array<string> = [
  ...bigIntsBlockTxInfoItemPlutusContractsAnyOfItem,
];
