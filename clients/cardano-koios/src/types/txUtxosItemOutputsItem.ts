 ...
 */
import type { TxUtxosItemOutputsItemPaymentAddr } from './txUtxosItemOutputsItemPaymentAddr';
import { bigIntsTxUtxosItemOutputsItemPaymentAddr } from './txUtxosItemOutputsItemPaymentAddr';
import type { TxUtxosItemOutputsItemStakeAddr } from './txUtxosItemOutputsItemStakeAddr';
import { bigIntsTxUtxosItemOutputsItemStakeAddr } from './txUtxosItemOutputsItemStakeAddr';
import type { TxUtxosItemOutputsItemInlineDatum } from './txUtxosItemOutputsItemInlineDatum';
import { bigIntsTxUtxosItemOutputsItemInlineDatum } from './txUtxosItemOutputsItemInlineDatum';
import type { TxUtxosItemOutputsItemReferenceScript } from './txUtxosItemOutputsItemReferenceScript';
import { bigIntsTxUtxosItemOutputsItemReferenceScript } from './txUtxosItemOutputsItemReferenceScript';
import type { TxUtxosItemOutputsItemAssetListItem } from './txUtxosItemOutputsItemAssetListItem';

import { bigIntsTxUtxosItemOutputsItemAssetListItem } from './txUtxosItemOutputsItemAssetListItem';

export type TxUtxosItemOutputsItem = {
  payment_addr?: TxUtxosItemOutputsItemPaymentAddr;
  stake_addr?: TxUtxosItemOutputsItemStakeAddr;
  ...
  inline_datum?: TxUtxosItemOutputsItemInlineDatum;
  ...
  reference_script?: TxUtxosItemOutputsItemReferenceScript;
  /** An array of assets on the UTxO */
  asset_list?: TxUtxosItemOutputsItemAssetListItem[] | null;
};

export const bigIntsTxUtxosItemOutputsItem = [
  ...bigIntsTxUtxosItemOutputsItemPaymentAddr.map(
    (item) => `payment_addr.${item}`
  ),
  ...bigIntsTxUtxosItemOutputsItemStakeAddr.map((item) => `stake_addr.${item}`),
  ...bigIntsTxUtxosItemOutputsItemInlineDatum.map(
    (item) => `inline_datum.${item}`
  ),
  ...bigIntsTxUtxosItemOutputsItemReferenceScript.map(
