...
export type StakeAddressesWithFirstOnlyAndEmptyBody = {
  /** Array of Cardano stake address(es) in bech32 format */
  _stake_addresses: string[];
  /** Only return the first result */
  _first_only?: boolean;
  /** Include zero quantity entries */
  _empty?: boolean;
};
export const bigIntsStakeAddressesWithFirstOnlyAndEmptyBody: Array<string> = [];
