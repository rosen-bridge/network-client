 ...
 */
import type { TxInfoItemPlutusContractsItemInputRedeemerDatum } from './txInfoItemPlutusContractsItemInputRedeemerDatum';
import { bigIntsTxInfoItemPlutusContractsItemInputRedeemerDatum } from './txInfoItemPlutusContractsItemInputRedeemerDatum';
import type { TxInfoItemPlutusContractsItemInputRedeemerPurpose } from './txInfoItemPlutusContractsItemInputRedeemerPurpose';
import { bigIntsTxInfoItemPlutusContractsItemInputRedeemerPurpose } from './txInfoItemPlutusContractsItemInputRedeemerPurpose';
import type { TxInfoItemPlutusContractsItemInputRedeemerUnit } from './txInfoItemPlutusContractsItemInputRedeemerUnit';
import { bigIntsTxInfoItemPlutusContractsItemInputRedeemerUnit } from './txInfoItemPlutusContractsItemInputRedeemerUnit';

export type TxInfoItemPlutusContractsItemInputRedeemer = {
  /** What kind of validation this redeemer is used for */
  purpose?: TxInfoItemPlutusContractsItemInputRedeemerPurpose;
  /** The budget in fees to run a script - the fees depend on the ExUnits and the current prices */
  fee?: string;
  unit?: TxInfoItemPlutusContractsItemInputRedeemerUnit;
  datum?: TxInfoItemPlutusContractsItemInputRedeemerDatum;
};

export const bigIntsTxInfoItemPlutusContractsItemInputRedeemer: Array<string> =
  [
