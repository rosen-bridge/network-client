 ...
 */
import type { TxInfoItemPlutusContractsAnyOfItemInputRedeemer } from './txInfoItemPlutusContractsAnyOfItemInputRedeemer';
import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemer } from './txInfoItemPlutusContractsAnyOfItemInputRedeemer';
import type { TxInfoItemPlutusContractsAnyOfItemInputDatum } from './txInfoItemPlutusContractsAnyOfItemInputDatum';

import { bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatum } from './txInfoItemPlutusContractsAnyOfItemInputDatum';

export type TxInfoItemPlutusContractsAnyOfItemInput = {
  redeemer?: TxInfoItemPlutusContractsAnyOfItemInputRedeemer;
  datum?: TxInfoItemPlutusContractsAnyOfItemInputDatum;
};

export const bigIntsTxInfoItemPlutusContractsAnyOfItemInput: Array<string> = [
  ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemer.map((item) =>
    item === '' ? 'redeemer' : `redeemer.${item}`
  ),
  ...bigIntsTxInfoItemPlutusContractsAnyOfItemInputDatum.map((item) =>
