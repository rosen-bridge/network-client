 ...
 * Value (json)
 */
export type BlockTxInfoItemCollateralInputsAnyOfItemInlineDatumValue = {
  [key: string]: unknown;
};
export const bigIntsBlockTxInfoItemCollateralInputsAnyOfItemInlineDatumValue: Array<string> =
  [];
