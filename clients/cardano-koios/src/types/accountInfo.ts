 ...
 */
import type { AccountInfoItem } from './accountInfoItem';
import { bigIntsAccountInfoItem } from './accountInfoItem';

/**
 * Array of stake account information
 */
export type AccountInfo = AccountInfoItem[];
export const bigIntsAccountInfo: Array<string> = [...bigIntsAccountInfoItem];
