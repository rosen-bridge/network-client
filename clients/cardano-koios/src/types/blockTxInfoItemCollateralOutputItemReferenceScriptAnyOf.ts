 ...
 */
import type { BlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue } from './blockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue';

import { bigIntsBlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue } from './blockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue';
 ...
 */
export type BlockTxInfoItemCollateralOutputItemReferenceScriptAnyOf = {
  /** Script bytes (hex) */
  bytes?: string;
  ...
  type?: string;
  /** Value (json) */
  value?: BlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue;
};

export const bigIntsBlockTxInfoItemCollateralOutputItemReferenceScriptAnyOf = [
  ...bigIntsBlockTxInfoItemCollateralOutputItemReferenceScriptAnyOfValue.map(
