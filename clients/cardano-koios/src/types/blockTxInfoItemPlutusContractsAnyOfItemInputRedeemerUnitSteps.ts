 ...
 */
export type BlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps =
  | string
  | number
  | null
  | null;
export const bigIntsBlockTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps: Array<string> =
  [];
