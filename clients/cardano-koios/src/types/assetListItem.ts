 ...
 */
import type { AssetListItemAssetName } from './assetListItemAssetName';

import { bigIntsAssetListItemAssetName } from './assetListItemAssetName';

export type AssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: AssetListItemAssetName;
  /** Asset Name (ASCII) */
...
export const bigIntsAssetListItem: Array<string> = [
  ...bigIntsAssetListItemAssetName.map((item) =>
