 ...
 */
import type { TxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName } from './txInfoItemReferenceInputsAnyOfItemAssetListItemAssetName';
import { bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName } from './txInfoItemReferenceInputsAnyOfItemAssetListItemAssetName';

export type TxInfoItemReferenceInputsAnyOfItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: TxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName;
...
export const bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItem: Array<string> =
  [
    ...bigIntsTxInfoItemReferenceInputsAnyOfItemAssetListItemAssetName.map(
