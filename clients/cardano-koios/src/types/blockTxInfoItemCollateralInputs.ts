 ...
 */
import type { BlockTxInfoItemCollateralInputsAnyOfItem } from './blockTxInfoItemCollateralInputsAnyOfItem';
import { bigIntsBlockTxInfoItemCollateralInputsAnyOfItem } from './blockTxInfoItemCollateralInputsAnyOfItem';

/**
 * An array of collateral inputs needed for smart contracts in case of contract failure
 */
export type BlockTxInfoItemCollateralInputs =
  | BlockTxInfoItemCollateralInputsAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemCollateralInputs: Array<string> = [
  ...bigIntsBlockTxInfoItemCollateralInputsAnyOfItem,
];
