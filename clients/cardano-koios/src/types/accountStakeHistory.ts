 ...
 */
import type { AccountStakeHistoryItem } from './accountStakeHistoryItem';
import { bigIntsAccountStakeHistoryItem } from './accountStakeHistoryItem';

/**
 * Array of active stake values per epoch
 */
export type AccountStakeHistory = AccountStakeHistoryItem[];
export const bigIntsAccountStakeHistory: Array<string> = [
  ...bigIntsAccountStakeHistoryItem,
];
