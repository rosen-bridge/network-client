 ...
 */
import type { UtxoInfosItemAssetListItemAssetName } from './utxoInfosItemAssetListItemAssetName';
import { bigIntsUtxoInfosItemAssetListItemAssetName } from './utxoInfosItemAssetListItemAssetName';

export type UtxoInfosItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: UtxoInfosItemAssetListItemAssetName;
...
export const bigIntsUtxoInfosItemAssetListItem: Array<string> = [
  ...bigIntsUtxoInfosItemAssetListItemAssetName.map((item) =>
