 ...
 */
import type { AssetInfoItemMintingTxMetadataAllOfAnyOf } from './assetInfoItemMintingTxMetadataAllOfAnyOf';

import { bigIntsAssetInfoItemMintingTxMetadataAllOfAnyOf } from './assetInfoItemMintingTxMetadataAllOfAnyOf';

/**
 * A JSON array containing details about metadata within transaction
 */
export type AssetInfoItemMintingTxMetadataAllOf =
  AssetInfoItemMintingTxMetadataAllOfAnyOf | null | null;
export const bigIntsAssetInfoItemMintingTxMetadataAllOf: Array<string> = [
  ...bigIntsAssetInfoItemMintingTxMetadataAllOfAnyOf,
];
