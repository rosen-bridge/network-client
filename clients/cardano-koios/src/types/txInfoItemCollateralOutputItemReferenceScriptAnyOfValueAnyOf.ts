 ...
 * Value (json)
 */
export type TxInfoItemCollateralOutputItemReferenceScriptAnyOfValueAnyOf = {
  [key: string]: unknown;
};
export const bigIntsTxInfoItemCollateralOutputItemReferenceScriptAnyOfValueAnyOf =
  [];
