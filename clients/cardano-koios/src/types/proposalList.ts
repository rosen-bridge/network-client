...
import { bigIntsProposalListItem } from './proposalListItem';

/**
 * List of all governance action proposals
 */
export type ProposalList = ProposalListItem[];
export const bigIntsProposalList: Array<string> = [...bigIntsProposalListItem];
