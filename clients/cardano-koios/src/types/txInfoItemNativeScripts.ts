 ...
 */
import type { TxInfoItemNativeScriptsAnyOfItem } from './txInfoItemNativeScriptsAnyOfItem';
import { bigIntsTxInfoItemNativeScriptsAnyOfItem } from './txInfoItemNativeScriptsAnyOfItem';

/**
 * Native scripts present in a transaction (if any)
 */
export type TxInfoItemNativeScripts = TxInfoItemNativeScriptsAnyOfItem[] | null;
export const bigIntsTxInfoItemNativeScripts: Array<string> = [
  ...bigIntsTxInfoItemNativeScriptsAnyOfItem,
];
