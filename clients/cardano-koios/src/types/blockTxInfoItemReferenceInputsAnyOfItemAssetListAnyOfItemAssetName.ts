 ...
 * Asset Name (hex)
 */
export type BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName =
  string | null;
export const bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName: Array<string> =
  [];
