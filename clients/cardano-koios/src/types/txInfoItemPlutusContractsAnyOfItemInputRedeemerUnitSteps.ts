 ...
 */
export type TxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps =
  | string
  | number
  | null;
export const bigIntsTxInfoItemPlutusContractsAnyOfItemInputRedeemerUnitSteps: Array<string> =
  [];
