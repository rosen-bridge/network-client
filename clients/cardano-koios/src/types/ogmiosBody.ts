 ...
 */
import type { OgmiosBodyMethod } from './ogmiosBodyMethod';
import { bigIntsOgmiosBodyMethod } from './ogmiosBodyMethod';
import type { OgmiosBodyParams } from './ogmiosBodyParams';

import { bigIntsOgmiosBodyParams } from './ogmiosBodyParams';

export type OgmiosBody = {
  /** Identifier for JSON-RPC 2.0 standard */
  jsonrpc: string;
  /** The Ogmios method to be called (see more details [here](#tag--Ogmios)) or browse examples tab */
  method: OgmiosBodyMethod;
  /**
   * Any parameters relevant to the specific method to be called
   * @nullable
   */
  params?: OgmiosBodyParams;
};

export const bigIntsOgmiosBody = [
