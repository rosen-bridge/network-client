 ...
 */
import type { BlockTxInfoItemWithdrawalsAnyOfItem } from './blockTxInfoItemWithdrawalsAnyOfItem';
import { bigIntsBlockTxInfoItemWithdrawalsAnyOfItem } from './blockTxInfoItemWithdrawalsAnyOfItem';

/**
 * Array of withdrawals with-in a transaction
 */
export type BlockTxInfoItemWithdrawals =
  | BlockTxInfoItemWithdrawalsAnyOfItem[]
  | null;
export const bigIntsBlockTxInfoItemWithdrawals: Array<string> = [
  ...bigIntsBlockTxInfoItemWithdrawalsAnyOfItem,
];
