 ...
 */
import type { TxInfoItemVotingProceduresItemVote } from './txInfoItemVotingProceduresItemVote';
import { bigIntsTxInfoItemVotingProceduresItemVote } from './txInfoItemVotingProceduresItemVote';
import type { TxInfoItemVotingProceduresItemVoterRole } from './txInfoItemVotingProceduresItemVoterRole';
import { bigIntsTxInfoItemVotingProceduresItemVoterRole } from './txInfoItemVotingProceduresItemVoterRole';

export type TxInfoItemVotingProceduresItem = {
  /** Hash identifier of the transaction */
  proposal_tx_hash?: string;
  /** Index of governance proposal in transaction */
  proposal_index?: number;
  /** The role of the voter */
  voter_role?: TxInfoItemVotingProceduresItemVoterRole;
  ...
  voter_hex?: string;
  /** Actual Vote casted */
  vote?: TxInfoItemVotingProceduresItemVote;
};

export const bigIntsTxInfoItemVotingProceduresItem: Array<string> = [
  ...bigIntsTxInfoItemVotingProceduresItemVoterRole.map((item) =>
    item === '' ? 'voter_role' : `voter_role.${item}`,
  ),
  ...bigIntsTxInfoItemVotingProceduresItemVote.map((item) =>
    item === '' ? 'vote' : `vote.${item}`,
  ),
];
