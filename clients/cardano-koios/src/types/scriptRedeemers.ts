 ...
 */
import type { ScriptRedeemersItem } from './scriptRedeemersItem';

import { bigIntsScriptRedeemersItem } from './scriptRedeemersItem';

/**
 * Array of all redeemers for a given script hash
 */
export type ScriptRedeemers = ScriptRedeemersItem[];
export const bigIntsScriptRedeemers: Array<string> = [
  ...bigIntsScriptRedeemersItem,
];
