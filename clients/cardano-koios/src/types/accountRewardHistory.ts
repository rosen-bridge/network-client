 ...
 */
import type { AccountRewardHistoryItem } from './accountRewardHistoryItem';
import { bigIntsAccountRewardHistoryItem } from './accountRewardHistoryItem';

/**
 * Array of reward history information
 */
export type AccountRewardHistory = AccountRewardHistoryItem[];
export const bigIntsAccountRewardHistory: Array<string> = [
  ...bigIntsAccountRewardHistoryItem,
];
