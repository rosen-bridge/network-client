 ...
 */
import type { BlockTxInfoItemOutputsItemAssetListItemAssetName } from './blockTxInfoItemOutputsItemAssetListItemAssetName';
import { bigIntsBlockTxInfoItemOutputsItemAssetListItemAssetName } from './blockTxInfoItemOutputsItemAssetListItemAssetName';

export type BlockTxInfoItemOutputsItemAssetListItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemOutputsItemAssetListItemAssetName;
...
export const bigIntsBlockTxInfoItemOutputsItemAssetListItem: Array<string> = [
  ...bigIntsBlockTxInfoItemOutputsItemAssetListItemAssetName.map((item) =>
