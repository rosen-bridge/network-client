...
export type AssetInfoItemTokenRegistryMetadataAnyOfDescription = null | string;
export const bigIntsAssetInfoItemTokenRegistryMetadataAnyOfDescription: Array<string> =
  [];
