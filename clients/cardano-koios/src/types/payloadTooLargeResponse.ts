...
/**
 * The payload attached to your request is too large, please ensure your request packet is less than 5kb.
 */
export type PayloadTooLargeResponse = void;
export const bigIntsPayloadTooLargeResponse: Array<string> = [];
