...
import { bigIntsTxInfoItemInvalidAfter } from './txInfoItemInvalidAfter';
import type { TxInfoItemInvalidBefore } from './txInfoItemInvalidBefore';
...
export type TxInfoItem = {
   ...
   * @nullable
   */
  assets_minted?: TxInfoItemAssetsMintedItem[] | null;
  /** Hash of the block */
  block_hash?: string;
  /** Block height */
   ...
   * @nullable
   */
  certificates?: TxInfoItemCertificatesItem[] | null;
   ...
   * @nullable
   */
  collateral_output?: TxInfoItemCollateralOutputItem[] | null;
   ...
   * @nullable
   */
  native_scripts?: TxInfoItemNativeScriptsItem[] | null;
  /** An array of UTxO outputs created by the transaction */
   ...
   * @nullable
   */
  plutus_contracts?: TxInfoItemPlutusContractsItem[] | null;
  /**
   * Governance proposals in a transaction (if any)
   * @nullable
   */
  proposal_procedures?: TxInfoItemProposalProceduresItem[] | null;
  ...
  /** Total sum of all transaction outputs (in numbers) */
  total_output?: string;
   ...
   * @nullable
   */
  voting_procedures?: TxInfoItemVotingProceduresItem[] | null;
  /**
   * Array of withdrawals with-in a transaction
   * @nullable
   */
  withdrawals?: TxInfoItemWithdrawalsItem[] | null;
};
