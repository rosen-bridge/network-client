 ...
 */
import type { PoolInvalidDelegatorsItem } from './poolInvalidDelegatorsItem';
import { bigIntsPoolInvalidDelegatorsItem } from './poolInvalidDelegatorsItem';

/**
 * Array of pool delegators that are invalid for the specified epoch
 */
export type PoolInvalidDelegators = PoolInvalidDelegatorsItem[];
export const bigIntsPoolInvalidDelegators: Array<string> = [
  ...bigIntsPoolInvalidDelegatorsItem,
];
