 ...
 */
import type { TxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue } from './txInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue';

import { bigIntsTxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue } from './txInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue';

/**
 * Allows datums to be attached to UTxO (CIP-32)
 */
export type TxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOf = {
  /** Datum bytes (hex) */
  bytes?: string;
  /** Value (json) */
  value?: TxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue;
};

export const bigIntsTxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOf: Array<string> =
  [
    ...bigIntsTxInfoItemCollateralInputsAnyOfItemInlineDatumAnyOfValue.map(
