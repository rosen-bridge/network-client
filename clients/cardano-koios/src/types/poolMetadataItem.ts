 ...
 */
import type { PoolMetadataItemMetaHash } from './poolMetadataItemMetaHash';
import { bigIntsPoolMetadataItemMetaHash } from './poolMetadataItemMetaHash';
import type { PoolMetadataItemMetaJson } from './poolMetadataItemMetaJson';
import { bigIntsPoolMetadataItemMetaJson } from './poolMetadataItemMetaJson';
import type { PoolMetadataItemMetaUrl } from './poolMetadataItemMetaUrl';
import { bigIntsPoolMetadataItemMetaUrl } from './poolMetadataItemMetaUrl';

export type PoolMetadataItem = {
  /** Pool ID (bech32 format) */
  pool_id_bech32?: string;
  /** Pool metadata URL */
  meta_url?: PoolMetadataItemMetaUrl;
  /** Pool metadata hash */
  meta_hash?: PoolMetadataItemMetaHash;
  meta_json?: PoolMetadataItemMetaJson;
};

export const bigIntsPoolMetadataItem: Array<string> = [
  ...bigIntsPoolMetadataItemMetaUrl.map((item) =>
    item === '' ? 'meta_url' : `meta_url.${item}`,
  ),
  ...bigIntsPoolMetadataItemMetaHash.map((item) =>
