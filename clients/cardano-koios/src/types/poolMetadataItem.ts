...
import type { PoolMetadataItemPoolStatus } from './poolMetadataItemPoolStatus';

import { bigIntsPoolMetadataItemPoolStatus } from './poolMetadataItemPoolStatus';
...
export type PoolMetadataItem = {
  ...
  /** Pool status */
  pool_status?: PoolMetadataItemPoolStatus;
};
...
export const bigIntsPoolMetadataItem = [
  ...
  ...bigIntsPoolMetadataItemPoolStatus.map((item) =>
