 ...
 */
import type { _DrepIdParameter } from './_drepIdParameter';
import { bigInts_DrepIdParameter } from './_drepIdParameter';

export type DrepDelegatorsParams = {
  /**
   * DRep ID in bech32 format
   */
  _drep_id: _DrepIdParameter;
};

export const bigIntsDrepDelegatorsParams: Array<string> = [
  ...bigInts_DrepIdParameter.map((item) =>
