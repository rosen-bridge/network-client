 ...
 */
import type { AccountRewardHistoryItemPoolIdBech32 } from './accountRewardHistoryItemPoolIdBech32';
import { bigIntsAccountRewardHistoryItemPoolIdBech32 } from './accountRewardHistoryItemPoolIdBech32';
import type { AccountRewardHistoryItemType } from './accountRewardHistoryItemType';
import { bigIntsAccountRewardHistoryItemType } from './accountRewardHistoryItemType';

export type AccountRewardHistoryItem = {
  ...
  /** Amount of rewards earned (in number) */
  amount?: string;
  /** The source of the rewards */
  type?: AccountRewardHistoryItemType;
  pool_id_bech32?: AccountRewardHistoryItemPoolIdBech32;
};

export const bigIntsAccountRewardHistoryItem: Array<string> = [
  ...bigIntsAccountRewardHistoryItemType.map((item) =>
    item === '' ? 'type' : `type.${item}`,
  ),
  ...bigIntsAccountRewardHistoryItemPoolIdBech32.map((item) =>
    item === '' ? 'pool_id_bech32' : `pool_id_bech32.${item}`,
  ),
];
