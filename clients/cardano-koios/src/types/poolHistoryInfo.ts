 ...
 */
import type { PoolHistoryInfoItem } from './poolHistoryInfoItem';
import { bigIntsPoolHistoryInfoItem } from './poolHistoryInfoItem';

/**
 * Array of pool history information
 */
export type PoolHistoryInfo = PoolHistoryInfoItem[];
export const bigIntsPoolHistoryInfo: Array<string> = [
  ...bigIntsPoolHistoryInfoItem,
];
