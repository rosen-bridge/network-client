 ...
 */
import type { AddressListItem } from './addressListItem';
import { bigIntsAddressListItem } from './addressListItem';

/**
 * Array of information for address(es)
 */
export type AddressList = AddressListItem[];
export const bigIntsAddressList: Array<string> = [...bigIntsAddressListItem];
