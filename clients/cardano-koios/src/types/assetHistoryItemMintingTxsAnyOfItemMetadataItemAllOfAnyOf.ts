 ...
 */
export type AssetHistoryItemMintingTxsAnyOfItemMetadataItemAllOfAnyOf = {
  [key: string]: unknown;
};
export const bigIntsAssetHistoryItemMintingTxsAnyOfItemMetadataItemAllOfAnyOf: Array<string> =
  [];
