 ...
 */
import type { _AssetPolicyNftParameter } from './_assetPolicyNftParameter';
import { bigInts_AssetPolicyNftParameter } from './_assetPolicyNftParameter';
import type { _AssetNameNftParameter } from './_assetNameNftParameter';

import { bigInts_AssetNameNftParameter } from './_assetNameNftParameter';

export type AssetNftAddressParams = {
  /**
   * NFT Policy ID in hexadecimal format (hex)
   */
  _asset_policy: _AssetPolicyNftParameter;
  /**
   * NFT Name in hexadecimal format (hex)
   */
  _asset_name?: _AssetNameNftParameter;
};

export const bigIntsAssetNftAddressParams: Array<string> = [
