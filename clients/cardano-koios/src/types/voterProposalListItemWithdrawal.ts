 ...
 */
import type { VoterProposalListItemWithdrawalAnyOf } from './voterProposalListItemWithdrawalAnyOf';

import { bigIntsVoterProposalListItemWithdrawalAnyOf } from './voterProposalListItemWithdrawalAnyOf';

/**
 * If not null, the amount withdrawn from treasury into stake address by this this proposal
 */
export type VoterProposalListItemWithdrawal =
  VoterProposalListItemWithdrawalAnyOf | null | null;
export const bigIntsVoterProposalListItemWithdrawal: Array<string> = [
  ...bigIntsVoterProposalListItemWithdrawalAnyOf,
];
