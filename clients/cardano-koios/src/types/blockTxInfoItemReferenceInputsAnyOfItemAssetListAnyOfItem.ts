 ...
 */
import type { BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName';

import { bigIntsBlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName } from './blockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName';

export type BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItem = {
  /** Asset Policy ID (hex) */
  policy_id?: string;
  /** Asset Name (hex) */
  asset_name?: BlockTxInfoItemReferenceInputsAnyOfItemAssetListAnyOfItemAssetName;
