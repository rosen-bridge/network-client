 ...
 */
import type { PolicyAssetListItem } from './policyAssetListItem';

import { bigIntsPolicyAssetListItem } from './policyAssetListItem';

/**
 * Array of brief information of assets under the same policy
 */
export type PolicyAssetList = PolicyAssetListItem[];
export const bigIntsPolicyAssetList: Array<string> = [
  ...bigIntsPolicyAssetListItem,
];
