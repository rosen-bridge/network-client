 ...
 */
import type { TxUtxosItemInputsItemReferenceScriptValue } from './txUtxosItemInputsItemReferenceScriptValue';

import { bigIntsTxUtxosItemInputsItemReferenceScriptValue } from './txUtxosItemInputsItemReferenceScriptValue';
 ...
 */
export type TxUtxosItemInputsItemReferenceScript = {
  ...
  bytes?: string;
  /** Value (json) */
  value?: TxUtxosItemInputsItemReferenceScriptValue;
} | null;

export const bigIntsTxUtxosItemInputsItemReferenceScript = [
  ...bigIntsTxUtxosItemInputsItemReferenceScriptValue.map((item) =>
