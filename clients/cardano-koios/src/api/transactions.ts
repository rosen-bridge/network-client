 ...
 */
export const postTxUtxos = (
  txIdsBody: TxIdsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<TxUtxos>(
    {
      url: `/tx_utxos`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const postTxMetadata = (
  txIdsBody: TxIdsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<TxMetadata>(
    {
      url: `/tx_metadata`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const getTxMetalabels = (options?: SecondParameter<typeof axios>) => {
  return axios<TxMetalabels>({ url: `/tx_metalabels`, method: 'get' }, options);
};
/**
 * Submit an already serialized transaction to the network.
 * @summary Submit Transaction
 */
export const postSubmittx = (
  txbinBody: TxbinBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<string>(
 ...
 */
export const postTxStatus = (
  txIdsBody: TxIdsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<TxStatus>(
    {
      url: `/tx_status`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
