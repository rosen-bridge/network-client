 ...
 */
export const getTip = (options?: SecondParameter<typeof axios>) => {
  return axios<Tip>({ url: `/tip`, method: 'get' }, options);
};
/**
 * Get the Genesis parameters used to start specific era on chain
 * @summary Get Genesis info
 */
export const getGenesis = (options?: SecondParameter<typeof axios>) => {
  return axios<Genesis>({ url: `/genesis`, method: 'get' }, options);
};
/**
...
export const getTotals = (
  params?: GetTotalsParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<Totals>({ url: `/totals`, method: 'get', params }, options);
};
/**
 * Get all parameter update proposals submitted to the chain starting Shelley era
 * @summary Param Update Proposals
 */
export const getParamUpdates = (options?: SecondParameter<typeof axios>) => {
  return axios<ParamUpdates>({ url: `/param_updates`, method: 'get' }, options);
};
