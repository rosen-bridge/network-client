...
export const getEpochInfo = (
  ...
  return axios<EpochInfo>(
    { url: `/epoch_info`, method: 'get', params },
    options
  );
};
/**
...
export const getEpochParams = (
  params?: GetEpochParamsParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<EpochParams>(
    { url: `/epoch_params`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const getEpochBlockProtocols = (
  params?: GetEpochBlockProtocolsParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<EpochBlockProtocols>(
    { url: `/epoch_block_protocols`, method: 'get', params },
    options
  );
};
