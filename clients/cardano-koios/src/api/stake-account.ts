 ...
 */
export const getAccountList = (options?: SecondParameter<typeof axios>) => {
  return axios<AccountList>({ url: `/account_list`, method: 'get' }, options);
};
/**
...
export const postAccountInfo = (
  stakeAddressesBody: StakeAddressesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountInfo>(
    {
      url: `/account_info`,
      method: 'post',
 ...
 */
export const getAccountUtxos = (
  params: GetAccountUtxosParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountUtxos>(
    { url: `/account_utxos`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const postAccountInfoCached = (
  stakeAddressesBody: StakeAddressesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountInfo>(
 ...
 */
export const postAccountUpdates = (
  stakeAddressesBody: StakeAddressesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountUpdates>(
    {
      url: `/account_updates`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const postAccountAssets = (
  stakeAddressesBody: StakeAddressesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountAssets>(
    {
      url: `/account_assets`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const postAccountHistory = (
  stakeAddressesWithEpochNoBody: StakeAddressesWithEpochNoBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AccountHistory>(
    {
      url: `/account_history`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
