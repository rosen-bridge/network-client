 ...
 */
import type { Blocks, BlockInfo, BlockHashesBody, BlockTxs } from '../types';
 ...
 * @summary Block List
 */
export const getBlocks = (options?: SecondParameter<typeof axios>) => {
  return axios<Blocks>({ url: `/blocks`, method: 'get' }, options);
};
/**
 * Get detailed information about a specific block
 * @summary Block Information
 */
export const postBlockInfo = (
  blockHashesBody: BlockHashesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<BlockInfo>(
    {
      url: `/block_info`,
      method: 'post',
 ...
 */
export const postBlockTxs = (
  blockHashesBody: BlockHashesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<BlockTxs>(
    {
      url: `/block_txs`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
