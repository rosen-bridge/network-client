 ...
 */
export const getNativeScriptList = (
  options?: SecondParameter<typeof axios>
) => {
  return axios<NativeScriptList>(
    { url: `/native_script_list`, method: 'get' },
    options
  );
};
/**
 ...
 */
export const getPlutusScriptList = (
  options?: SecondParameter<typeof axios>
) => {
  return axios<PlutusScriptList>(
    { url: `/plutus_script_list`, method: 'get' },
    options
  );
};
/**
 ...
 */
export const getScriptRedeemers = (
  params: GetScriptRedeemersParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<ScriptRedeemers>(
    { url: `/script_redeemers`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const postDatumInfo = (
  datumHashesBody: DatumHashesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<DatumInfo>(
    {
      url: `/datum_info`,
      method: 'post',
