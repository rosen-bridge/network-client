 ...
 * @summary Pool List
 */
export const getPoolList = (options?: SecondParameter<typeof axios>) => {
  return axios<PoolList>({ url: `/pool_list`, method: 'get' }, options);
};
/**
 * Current pool statuses and details for a specified list of pool ids
 * @summary Pool Information
 */
export const postPoolInfo = (
  poolIdsBody: PoolIdsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolInfo>(
    {
      url: `/pool_info`,
      method: 'post',
 ...
 */
export const getPoolStakeSnapshot = (
  params: GetPoolStakeSnapshotParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolSnapshot>(
    { url: `/pool_stake_snapshot`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const getPoolDelegators = (
  params: GetPoolDelegatorsParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolDelegators>(
    { url: `/pool_delegators`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const getPoolDelegatorsHistory = (
  params: GetPoolDelegatorsHistoryParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolDelegatorsHistory>(
    { url: `/pool_delegators_history`, method: 'get', params },
    options
  );
};
/**
 ...
 * @summary Pool Blocks
 */
export const getPoolBlocks = (
  params: GetPoolBlocksParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolBlocks>(
    { url: `/pool_blocks`, method: 'get', params },
    options
  );
};
/**
...
export const getPoolHistory = (
  params: GetPoolHistoryParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolHistoryInfo>(
    { url: `/pool_history`, method: 'get', params },
    options
  );
};
/**
 ...
 */
export const getPoolUpdates = (
  params?: GetPoolUpdatesParams,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolUpdates>(
    { url: `/pool_updates`, method: 'get', params },
    options
  );
};
/**
 ...
 * @summary Pool Relays
 */
export const getPoolRelays = (options?: SecondParameter<typeof axios>) => {
  return axios<PoolRelays>({ url: `/pool_relays`, method: 'get' }, options);
};
/**
 * Metadata (on & off-chain) for all currently registered/retiring (not retired) pools
 * @summary Pool Metadata
 */
export const postPoolMetadata = (
  poolIdsOptionalBody: PoolIdsOptionalBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<PoolMetadata>(
    {
      url: `/pool_metadata`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
