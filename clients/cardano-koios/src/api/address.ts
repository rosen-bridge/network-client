 ...
 */
export const postAddressInfo = (
  paymentAddressesBody: PaymentAddressesBody,
 ...
 */
export const postAddressTxs = (
  addressTxsBody: AddressTxsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AddressTxs>(
    {
      url: `/address_txs`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const postCredentialUtxos = (
  credentialUtxosBody: CredentialUtxosBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<CredentialUtxos>(
    {
 ...
 */
export const postAddressAssets = (
  paymentAddressesBody: PaymentAddressesBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<AddressAssets>(
    {
      url: `/address_assets`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
 ...
 */
export const postCredentialTxs = (
  credentialTxsBody: CredentialTxsBody,
  options?: SecondParameter<typeof axios>
) => {
  return axios<CredentialTxs>(
    {
      url: `/credential_txs`,
      method: 'post',
      headers: { 'Content-Type': 'application/json' },
